...
const char kBraveTranslateEndpoint[] = "http://localhost:8195/translate"; // NOLINT
const char kBraveTranslateLanguageEndpoint[] = "http://localhost:8195/language"; // NOLINT
const char kBraveTranslateServerPrefix[] = "http://localhost:8195/*"; // NOLINT
