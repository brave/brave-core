...
window.__firefox__.includeOnce("BraveSkusHelper", function() {
  function sendMessage(method_id, data) {
    return webkit.messageHandlers.braveSkusHelper.postMessage({'securitytoken': '$<security_token>' ,'method_id': method_id, data: data});
  }
