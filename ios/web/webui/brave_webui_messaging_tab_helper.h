...
class BraveWebUIMessagingTabHelper : public web::WebStateUserData<BraveWebUIMessagingTabHelper> {

public:
  BraveWebUIMessagingTabHelper(const BraveWebUIMessagingTabHelper&) = delete;
  BraveWebUIMessagingTabHelper& operator=(const BraveWebUIMessagingTabHelper&) = delete;
