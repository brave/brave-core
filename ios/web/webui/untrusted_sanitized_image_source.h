...
#ifndef BRAVE_IOS_WEB_WEBUI_UNTRUSTED_SANITIZED_IMAGE_SOURCE_H_
#define BRAVE_IOS_WEB_WEBUI_UNTRUSTED_SANITIZED_IMAGE_SOURCE_H_
...
#endif  // BRAVE_IOS_WEB_WEBUI_UNTRUSTED_SANITIZED_IMAGE_SOURCE_H_
