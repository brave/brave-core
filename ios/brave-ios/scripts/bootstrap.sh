...
# Set up an lldbinit file for debugging remote_exec builds
cat > "$src_dir/brave/ios/brave-ios/App/Configuration/LLDBInit" << EOL
# This file is generated by bootstrap
#
# This allows proper source mapping to builds made with the GN arg
# strip_absolute_paths_from_debug_symbols set to true.
settings set target.source-map "../.." "$src_dir"
EOL
