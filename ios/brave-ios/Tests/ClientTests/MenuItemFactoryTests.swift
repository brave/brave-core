...
class MenuItemFactoryTests: XCTestCase {
  func test_buttonType_deliversCorrectTitleAndSubtitle() {
    ...
    let playlistButtonWithSubtitle = MenuItemFactory.button(
      for: .playlist(subtitle: "some subtitle"),
      completion: {}
    )
    ...
    let walletButtonWithSubtitle = MenuItemFactory.button(
      for: .wallet(subtitle: "some subtitle"),
      completion: {}
    )
