...
class BraveVPNTests: XCTestCase {
  ...
  override func setUp() {
    ...
    let modifiedDateWithGracePeriod = Calendar.current.date(
      byAdding: .day,
      value: gracePeriod,
      to: Date()
    )!
    ...
    subjectActivePeriodRenewableNotInTrial = generateReceiptResponse(
      using: lineItemPurchasedNotInTrial,
      metaData: lineItemMetaDataAutoRenewEnabled
    )
    subjectActivePeriodRenewableInTrial = generateReceiptResponse(
      using: lineItemPurchasedInTrial,
      metaData: lineItemMetaDataAutoRenewEnabled
    )
    subjectActivePeriodNotRenewable = generateReceiptResponse(
      using: lineItemPurchasedNotInTrial,
      metaData: lineItemMetaDataAutoRenewCanceled
    )
    subjectRetryPeriod = generateReceiptResponse(
      using: lineItemPurchasedNotInTrial,
      metaData: lineItemMetaDataIsInRetryPeriod
    )
    subjectRetryPeriodNoMetaGraceExpiry = generateReceiptResponse(
      using: nil,
      metaData: lineItemMetaDataIsInRetryPeriodWithGraceExpiry
    )
    subjectExpiredPeriod = generateReceiptResponse(
      using: nil,
      metaData: lineItemMetaDataAutoRenewCanceled
    )
  }
  ...
  func testSubscriptionActiveAutoRenewEnabledNotInTrial() {
    let processedLineItem = BraveVPN.processReceiptResponse(
      receiptResponseItem: subjectActivePeriodRenewableNotInTrial
    )
  ...
  func testSubscriptionActiveAutoRenewEnabledInTrial() {
    let processedLineItem = BraveVPN.processReceiptResponse(
      receiptResponseItem: subjectActivePeriodRenewableInTrial
    )
  ...
  func testSubscriptionActiveAutoRenewDisabled() {
    let processedLineItem = BraveVPN.processReceiptResponse(
      receiptResponseItem: subjectActivePeriodNotRenewable
    )
  ...
  func testSubscriptionIsInNoMetaGraceExpiry() {
    let processedLineItem = BraveVPN.processReceiptResponse(
      receiptResponseItem: subjectRetryPeriodNoMetaGraceExpiry
    )
  ...
  func testSubscriptionExpiredPeriod() {
    let processedLineItem = BraveVPN.processReceiptResponse(
      receiptResponseItem: subjectExpiredPeriod
    )
  ...
  private func generateReceiptResponse(
    using lineItem: NSDictionary?,
    metaData: NSDictionary
  ) -> GRDIAPReceiptResponse {
