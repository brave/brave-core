...
extension BraveShieldsSettings {
  ...
  @MainActor public func migrateShieldsToContentSettings(for domains: [Domain]) {
    ...
    for (host, domains) in groupedByHost {
      ...
      let secureDomainsWithExplicitAllOff =
        domainsWithExplicitAllOff
        .secureDomains()
        .sortedForMigration()
      let insecureDomainsWithExplicitAllOff =
        domainsWithExplicitAllOff
        .insecureDomains()
        .sortedForMigration()
      ...
      let secureDomainsWithExplicitShieldLevel =
        domainsWithExplicitShieldLevel
        .secureDomains()
        .sortedForMigration()
      let insecureDomainsWithExplicitShieldLevel =
        domainsWithExplicitShieldLevel
        .insecureDomains()
        .sortedForMigration()
      // prefer https Shield setting
      ...
      let secureDomainsWithExplicitFingerprintingProtection =
        domainsWithExplicitFingerprintingProtection
        .secureDomains()
        .sortedForMigration()
      ...
      let secureDomainsWithExplicitBlockScripts =
        domainsWithExplicitBlockScripts
        .secureDomains()
        .sortedForMigration()
    ...
    for (domain, domains) in groupedByDomain {
      ...
      let secureDomainsWithExplicitShredLevel =
        domainsWithExplicitShredLevel
        .secureDomains()
        .sortedForMigration()
      let insecureDomainsWithExplicitShredLevel =
        domainsWithExplicitShredLevel
        .insecureDomains()
        .sortedForMigration()
      // prefer https Shield setting
