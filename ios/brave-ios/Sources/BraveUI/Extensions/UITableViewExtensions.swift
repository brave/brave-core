...
extension UITableView {
  ...
  public func registerHeaderFooter<T: UITableViewHeaderFooterView & TableViewReusable>(
    _ headerFooterClass: T.Type
  ) {
    register(headerFooterClass, forHeaderFooterViewReuseIdentifier: headerFooterClass.identifier)
  }

  public func dequeueReusableCell<T: UITableViewCell & TableViewReusable>(
