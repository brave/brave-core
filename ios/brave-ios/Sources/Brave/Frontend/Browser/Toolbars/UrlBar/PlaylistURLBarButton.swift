    ...
    return UIMenu(
      ...
      children: [
          ...
          handler([
            UIAction(
              title: String.localizedStringWithFormat(
                Strings.PlayList.addedToPlaylistMessage,
        ...
        UIMenu(
          ...
          children: [
            UIAction(
              title: Strings.PlayList.openInPlaylistButtonTitle,
            ...
            UIAction(
              title: Strings.PlayList.changeFoldersButtonTitle,
              image: UIImage(braveSystemNamed: "leo.folder.exchange"),
              handler: { _ in
      ...
      children: [
        UIDeferredMenuElement.uncached { handler in
          ...
          handler([
            UIAction(
              title: String.localizedStringWithFormat(
                Strings.PlayList.removedFromPlaylistMessage,
                item?.playlistFolder?.title ?? "Playlist"
              ),
              image: UIImage(braveSystemNamed: "leo.check.circle-filled")?.withTintColor(
                .braveSuccessLabel
