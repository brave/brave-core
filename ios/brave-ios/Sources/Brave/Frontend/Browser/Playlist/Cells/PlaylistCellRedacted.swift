  ...
  var body: some View {
    HStack {
      RoundedRectangle(cornerRadius: 5.0, style: .continuous)
        .fill(Color.black)
        .frame(
          width: contentSize.width * 0.30,
          height: contentSize.width * 0.3 * (9.0 / 16.0),
          alignment: .center
        )
        .overlay(
...
class PlaylistCellRedacted: UITableViewCell {
  public let hostingController = UIHostingController<PlaylistCellRedactedView>(
    rootView:
      PlaylistCellRedactedView(
        thumbnail: nil,
        title: nil,
        details: nil,
        contentSize: .zero
