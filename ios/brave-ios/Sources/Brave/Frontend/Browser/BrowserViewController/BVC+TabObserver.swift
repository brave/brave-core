...
extension BrowserViewController: TabObserver {
  public func tabDidCreateWebView(_ tab: some TabState) {
    ...
    var injectedScripts: [TabContentScript] = [
      ...
      DeAmpScriptHandler(),
      SiteStateListenerScriptHandler(braveShieldsUtils: profileController.braveShieldsUtils),
      CosmeticFiltersScriptHandler(braveShieldsUtils: profileController.braveShieldsUtils),
