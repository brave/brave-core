...
@MainActor class AdvancedShieldsSettings: ObservableObject {
  ...
  /// Updates the Developer Mode preference for custom filter lists. When
  /// enabling on a device owner authentication, will request permissions.
  private func setDeveloperMode(enabled: Bool) {
