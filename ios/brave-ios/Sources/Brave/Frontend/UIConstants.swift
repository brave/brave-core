...
public struct UIConstants {
  ...
  static let defaultChromeFont: UIFont = UIFont.systemFont(
    ofSize: defaultChromeSize,
    weight: UIFont.Weight.regular
  )
  static let defaultChromeSmallFontBold = UIFont.boldSystemFont(ofSize: defaultChromeSmallSize)
  static let passcodeEntryFont = UIFont.systemFont(
    ofSize: passcodeEntryFontSize,
