...
public class BraveProfileMigrations {
  ...
  @MainActor public func migrateShieldsToContentSettings() {
    ...
    let braveShieldsSettings = BraveShieldsSettingsFactory.create(for: profileController.profile)
    braveShieldsSettings.migrateShieldsToContentSettings(domainsToMigrate)
  }
}
