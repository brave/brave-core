...
extension Preferences {
  public final class DAU {
    /// Deprecated. Superseded by `kLastCheckYMD` in local state.
    /// Kept until existing values are migrated on first launch after update.
    public static let lastLaunchInfoDeprecated = Option<[Int]?>(
    ...
    static let firstPingParam: Option<Bool> =
      Option<Bool>(
        key: "dau.first-ping",
        default: Preferences.DAU.lastLaunchInfoDeprecated.value == nil
      )
    ...
    public static let appRetentionLaunchDate = Option<Date?>(
  ...
  public final class URP {
    ...
    public static let referralCodeDeleteDate = Option<TimeInterval?>(
    ...
    public static let installAttributionLookupOutstanding = Option<Bool?>(
      key: "install.attribution.lookup-completed",
      default: nil
    )
  }
  ...
  public final class Review {
    ...
    public static let braveNewsCriteriaPassed = Option<Bool>(
      key: "review.brave-new.criteria",
      default: false
    )
    public static let numberBookmarksAdded = Option<Int>(
      key: "review.numberBookmarksAdded",
      default: 0
    )
    public static let numberPlaylistItemsAdded = Option<Int>(
      key: "review.numberPlaylistItemsAdded",
      default: 0
    )
    public static let dateWalletConnectedToDapp = Option<Date?>(
      key: "review.connect-dapp.wallet",
      default: nil
    )
