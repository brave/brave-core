...
def replacement_string(key, table_name, value, comment, file):
    ...
    if val in keyDict:
        ...
        keyDict[val] = file
    content = 'public static let ' + key + ' = NSLocalizedString("' + pascal_case(
        key) + '"'
...
#        print "Processing " + path + "/" + file
            ...
            with open(os.path.join(path, file), 'r') as source:
                ...
                replacement_pattern = lambda match: replacement_string(
                    match.group(1), table_name, match.group(4), match.group(5),
                    file)
                ...
                replacement_pattern = lambda match: replacement_string(
                    match.group(1), table_name, match.group(4), "", file)
                content = re.sub(pattern,
                                 replacement_pattern,
                                 content,
                                 flags=flags)
                ...
                replacement_pattern = lambda match: replacement_string(
                    match.group(1), table_name, match.group(2), match.group(4),
                    file)
                content = re.sub(pattern,
                                 replacement_pattern,
                                 content,
                ...
                replacement_pattern = lambda match: replacement_string(
                    match.group(1), table_name, match.group(2), "", file)
                content = re.sub(pattern,
                                 replacement_pattern,
                                 content,
                                 flags=flags)
                ...
                replacement_pattern = lambda match: replacement_string(
                    match.group(1), table_name, match.group(3), match.group(4),
                    file)
                content = re.sub(pattern,
                                 replacement_pattern,
                                 content,
                ...
                replacement_pattern = lambda match: replacement_string(
                    match.group(1), table_name, match.group(2), match.group(3),
                    file)
                content = re.sub(pattern,
                                 replacement_pattern,
                                 content,
                ...
                replacement_pattern = lambda match: replacement_string(
                    match.group(1), table_name, match.group(3), "", file)
                content = re.sub(pattern,
                                 replacement_pattern,
                                 content,
                                 flags=flags)
