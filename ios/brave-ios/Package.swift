...
var package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "BraveCore", path: "BraveCore/build/BraveCore.xcframework"),
    .binaryTarget(name: "MaterialComponents", path: "BraveCore/build/MaterialComponents.xcframework"),
