...
class AIChatUI : public web::WebUIIOSController {
 public:
  ...
  void BindInterfaceChatService(mojo::PendingReceiver<ai_chat::mojom::Service> receiver);
  void BindInterfaceParentUIFrame(mojo::PendingReceiver<ai_chat::mojom::ParentUIFrame>
                         parent_ui_frame_receiver);
  void BindInterfaceTabTracker(mojo::PendingReceiver<ai_chat::mojom::TabTrackerService>
                         pending_receiver);
