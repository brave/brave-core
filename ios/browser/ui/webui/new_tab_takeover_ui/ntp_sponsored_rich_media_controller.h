...
class NTPSponsoredRichMediaController : public web::WebUIIOSController {
  public:
   NTPSponsoredRichMediaController(web::WebUIIOS* web_ui, const GURL& url, ntp_background_images::NTPBackgroundImagesService* background_images_service);
    //NTPSponsoredRichMediaController(web::WebUIIOS* web_ui, const GURL& url);
