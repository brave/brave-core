...
//   NewTabTakeoverUIMessageHandler(const NewTabTakeoverUIMessageHandler&) =
//   delete; NewTabTakeoverUIMessageHandler& operator=(const
//   NewTabTakeoverUIMessageHandler&) =
//       delete;
...
NewTabTakeoverUIIOS::NewTabTakeoverUIIOS(web::WebUIIOS* web_ui, const GURL& url, ntp_background_images::NTPBackgroundImagesService* ntp_background_images_service)
...
//  web_ui->AddRequestableScheme(content::kChromeUIUntrustedScheme);
  ...
  LOG(ERROR) << "FOOBAR.NewTabTakeoverUIIOS";
