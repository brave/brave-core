...
NSString* const kBraveAdsEnabledByPolicyPrefName =
    base::SysUTF8ToNSString(brave_ads::prefs::kEnabledByPolicy);
...
- (BOOL)isIneligibleToStart {
  return adsService != nil && adsService->IsIneligibleToStart();
}
