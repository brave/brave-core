...
void ConversationDriverIOS::OnAPIResponseError(
    ai_chat::mojom::APIErrorPtr error) {
  [bridge_ onAPIResponseError:[[AiChatAPIError alloc]
                                  initWithAPIErrorPtr:std::move(error)]];
}
