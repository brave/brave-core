...
class ExportedRootBookmarkEntry {
 public:
  ...
  ExportedBookmarkEntry* other_bookmarks_node() {
    return other_bookmarks_node_;
  }
  ExportedBookmarkEntry* mobile_bookmarks_node() {
    return mobile_bookmarks_node_;
  }
...
class ExportedBookmarkEntry {
 public:
  ...
  const std::vector<std::unique_ptr<ExportedBookmarkEntry>>& children() const {
    return children_;
  }
 ...
 private:
  ...
  static std::unique_ptr<ExportedBookmarkEntry> CreateOtherBookmarks(
      int64_t id);
  static std::unique_ptr<ExportedBookmarkEntry> CreateMobileBookmarks(
      int64_t id);
