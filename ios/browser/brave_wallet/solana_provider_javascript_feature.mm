...
SolanaProviderJavaScriptFeature::SolanaProviderJavaScriptFeature(
  ...
  pref_change_registrar_.Add(
      ...
      base::BindRepeating(
          &SolanaProviderJavaScriptFeature::OnScriptGatingPrefChanged,
  ...
  pref_change_registrar_.Add(
      ...
      base::BindRepeating(&SolanaProviderJavaScriptFeature::OnKeyringsChanged,
                          base::Unretained(this)));
}

void SolanaProviderJavaScriptFeature::OnKeyringsChanged() {
...
void SolanaProviderJavaScriptFeature::OnScriptGatingPrefChanged() {
...
SolanaProviderJavaScriptFeature::GetScripts() const {
  ...
  if (!IsAllowed(prefs) || !IsDefaultSolanaWalletBrave(prefs) ||
    ...
    // Brave is not set as the default solana wallet provider, or the user
