...
#ifndef BRAVE_IOS_BROWSER_BRAVE_WALLET_BLOCKCHAIN_IMAGES_SOURCE_H_
#define BRAVE_IOS_BROWSER_BRAVE_WALLET_BLOCKCHAIN_IMAGES_SOURCE_H_
...
#endif  // BRAVE_IOS_BROWSER_BRAVE_WALLET_BLOCKCHAIN_IMAGES_SOURCE_H_
