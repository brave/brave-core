...
class ZCashWalletServiceFactory : public BrowserStateKeyedServiceFactory {
 public:
  ...
  static ZCashWalletService* GetServiceForState(ChromeBrowserState* browser_state);
 ...
 private:
  ...
  ZCashWalletServiceFactory& operator=(const ZCashWalletServiceFactory&) = delete;
};
