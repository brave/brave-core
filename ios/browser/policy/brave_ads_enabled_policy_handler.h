...
#ifndef BRAVE_IOS_BROWSER_POLICY_BRAVE_ADS_ENABLED_POLICY_HANDLER_H_
#define BRAVE_IOS_BROWSER_POLICY_BRAVE_ADS_ENABLED_POLICY_HANDLER_H_
...
#endif  // BRAVE_IOS_BROWSER_POLICY_BRAVE_ADS_ENABLED_POLICY_HANDLER_H_
