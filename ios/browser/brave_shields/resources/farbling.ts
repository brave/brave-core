...
import {sendPromptMessage} from "//brave/ios/web/js_messaging/resources/prompt_utils.js"
...
const response = sendPromptMessage(messageHandlerName, {});
console.log("Prompt Response: " + response);

sendWebKitMessageWithReply(messageHandlerName, {})
  .then((response2: any) => {console.log("WebKit Response: " + response2)})
