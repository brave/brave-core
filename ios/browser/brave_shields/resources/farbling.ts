...
/**
 * @fileoverview Enables privacy protections by overriding common JavaScript
 * APIs used to fingerprint users. Only activates if the user has shields
 * enabled and blocks fingerprinting for the URL loading in the frame.
 */
