...
#ifndef BRAVE_IOS_BROWSER_BRAVE_SHIELDS_COSMETIC_FILTERING_COSMETIC_FILTERING_JAVASCRIPT_FEATURE_H_
...
class CosmeticFilteringJavaScriptFeature : public web::JavaScriptFeature {
 public:
  ...
  // needed.
  static CosmeticFilteringJavaScriptFeature* GetInstance();
 ...
 private:
  friend class base::NoDestructor<CosmeticFilteringJavaScriptFeature>;
