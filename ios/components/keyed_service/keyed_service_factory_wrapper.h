...
#ifndef BRAVE_IOS_COMPONENTS_KEYED_SERVICE_KEYED_SERVICE_FACTORY_WRAPPER_H_
#define BRAVE_IOS_COMPONENTS_KEYED_SERVICE_KEYED_SERVICE_FACTORY_WRAPPER_H_
...
#endif  // BRAVE_IOS_COMPONENTS_KEYED_SERVICE_KEYED_SERVICE_FACTORY_WRAPPER_H_
