...
public final class BravePreferenceKeys {
    ...
    public static final String BRAVE_BROWSER_LOCK_SCREENSHOT_MODE = "browser_lock_screenshot_mode";

    // Screenshot mode values.
    public static final int BRAVE_BROWSER_LOCK_SCREENSHOT_MODE_ALLOW = 0;
    public static final int BRAVE_BROWSER_LOCK_SCREENSHOT_MODE_PRIVATE_TABS_ONLY = 1;
    public static final int BRAVE_BROWSER_LOCK_SCREENSHOT_MODE_EVERYTHING = 2;
