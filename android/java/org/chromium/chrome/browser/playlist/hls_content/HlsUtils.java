...
public class HlsUtils {
    ...
    public static void getManifestFile(Context context, PlaylistService playlistService,
            PlaylistItem playlistItem, HlsUtils.HlsManifestDelegate hlsManifestDelegate) {
    ...
    public static void getHLSFile(Context context, PlaylistService playlistService,
                        ...
                        public void onDataCompleted() {
                            try {
                                ...
                                if (newSegment != null) {
                                    ...
                                    getHLSFile(context, playlistService, playlistItem,
                                            segmentsQueue, hlsFileDelegate);
                                } else {
                                    if (hlsFileDelegate != null) {
