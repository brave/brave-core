        ...
        try {
            ...
            switch (feedItem.which()) {
                ...
                case FeedItem.Tag.Deal:
                    ...
                    FeedItemMetadata unused_dealData = deal.data;
        ...
        return new RequestListener<Drawable>() {
            ...
            public boolean onResourceReady(
                ...
                if (resource instanceof BitmapDrawable) {
                    Bitmap unused_bitmap = ((BitmapDrawable) resource).getBitmap();
                    // Log.d(TAG,String.format(Locale.getDefault(), "Ready %s bitmap %,d bytes,
                    // size: %d x %d",
                    //         unused_name,
                    //         unused_bitmap.getByteCount(),
                    //         unused_bitmap.getWidth(),
                    //         unused_bitmap.getHeight()));
                }
                return false;
            }
        };
