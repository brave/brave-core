...
public class BraveTabbedAppMenuPropertiesDelegate extends TabbedAppMenuPropertiesDelegate {
        ...
        public BraveTabbedAppMenuPropertiesDelegate(
                        ...
                        @NonNull OneshotSupplier<IncognitoReauthController> incognitoReauthControllerOneshotSupplier,
        ...
        private void onFooterViewInflated(AppMenuHandler appMenuHandler, View view) {
                ...
                if (bookmarkButton != null
                        ...
                        if (bookmarkWrapper != null)
                                bookmarkWrapper.setVisibility(View.GONE);
                }
                ...
                boolean showShareButton = BottomToolbarConfiguration.isToolbarTopAnchored() || !showForwardButton;
                if (shareButton != null) {
                ...
                if (homeButton != null && HomepageManager.getInstance() != null) {
                        boolean showHome = BottomToolbarConfiguration.isToolbarBottomAnchored()
        ...
        public @Nullable View buildFooterView(AppMenuHandler appMenuHandler) {
                if (isMenuButtonInBottomToolbar() && shouldShowPageMenu()) {
                        View footer = LayoutInflater.from(mBraveContext).inflate(R.layout.icon_row_menu_footer, null);
                ...
                for (int i = 0; i < modelList.size(); ++i) {
                        ...
                        if (itemId == R.id.new_tab_menu_id) {
                                item.model.set(
                                                ...
                                                AppCompatResources.getDrawable(mBraveContext,
                        ...
                        } else if (itemId == R.id.new_tor_tab_menu_id) {
                                item.model.set(
                                                AppMenuItemProperties.ICON,
                                                AppCompatResources.getDrawable(
                                                                mBraveContext, R.drawable.ic_tor_onion));
                        } else if (itemId == R.id.new_tab_group_menu_id
                                        || itemId == R.id.add_to_group_menu_id) {
                                item.model.set(
                                                AppMenuItemProperties.ICON,
                                                AppCompatResources.getDrawable(mBraveContext,
                                                                R.drawable.browser_group));
        ...
        /**
         * Builds the complete list of main menu items for the Customize menu settings
         * screen.
         *
         * <p>
         * This method creates a comprehensive list of all available main menu items
         * that users can
         * customize through the menu settings. The list includes items like "New Tab",
         * "History",
         * "Downloads", "Brave Wallet", etc., based on feature availability and device
         * configuration.
         *
         * <p>
         * <strong>Note on Icons:</strong> The returned menu items do not include
         * drawable icons
         * because {@link android.graphics.drawable.Drawable} objects cannot be parceled
         * across activity
         * boundaries. Instead, the settings screen uses {@link
         * CustomizeBraveMenu#getDrawableResFromMenuItemId(int)} to map menu item IDs to
         * their
         * corresponding drawable resource IDs for display.
         *
         * @return a ModelList containing all customizable main menu items with their
         *         IDs and titles
         */
        public MVCListAdapter.ModelList buildMainMenuModelList() {
                        ...
                        modelList.add(
                                        new MVCListAdapter.ListItem(
                                                        ...
                                                        buildModelForStandardMenuItem(
                                                                        ...
                                                                        R.string.menu_add_tab_to_group, 0)));
                }
                ...
                String manageWindows = mContext.getString(R.string.menu_manage_all_windows, 0)
                                .replaceAll("\\s*\\(\\d+\\)$", "");
                ...
                modelList.add(
                                new MVCListAdapter.ListItem(
                                                AppMenuHandler.AppMenuItemType.STANDARD,
                                                buildModelForStandardMenuItem(
                                                                R.id.all_bookmarks_menu_id, R.string.menu_bookmarks,
                                                                0)));
                ...
                modelList.add(
                                new MVCListAdapter.ListItem(
                                                AppMenuHandler.AppMenuItemType.STANDARD,
                                                buildModelForStandardMenuItem(
                                                                R.id.recent_tabs_menu_id, R.string.menu_recent_tabs,
                                                                0)));
        ...
        /**
         * Builds the complete list of page action items for the Customize menu settings
         * screen.
         *
         * <p>
         * This method creates a comprehensive list of all available page action menu
         * items that
         * users can customize through the menu settings. Page actions are
         * context-sensitive menu items
         * that operate on the current page, such as "Share", "Download Page", "Print",
         * "Find in Page",
         ...
         * corresponding drawable resource IDs for display.
         *
         * @return a ModelList containing all customizable page action menu items with
         *         their IDs and
         *         titles
         */
        public MVCListAdapter.ModelList buildPageActionsModelList() {
                ...
                if (mIsTablet) {
                        modelList.add(
                                        new MVCListAdapter.ListItem(
                                                        AppMenuItemType.STANDARD,
                                                        buildModelForStandardMenuItem(
                                                                        R.id.share_menu_id, R.string.menu_share_page,
                                                                        0)));
                }
                ...
                modelList.add(
                                new MVCListAdapter.ListItem(
                                                AppMenuItemType.STANDARD,
                                                buildModelForStandardMenuItem(
                                                                R.id.download_page_id, R.string.menu_download_page,
                                                                0)));
                ...
                if (ChromeFeatureList.isEnabled(
                        ...
                        modelList.add(
                                        new MVCListAdapter.ListItem(
                                                        ...
                                                        buildModelForStandardMenuItem(
                                                                        R.id.ai_web_menu_id,
                                                                        R.string.menu_summarize_with_ai, 0)));
                }
                ...
                if (ChromeFeatureList.isEnabled(BraveFeatureList.BRAVE_SHRED)) {
                        modelList.add(
                                        new MVCListAdapter.ListItem(
                                                        ...
                                                        buildModelForStandardMenuItem(
                                                                        R.id.brave_shred_id,
                                                                        R.string.brave_menu_shred_text, 0)));
                }
                ...
                modelList.add(
                                new MVCListAdapter.ListItem(
                                                ...
                                                buildModelForStandardMenuItem(
                                                                ...
                                                                R.string.menu_listen_to_this_page, 0)));
                        ...
                        modelList.add(
                                        new MVCListAdapter.ListItem(
                                                        ...
                                                        buildModelForStandardMenuItem(
                                                                        ...
                                                                        R.string.show_reading_mode_text, 0)));
                }
                ...
                if (WebappsUtils.isAddToHomeIntentSupported()) {
                        // This is the 'webapp is already installed' case, so we offer to open the
                        // webapp.
                        ...
                        modelList.add(
                                        new MVCListAdapter.ListItem(
                                                        ...
                                                        buildModelForStandardMenuItem(
                                                                        ...
                                                                        R.string.menu_add_to_homescreen, 0)));
                }
                ...
                modelList.add(
                                new MVCListAdapter.ListItem(
                                                ...
                                                buildModelForStandardMenuItem(
                                                                ...
                                                                R.string.menu_reader_mode_prefs, 0)));
                        ...
                        modelList.add(
                                        new MVCListAdapter.ListItem(
                                                        ...
                                                        buildModelForStandardMenuItem(
                                                                        ...
                                                                        R.string.menu_listen_to_feed, 0)));
                }
        ...
        /**
         * Adds a new menu item after the last item with an ID in the previousItemIds
         * list.
         *
         * @param modelList       The model list to which the item will be added.
         * @param itemToAdd       The item to add to the model list.
         * @param previousItemIds A list of IDs of items that should precede the new
         *                        item.
         */
                ...
                return new MVCListAdapter.ListItem(
                                ...
                                buildModelForStandardMenuItem(
                                                ...
                                                shouldShowIconBeforeItem()
                                                                ? org.chromium.brave.browser.customize_menu.R.drawable.ic_window_screwdriver
                                                                : 0));
        }
        ...
        private MVCListAdapter.ListItem buildBraveVpnLocationIconItem() {
                ...
                String regionName = BraveVpnPrefUtils.getRegionPrecision()
                ...
                Drawable secondaryActionIcon = AppCompatResources.getDrawable(mBraveContext,
                ...
                PropertyModel model = buildModelForMenuItemWithSecondaryButton(
        ...
        protected PropertyModel buildPageInfoModel(@Nullable Tab currentTab) {
                ...
                PropertyModel shareButton = buildModelForIcon(
        ...
        /**
         * Method to ensure that the object is created for junit tests to avoid calling
         * the native
         * portion of code.
         *
         * @param isJunitTesting flag indicating whether the native code should be
         *                       avoided.
         */
        @VisibleForTesting
