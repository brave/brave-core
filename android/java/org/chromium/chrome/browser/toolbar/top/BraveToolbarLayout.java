...
public abstract class BraveToolbarLayout extends ToolbarLayout
    ...
    protected void onFinishInflate() {
        ...
        mBraveShieldsMenuHandler =
                new BraveShieldsMenuHandler(mMainActivity, R.menu.brave_shields_menu);
    ...
    void onNativeLibraryReady() {
        ...
        mBraveShieldsContentSettings =
                new BraveShieldsContentSettings(mBraveShieldsContentSettingsObserver);
    ...
    public void OnWalletInitialized(int error_code) {
        if (error_code == BraveRewardsNativeWorker.SAFETYNET_ATTESTATION_FAILED) {
            ...
            AlertDialog alertDialog =
                    alert.setMessage(getResources().getString(R.string.brave_rewards_not_available))
            ...
            if (currentTab != null
                    && getToolbarDataProvider().getCurrentUrl().equals(
            ...
            // Set preferences that Brave Rewards was turned On and that Brave Rewards icon is not
            // hidden
            sharedPreferencesEditor.putBoolean(
                    BraveRewardsPanelPopup.PREF_WAS_BRAVE_REWARDS_TURNED_ON, true);
    ...
    public void OnRewardsMainEnabled(boolean enabled) {
        ...
        sharedPreferencesEditor.putBoolean(
                BraveRewardsPanelPopup.PREF_IS_BRAVE_REWARDS_ENABLED, enabled);
        sharedPreferencesEditor.apply();
