...
public abstract class BraveToolbarLayoutImpl extends ToolbarLayout
    ...
    // TabModelSelectorTabObserver and TabModelSelectorTabModelObserver
    // set the observer at own ctor, suppress [UnusedVariable] warning for both
    ...
    // TODO(alexeybarabash): Seems unused, needs to be rechecked when the project will be compiled
    @SuppressWarnings("UnusedVariable")
        ...
        new AsyncTask<Void>() {
            ...
            protected Void doInBackground() {
                try {
                    ...
                    mDatabaseHelper.insertSavedBandwidth(savedBandwidthTable);
                } catch (Exception e) {
