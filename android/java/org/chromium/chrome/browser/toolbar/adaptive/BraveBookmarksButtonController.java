...
public class BraveBookmarksButtonController extends BaseButtonDataProvider {
    ...
    /**
     * Creates BraveBookmarksButtonController object.
     *
     * @param context The context for retrieving string resources.
     * @param buttonDrawable Drawable for the bookmarks button.
     * @param tabProvider The {@link ActivityTabProvider} used for accessing the tab.
     * @param profileSupplier The supplier to get a handle on the current profile.
     * @param modalDialogManager dispatcher for modal lifecycles events
     * @param bookmarkManagerOpener The {@link BookmarkManagerOpener} used to open bookmark manager.
     */
    ...
    public void onClick(View view) {
        ...
        assert profile != null : "Profile became null after bookmarks button was displayed";
        ...
        mBookmarkManagerOpener.showBookmarkManager(
                (Activity) mContext, tab, profile, /* folderId= */ null);
    }

    @Override
    protected boolean shouldShowButton(@Nullable Tab tab) {
        if (!super.shouldShowButton(tab) || mProfileSupplier.get() == null) return false;
