...
public class TxNonSwipeableViewPager extends ViewPager {
    public TxNonSwipeableViewPager(Context context) {
        super(context);
        setViewPagerScroller();
    }

    public TxNonSwipeableViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        setViewPagerScroller();
    }
