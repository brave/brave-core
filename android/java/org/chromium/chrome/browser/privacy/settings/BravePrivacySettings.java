...
public class BravePrivacySettings extends PrivacySettings {
    ...
    private static final String[] NEW_PRIVACY_PREFERENCE_ORDER = {
            ...
            PREF_FINGERPRINTING_PROTECTION, PREFFINGER_PRINT_LANGUAGE,
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (PREF_HTTPSE.equals(key)) {
            ...
            BravePrefServiceBridge.getInstance().setFingerprintingForLanguageControlEnabled((boolean) newValue);
