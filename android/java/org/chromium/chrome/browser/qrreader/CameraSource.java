...
/**
 * Manages the camera in conjunction with an underlying {@link
 * com.google.android.gms.vision.Detector}. This receives preview frames from the camera at a
 * specified rate, sending those frames to the detector as fast as it is able to process those
 * frames.
 *
 ...
 * is unable to keep up with the rate of frames generated by the camera. You should use {@link
 * CameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with the
 ...
 *
 * <p>The following Android permission is required to use the camera:
 *
 * <ul>
 *   <li>android.permissions.CAMERA
 * </ul>
 */
public class CameraSource {
     ...
     * {@link Frame.Metadata#getRotation()}.
     */
    ...
    public static class Builder {
         ...
         * values are not available options, the best matching available options are selected. Also,
         * we try to select a preview size which corresponds to the aspect ratio of an associated
         * full picture size, if applicable. Default: 1024x768.
         */
        ...
        /**
         * Sets the camera to use (either {@link #CAMERA_FACING_BACK} or {@link
    ...
    public interface PictureCallback {
        /**
         * Called when image data is available after a picture is taken. The format of the data is a
         * jpeg binary.
         */
    ...
    public interface AutoFocusCallback {
        /**
         * Called when the camera auto focus completes. If the camera does not support auto-focus
         * and autoFocus is called, onAutoFocus will be called immediately with a fake value of
         * <code>success</code> set to <code>true</code>.
         *
         * <p>The auto-focus routine does not lock auto-exposure and auto-white balance after it
         * completes.
         *
     ...
     * Camera.Parameters#FOCUS_MODE_CONTINUOUS_PICTURE}. Applications can show autofocus animation
     * based on this.
     */
     ...
     *
     * @return current flash mode. null if flash mode setting is not supported or the camera is not
     *     yet created.
     ...
     *
     * <p>Even though we may only need the preview size, it's necessary to find both the preview
    ...
    private class FrameProcessingRunnable implements Runnable {
         ...
         *
         * <p>If detection takes longer than the time in between new frames from the camera, this
         * will mean that this loop will run without ever waiting on a frame, avoiding any context
         * switching or frame acquisition time latency.
         *
         * <p>If you find that this is using more CPU than you'd like, you should probably decrease
         * the FPS setting above to allow for some idle time in between frames.
         */
        @SuppressWarnings("ByteBufferBackingArray")
        @Override
        public void run() {
