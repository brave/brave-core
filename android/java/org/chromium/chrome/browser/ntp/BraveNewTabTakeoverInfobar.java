        ...
        SnackbarController controller =
                new SnackbarController() {
                    ...
                    public void onAction(@Nullable Object actionData) {
                        ...
                        // showing again. Auto-dismissal (timeout/swipe) is intentionally not
                        // suppressed so the notice can still be shown up to its remaining display
                        // count, which is decremented above on each display.
                        suppressInfobar();
