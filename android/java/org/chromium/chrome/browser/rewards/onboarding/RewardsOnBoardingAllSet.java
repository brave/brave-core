...
/**
 * This class is to show success screen
 * */
public class RewardsOnBoardingAllSet {
    private final View mAnchorView;
    private final PopupWindow mPopupWindow;

    public RewardsOnBoardingAllSet(View anchorView, int deviceWidth) {
    ...
    private void setUpViews(int deviceWidth) {
        ...
        View popupView = inflater.inflate(R.layout.rewards_on_boarding_all_set, null);

        setStartUsingButtonClick(popupView);
        setHowDoesItWorkClick(popupView);
    ...
    private void setStartUsingButtonClick(View view) {
        View doneButton = view.findViewById(R.id.all_set_done_button);
    ...
    private void setHowDoesItWorkClick(View view) {
