...
public class OnboardingStepAdapter
   ...
   private static final int[] STEPS = {
           R.layout.help_brave_search,
           R.layout.block_interruptions,
           R.layout.make_brave_better
   };
   ...
   public OnboardingStepAdapter(final SpannableString wdpLearnMore, final OnboardingNavigationListener listener) {
   ...
   public OnboardingBaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      ...
      return switch (viewType) {
         ...
         case 2 -> new MakeBraveBetterViewHolder(view, mCrashReportingManaged, mCrashReportingChecked, mP3aManaged, mP3aChecked, mListener);
...
//        public void onBindViewHolder(@NonNull OnboardingStepViewHolder holder, int position) {}
   ...
   static abstract class OnboardingBaseViewHolder extends RecyclerView.ViewHolder {
   ...
   private static final class HelpBraveSearchViewHolder extends OnboardingBaseViewHolder {
      ...
      final Button mLater;
      final Button mSure;
      private HelpBraveSearchViewHolder(final View itemView, final SpannableString wdpLearnMore, final OnboardingNavigationListener listener) {
         super(itemView);
   ...
   private static final class BlockInterruptionsViewHolder extends OnboardingBaseViewHolder {
      ...
      private BlockInterruptionsViewHolder(final View itemView, final OnboardingNavigationListener listener) {
         super(itemView);
   ...
   private static final class MakeBraveBetterViewHolder extends OnboardingBaseViewHolder {
      ...
      private MakeBraveBetterViewHolder(final View itemView,
         ...
         if (crashReportingManaged) {
            ...
            mSendCrashReports.setOnCheckedChangeListener((buttonView, isChecked) -> WelcomeOnboardingActivity.setMetricsReportingConsent(isChecked));
         }
         ...
         if (p3aManaged) {
            ...
            mSendP3a.setOnCheckedChangeListener((buttonView, isChecked) -> WelcomeOnboardingActivity.setP3aConsent(isChecked));
         }
      }
