...
void OnRewriteSuggestionDataReceived(
  ...
  if (base::EndsWith(suggestion, "<") || base::EndsWith(suggestion, "</") ||
      base::EndsWith(suggestion, "</r") || base::EndsWith(suggestion, "</re") ||
      base::EndsWith(suggestion, "</res") ||
      base::EndsWith(suggestion, "</resp") ||
      base::EndsWith(suggestion, "</respo") ||
      base::EndsWith(suggestion, "</respon") ||
      base::EndsWith(suggestion, "</respons") ||
      base::EndsWith(suggestion, "</response")) {
    return;
  }
