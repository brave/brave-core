...
#include <chrome/browser/ui/views/page_action/page_action_controller.h>  // IWYU pragma: export
...
#endif  // BRAVE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_PAGE_ACTION_PAGE_ACTION_CONTROLLER_H_
