...
#ifndef BRAVE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_PAGE_ACTION_PAGE_ACTION_MODEL_H_
#define BRAVE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_PAGE_ACTION_PAGE_ACTION_MODEL_H_
...
#include <chrome/browser/ui/views/page_action/page_action_model.h>  // IWYU pragma: export
...
class PageActionModel : public chromium_impl::PageActionModel {
 public:
  ...
  void SetOverrideBorder(base::PassKey<PageActionController>,
                         std::optional<gfx::Insets> insets) override;
...
#endif  // BRAVE_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_PAGE_ACTION_PAGE_ACTION_MODEL_H_
