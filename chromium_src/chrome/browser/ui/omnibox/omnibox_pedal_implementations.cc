...
#define kShareMacChromeRefreshIcon kShareMacIcon
#define kShareWinChromeRefreshIcon kShareWinIcon
...
#undef kShareLinuxChromeRefreshIcon
#undef kShareChromeRefreshIcon
