...
void BraveProfilePolicyConnector::Init(
  ...
  // Init will be called on brave_origin_policy_provider_ in the chromium_src
  // profile_policy_connector_builder.cc override for
...
BraveProfilePolicyConnector::GetBraveOriginPolicyProvider() {
  return brave_origin_policy_provider_;
}
