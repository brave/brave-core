...
IPC_STRUCT_TRAITS_BEGIN(SessionStoreSettings::ExtensionSettings)
  IPC_STRUCT_TRAITS_MEMBER(honey_enabled)
  IPC_STRUCT_TRAITS_MEMBER(active_password_manager)
  IPC_STRUCT_TRAITS_MEMBER(metamask_enabled)
  IPC_STRUCT_TRAITS_MEMBER(pocket_enabled)
IPC_STRUCT_TRAITS_END()
...
IPC_STRUCT_TRAITS_BEGIN(SessionStoreSettings)
  ...
  IPC_STRUCT_TRAITS_MEMBER(extensions)
IPC_STRUCT_TRAITS_END()
