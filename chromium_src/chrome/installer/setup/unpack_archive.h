...
//
// Upstream removed the archive_type and uncompressed_archive values when it
...
// do this by storing the archive_type and uncompressed_archive values in the
// installer_state object.
