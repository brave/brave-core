...
const InstallConstants kInstallModes[] = {
    // The primary install mode for stable Brave.
    {
        ...
        {0x6c9646d,
         0x2807,
         0x44c0,
         {0x97, 0xd2, 0x6d, 0xa0, 0xdb, 0x62, 0x3d, 0xb4}},  // Toast activator
                                                             // CLSID.
        {0x576b31af,
         0x6369,
         0x4b6b,
    ...
    // A secondary install mode for Brave Beta
    {
        ...
        {0x9560028d,
         0xcca,
         0x49f0,
         {0x8d, 0x47, 0xef, 0x22, 0xbb, 0xc4, 0xb, 0xa7}},  // Toast activator
                                                            // CLSID.
        {0x2313f1cd,
         0x41f3,
         0x4347,
    ...
    // A secondary install mode for Brave Dev
    {
        ...
        {0x20b22981,
         0xf63a,
         0x47a6,
         {0xa5, 0x47, 0x69, 0x1c, 0xc9, 0x4c, 0xae, 0xe0}},  // Toast activator
                                                             // CLSID.
        {0x9129ed6a,
         0x11d3,
         0x43b7,
    ...
    // A secondary install mode for Brave SxS (canary).
    {
        ...
        {0xf2edbc59,
         0x7217,
         0x4da5,
         {0xa2, 0x59, 0x3, 0x2, 0xda, 0x6a, 0x0, 0xe1}},  // Toast activator
                                                          // CLSID.
        {0x1ce2f84f,
         0x70cb,
         0x4389,
...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Brave developer build.
    {
        ...
        {0xeb41c6e8,
         0xba35,
         0x4c06,
         {0x96, 0xe8, 0x6f, 0x30, 0xf1, 0x8c, 0xa5, 0x5c}},  // Toast activator
                                                             // CLSID.
        {0x5693e62d,
         0xd6,
         0x4421,
         {0xaf, 0xe8, 0x58, 0xf3, 0xc9, 0x47, 0x43, 0x6a}},  // Elevator CLSID.
        {0xedf6b466,
         0x4efc,
         0x4c88,
