...
def _GetWebuiMessageAndIds(root):
    ...
    for item in root.ActiveDescendants():
        ...
        grouped_messages[webui].append(
            (name[IDS_PREFIX_LEN:], ids_map[name], get_message_text(item)))
...
def _FormatWebuiStorybook(root, *_args, **_kwargs):
    """Generates a JSON file with the strings for storybook usage."""
...
_CUSTOM_FORMATTERS = {
    ...
    'webui_storybook': _FormatWebuiStorybook,
}
