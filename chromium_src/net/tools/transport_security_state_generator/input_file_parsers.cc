...
constexpr std::string_view kBravePinsJson = R"brave_pins_json({
  ...
  "entries": [
    ...
    { "name": "gate3.wallet.brave.com", "pins": "brave"},
    { "name": "gate3.wallet.brave.software", "pins": "brave"},
...
constexpr std::string_view kBraveHstsJson = R"brave_hsts_json({
  "entries": [
    ...
    {
      "name": "gate3.wallet.brave.com",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "gate3.wallet.brave.software",
      "mode": "force-https",
      "policy": "custom"
    },
...
# Last updated: Tue Apr 07 18:41:30 2026
PinsListTimestamp
1775601690
