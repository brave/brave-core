...
# Last updated: Thu Oct 20 17:57:25 UTC 2022
PinsListTimestamp
1666288645
...
bool ParseJSON(base::StringPiece json,
  ...
  base::StringPiece brave_json = R"brave_json({
    ...
    "entries": [
      ...
      { "name": "search.anonymous.ads.brave.com", "mode": "force-https", "policy": "custom", "pins": "brave"},
      { "name": "search.anonymous.ads.bravesoftware.com", "mode": "force-https", "policy": "custom", "pins": "brave"},
