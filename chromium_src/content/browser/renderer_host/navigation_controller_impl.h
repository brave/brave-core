...
#include "src/content/browser/renderer_host/navigation_controller_impl.h"  // IWYU pragma: export
...
class BraveNavigationControllerImpl : public NavigationControllerImpl {
 public:
  ...
  BraveNavigationControllerImpl& operator=(
      const BraveNavigationControllerImpl&) = delete;
