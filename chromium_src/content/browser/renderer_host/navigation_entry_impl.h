...
#define GetMainFrameDocumentSequenceNumber()     \
  ...
  base::optional_ref<const StoragePartitionConfig> GetStoragePartitionConfig()

#include "src/content/browser/renderer_host/navigation_entry_impl.h"  // IWYU pragma: export
