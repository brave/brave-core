...
// *****************************
// *****************************
// TODO: Make UNIT TEST FOR THIS (GetSource) - because the default cause will
// call NOTREACHED() If ever this override doesn't take effect because of a
// chromium upgrade, we need tests to catch this
// *****************************
// *****************************
// *****************************
// *****************************
