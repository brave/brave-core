...
#include <components/permissions/bluetooth_scanning_prompt_controller.h>  // IWYU pragma: export

#undef GetThrobberLabelAndTooltip

#endif  // BRAVE_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_BLUETOOTH_SCANNING_PROMPT_CONTROLLER_H_
