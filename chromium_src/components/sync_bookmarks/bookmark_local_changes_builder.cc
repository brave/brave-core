// This override is for kSyncUSSBookmarks
// TODO(darkdh): use same implementation as bookmark_change_processor.cc in the
// same file since we store objectId in meta info now
namespace bookmarks {
class BookmarkModel;
class BookmarkNode;
}   // namespace bookmarks
