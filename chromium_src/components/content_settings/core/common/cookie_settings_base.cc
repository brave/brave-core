...
constexpr char kWp[] = "https://[*.]fakewp.com/*";
constexpr char kWordpress[] = "https://[*.]fakewordpress.com/*";
constexpr char kPlaystation[] = "https://[*.]fakeplaystation.com/*";
constexpr char kSonyentertainmentnetwork[] =
    "https://[*.]fakesonyentertainmentnetwork.com/*";
constexpr char kSony[] = "https://[*.]fakesony.com/*";
constexpr char kGoogle[] = "https://[*.]fakegoogle.com/*";
constexpr char kGoogleusercontent[] = "https://[*.]fakegoogleusercontent.com/*";
constexpr char kFacebook[] = "https://[*.]fakefacebook.com/*";
constexpr char kInstagram[] = "https://[*.]fakeinstagram.com/*";
