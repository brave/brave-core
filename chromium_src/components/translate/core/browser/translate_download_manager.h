...
class TranslateDownloadManager {
 public:
  ...
  // translate server can translate to or from. May cause a language list
  ...
  // Returns true if |language| is supported by the translation server as either source or target language.
