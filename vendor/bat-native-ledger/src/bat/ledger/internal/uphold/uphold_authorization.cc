...
void UpholdAuthorization::Authorize(
  ...
  if (uphold_wallet->status != mojom::WalletStatus::NOT_CONNECTED &&
...
void UpholdAuthorization::OnAuthorize(
  ...
  const auto to = uphold_wallet->status = mojom::WalletStatus::PENDING;
