...
PostConnectUphold::PostConnectUphold(LedgerImpl* ledger,
                                     const std::string& address)
    : PostConnect(ledger), address_(address) {}

PostConnectUphold::~PostConnectUphold() = default;

base::expected<std::string, base::Location> PostConnectUphold::Content() const {
...
base::expected<std::vector<std::string>, base::Location>
PostConnectUphold::Headers() const {
