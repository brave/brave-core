...
mojom::Result GetRecoverWallet::CheckStatusCode(const int status_code) {
...
mojom::Result GetRecoverWallet::ParseBody(const std::string& body,
...
void GetRecoverWallet::OnRequest(const mojom::UrlResponse& response,
                                 GetRecoverWalletCallback callback) {
