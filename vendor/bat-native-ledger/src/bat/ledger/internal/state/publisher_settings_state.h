...
#ifndef BRAVELEDGER_STATE_PUBLISHER_SETTINGS_STATE_H_
#define BRAVELEDGER_STATE_PUBLISHER_SETTINGS_STATE_H_
...
#endif  // BRAVELEDGER_STATE_PUBLISHER_SETTINGS_STATE_H_
