...
TEST_F(BindUtilTest,
    NullContributionQueueFromStringToPromotionWithInvalidType) {
  ...
  EXPECT_EQ(contribution_queue.get(), nullptr);
}
...
TEST_F(BindUtilTest, NullPromotionFromStringToPromotionWithInvalidType) {
  ...
  EXPECT_EQ(promotion.get(), nullptr);
}

TEST_F(BindUtilTest, NullPromotionFromStringToPromotionWithInvalidStatus) {
