...
/// The client should show the notification to the user. Return true if the
/// notification was successfully shown, otherwise, return false.
- (BOOL)braveAds:(BATBraveAds*)braveAds
    showNotification:(BATAdsNotification*)notification;
...
@property(nonatomic, assign)
    NSInteger numberOfAllowableAdsPerDay NS_SWIFT_NAME(adsPerDay);
