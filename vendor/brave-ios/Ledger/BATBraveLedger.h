...
extern NSString* const BATBraveLedgerErrorDomain
    NS_SWIFT_NAME(BraveLedgerErrorDomain);
...
- (void)addressesForPaymentId:
    (void (^)(NSDictionary<NSString*, NSString*>*))completion NS_UNAVAILABLE;
...
- (void)mediaPublisherInfoForMediaKey:(NSString*)mediaKey
                           completion:
                               (void (^)(BATPublisherInfo* _Nullable info))
                                   completion;
...
- (void)addRecurringTipToPublisherWithId:(NSString*)publisherId
    ...
    NS_SWIFT_NAME(addRecurringTip(publisherId:amount:));
...
- (void)grantCaptchaForPromotionId:(NSString*)promoID
                     promotionType:(NSString*)promotionType
                        completion:(void (^)(NSString* image,
                                             NSString* hint))completion;
...
- (void)adsDetailsForCurrentCycle:
    ...
    NS_SWIFT_NAME(adsDetailsForCurrentCycle(_:));
