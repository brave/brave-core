...
NativeLedgerClient::NativeLedgerClient(id<NativeLedgerClientBridge> bridge)
    : bridge_(bridge) {}
...
void NativeLedgerClient::FetchGrants(const std::string& lang,
...
void NativeLedgerClient::GetActivityInfoList(
    uint32_t start,
    uint32_t limit,
    ledger::ActivityInfoFilter filter,
    ledger::PublisherInfoListCallback callback) {
  [bridge_ getActivityInfoList:start
                         limit:limit
                        filter:filter
                      callback:callback];
}
void NativeLedgerClient::GetCountryCodes(
...
void NativeLedgerClient::LoadActivityInfo(
    ledger::ActivityInfoFilter filter,
    ledger::PublisherInfoCallback callback) {
  [bridge_ loadActivityInfo:filter callback:callback];
}
void NativeLedgerClient::LoadLedgerState(
...
void NativeLedgerClient::LoadNicewareList(
    ledger::GetNicewareListCallback callback) {
  [bridge_ loadNicewareList:callback];
}
void NativeLedgerClient::LoadPanelPublisherInfo(
    ledger::ActivityInfoFilter filter,
    ledger::PublisherInfoCallback callback) {
  [bridge_ loadPanelPublisherInfo:filter callback:callback];
}
void NativeLedgerClient::LoadPublisherInfo(
    const std::string& publisher_key,
    ledger::PublisherInfoCallback callback) {
  [bridge_ loadPublisherInfo:publisher_key callback:callback];
}
void NativeLedgerClient::LoadPublisherList(
    ledger::LedgerCallbackHandler* handler) {
  [bridge_ loadPublisherList:handler];
}
void NativeLedgerClient::LoadPublisherState(
    ledger::LedgerCallbackHandler* handler) {
  [bridge_ loadPublisherState:handler];
}
void NativeLedgerClient::LoadState(const std::string& name,
...
void NativeLedgerClient::OnPanelPublisherInfo(
...
void NativeLedgerClient::OnWalletProperties(
    ledger::Result result,
    std::unique_ptr<ledger::WalletInfo> arg1) {
  [bridge_ onWalletProperties:result arg1:std::move(arg1)];
}
void NativeLedgerClient::RemoveAllPendingContributions(
    const ledger::RemovePendingContributionCallback& callback) {
  [bridge_ removeAllPendingContributions:callback];
}
void NativeLedgerClient::RemovePendingContribution(
    const std::string& publisher_key,
    const std::string& viewing_id,
    uint64_t added_date,
    const ledger::RemovePendingContributionCallback& callback) {
  [bridge_ removePendingContribution:publisher_key
                           viewingId:viewing_id
                           addedDate:added_date
                            callback:callback];
}
void NativeLedgerClient::ResetState(const std::string& name,
                                    ledger::OnResetCallback callback) {
  [bridge_ resetState:name callback:callback];
}
void NativeLedgerClient::SaveActivityInfo(
    ledger::PublisherInfoPtr publisher_info,
    ledger::PublisherInfoCallback callback) {
  [bridge_ saveActivityInfo:std::move(publisher_info) callback:callback];
}
void NativeLedgerClient::SaveContributionInfo(
    const std::string& probi,
    const int month,
    const int year,
    const uint32_t date,
  ...
  [bridge_ saveContributionInfo:probi
                          month:month
                           year:year
                           date:date
...
std::unique_ptr<ledger::LogStream> NativeLedgerClient::VerboseLog(
    const char* file,
    int line,
