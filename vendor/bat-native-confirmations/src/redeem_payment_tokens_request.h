...
#ifndef BAT_CONFIRMATIONS_REDEEM_PAYMENT_TOKENS_REQUEST_H_
#define BAT_CONFIRMATIONS_REDEEM_PAYMENT_TOKENS_REQUEST_H_
...
#endif  // BAT_CONFIRMATIONS_REDEEM_PAYMENT_TOKENS_REQUEST_H_
