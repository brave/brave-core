...
#ifndef BAT_CONFIRMATIONS_REQUEST_SIGNED_TOKENS_REQUEST_H_
#define BAT_CONFIRMATIONS_REQUEST_SIGNED_TOKENS_REQUEST_H_
...
#endif  // BAT_CONFIRMATIONS_REQUEST_SIGNED_TOKENS_REQUEST_H_
