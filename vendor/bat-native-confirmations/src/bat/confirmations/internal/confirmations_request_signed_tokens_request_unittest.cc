  ...
  std::vector<Token> GetTokens(const int count) {
    std::
        vector<std::string>
            tokens_base64 =
                {
                    "B2CbFJJ1gKJy9qs8NMburYj12VAqnVfFrQ2K2u0QwcBi1YoMMHQfRQeDbO"
                    "Q62Z+WrCOTYLbZrBY7+j9hz2jLFL74KSQig7/"
                    "PDbqIpmNYs6PpNUK3MpVc4dm5R9lkySQF",  // NOLINT
                    "MHbZ2XgFtno4g7yq/tmFCr1sFuFrkE7D6JjVAmM70ZJrwH/"
                    "EqYNaWL1qANSKXX9ghyiN8KUDThEhDTqhuBQ4v7gzNY2qHav9uiAmjqvLz"
                    "Dp7oxmUBFohmdkVlvWhxV0F",  // NOLINT
                    "6WWlDOIHNs6Az23V+VM3QTDFFDkR9D0CGZSd27/"
                    "cjo3eO5EDEzi9Ev5omoJwZQHqiObVgUXmRFRa8UYXsL4O4MvBsYlgGz9Vy"
                    "oBLXo0ethmEBowsrMubj3GR4CQaN6gB",  // NOLINT
                    "IzhzMBc/"
                    "rI8uzGuARaudvUYY662c0tqzYDPOfvbWRiThTTyH9fU13nmAmhkdtpoUnD"
                    "lGTE37fLDpjWPlGdAd9r2qh++09+sa9xHV+"
                    "V9SXHbr9gtJBybZMWr8vjQuslMM",  // NOLINT
                    "eZDj3OGto3E0Uz0djk6Ilfgz+"
                    "Ar4kMAXOL68iLTNycBPgoNnM1rtjaL4OqvSc1ascZhGCf6Js42B/"
                    "wPVzUYuKMloATKmYs7Ym+ndXnuX0FV9XJs94tlIGcp4k0uOMcgB",  // NOLINT
                    "8QNMIJuJfu9W4KURg1Y2coXyKjbJOQLmo6RIGg+"
                    "tKkUcY7srgUpac8XteSwWy6o6YLDoNKXS21FmbZ4VHb+"
                    "Bv2NVhBWooK0b8lwQAdVUax5+Ej77qK//GeyRmAcAQV8G",  // NOLINT
                    "6ILvEIM3+"
                    "kgacI6JFa5415qAdzcg6hccQzEyhMsqYFa3MZKzvcLEF57pFFRoaYw7nFD"
                    "QL8v8CDG2iSUoBIk8bmeoUwgdXsgofHvSahcBSWawmcnn8ESJTkZPGgxaF"
                    "gcA",  // NOLINT
                    "VHDbhwcInhhjL/"
                    "HhSF+NyYak7Zy24xzDDTpI+3rsEZ7iL4SYUdcVkFmJ+"
                    "bg8QlmPv8UMTchPBP7CVtCc96jj5PwGMsvAB8t2TffdSK9SHBRx/"
                    "ZINmYSb7x+GTTdqWugB",  // NOLINT
                    "YbH2x8oMkQrPR0uX6h8LrcgXSrPlSg60FFfp8V+"
                    "GM8eiCQTwPJ643kilmlKU/qNZM3e28Hw3W4GPAELnm/"
                    "YxFzG6qJ4B1wVTBdl/myIa0M3QIdoOn2//+JH2u4jRtIgN",  // NOLINT
                    "0/KAtyvRoYLhsQnwu4McuG7pglpDpi2BXQi//FwGu8m/"
                    "O+"
                    "iTh1Lijzpt2RCnotGh0Wid9efnojrYQH5NJv9GYOhUDX7yYHVjUorc6y6S"
                    "kUaO1aATc42RciRQ0cmuQFQC"  // NOLINT
                };
...
TEST_F(ConfirmationsRequestSignedTokensRequestTest, BuildBody) {
  ...
  std::string expected_body =
      R"({"blindedTokens":["iEK4BXJINfAa0kzgpnnukGUAHvH5303+Y/msR5+u/nY=","eAAv7FNH2twpELsYf3glHLlOhnnlIMovIeEgEmcjgyo=","1G0+8546Y6jCIUXG0cKJq0qpkd6NsnG+4w9oSVW3gH8="]})";  // NOLINT
...
TEST_F(ConfirmationsRequestSignedTokensRequestTest, BuildSignatureHeaderValue) {
  ...
  // Assert
  std::string expected_header_value =
      R"(keyId="primary",algorithm="ed25519",headers="digest",signature="m5CxS9uqI7DbZ5UDo51bcLRP2awqcUSU8tfc4t/ysrH47B8OJUG1roQyi6/pjSZj9VJuj296v77c/lxBlCn2DA==")";  // NOLINT
  EXPECT_EQ(expected_header_value, header_value);
}
