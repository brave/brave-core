...
#ifndef BAT_CONFIRMATIONS_INTERNAL_GET_PAYMENT_BALANCE_REQUEST_H_
#define BAT_CONFIRMATIONS_INTERNAL_GET_PAYMENT_BALANCE_REQUEST_H_
...
class GetPaymentBalanceRequest {
 public:
...
#endif  // BAT_CONFIRMATIONS_INTERNAL_GET_PAYMENT_BALANCE_REQUEST_H_
