...
#ifndef BAT_CONFIRMATIONS_INTERNAL_REFILL_UNBLINDED_TOKENS_DELEGATE_H_
#define BAT_CONFIRMATIONS_INTERNAL_REFILL_UNBLINDED_TOKENS_DELEGATE_H_
...
#endif  // BAT_CONFIRMATIONS_INTERNAL_REFILL_UNBLINDED_TOKENS_DELEGATE_H_
