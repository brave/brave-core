...
TEST_F(BatConfirmationsRedeemPaymentTokensRequestTest,
    BuildUrl) {
  // Arrange
  WalletInfo wallet;
  ...
  // Assert
  const std::string expected_url = "https://ads-serve.bravesoftware.com/v1/confirmation/payment/d4ed0af0-bfa9-464b-abd7-67b29d891b8b";  // NOLINT
