 ...
 protected:
  BatAdsRedeemUnblindedTokenTest()
      : redeem_unblinded_token_(std::make_unique<RedeemUnblindedToken>()),
        redeem_unblinded_token_delegate_mock_(std::make_unique<
...
TEST_F(BatAdsRedeemUnblindedTokenTest,
  ...
  EXPECT_CALL(*redeem_unblinded_token_delegate_mock_,
      OnDidRedeemUnblindedToken(expected_confirmation, _)).Times(1);

  EXPECT_CALL(*redeem_unblinded_token_delegate_mock_,
      OnFailedToRedeemUnblindedToken(_, _)).Times(0);
...
TEST_F(BatAdsRedeemUnblindedTokenTest,
  ...
  EXPECT_CALL(*redeem_unblinded_token_delegate_mock_,
      OnDidRedeemUnblindedToken(_, _)).Times(0);

  EXPECT_CALL(*redeem_unblinded_token_delegate_mock_,
      OnFailedToRedeemUnblindedToken(expected_confirmation, true)).Times(1);
