...
TEST_F(BatAdsRedeemUnblindedTokenTest, RedeemUnblindedToken) {
  ...
  const URLEndpoints& endpoints = {
      ...
      {// Fetch payment token request
       R"(/v3/confirmation/d990ed8d-d739-49fb-811b-c2e02158fb60/paymentToken)",
       {{net::HTTP_OK, R"(
            {
...
TEST_F(
  ...
  const URLEndpoints& endpoints = {
      {// Create confirmation request
       R"(/v3/confirmation/d990ed8d-d739-49fb-811b-)",
...
TEST_F(BatAdsRedeemUnblindedTokenTest, RedeemUnblindedTokenIfAdsIsDisabled) {
  ...
  const URLEndpoints& endpoints = {
      {// Create confirmation request
       "/v3/confirmation/d990ed8d-d739-49fb-811b-c2e02158fb60",
       {{418 /* I'm a teapot */, R"(
            {
              "id" : "d990ed8d-d739-49fb-811b-c2e02158fb60",
              "payload" : {},
