...
class BatAdsMarkedAsInappropriateFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsMarkedAsInappropriateFrequencyCapTest()
      : task_environment_(base::test::TaskEnvironment::TimeSource::MOCK_TIME),
        ...
        frequency_cap_(std::make_unique<
            MarkedAsInappropriateFrequencyCap>(ads_.get())) {
  ...
  ~BatAdsMarkedAsInappropriateFrequencyCapTest() override {
  ...
  std::unique_ptr<MarkedAsInappropriateFrequencyCap> frequency_cap_;
