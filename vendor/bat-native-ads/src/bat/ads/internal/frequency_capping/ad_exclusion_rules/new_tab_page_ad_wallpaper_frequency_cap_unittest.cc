...
class BatAdsNewTabPageAdWallpaperFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsNewTabPageAdWallpaperFrequencyCapTest()
      : task_environment_(base::test::TaskEnvironment::TimeSource::MOCK_TIME),
        ...
        frequency_cap_(std::make_unique<
            NewTabPageAdWallpaperFrequencyCap>(ads_.get())) {
  ...
  ~BatAdsNewTabPageAdWallpaperFrequencyCapTest() override {
  ...
  std::unique_ptr<NewTabPageAdWallpaperFrequencyCap> frequency_cap_;
  std::unique_ptr<Database> database_;
};

TEST_F(BatAdsNewTabPageAdWallpaperFrequencyCapTest,
...
TEST_F(BatAdsNewTabPageAdWallpaperFrequencyCapTest,
    AdAllowedForAdWithDifferentWallpaperId) {
  // Arrange
  AdInfo ad_1;
  ...
  get_client()->AppendUuidToNewTabPageAdHistory(ad_2.uuid);
...
TEST_F(BatAdsNewTabPageAdWallpaperFrequencyCapTest,
    AdNotAllowedForAdWithSameWallpaperId) {
  // Arrange
  AdInfo ad;
  ad.uuid = kUuids.at(0);

  get_client()->AppendUuidToNewTabPageAdHistory(ad.uuid);
