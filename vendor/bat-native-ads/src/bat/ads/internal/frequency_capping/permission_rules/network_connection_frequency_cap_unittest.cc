...
class BatAdsNetworkConnectionFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsNetworkConnectionFrequencyCapTest()
      : task_environment_(base::test::TaskEnvironment::TimeSource::MOCK_TIME),
        ...
        frequency_cap_(std::make_unique<
            NetworkConnectionFrequencyCap>(ads_.get())) {
  ...
  ~BatAdsNetworkConnectionFrequencyCapTest() override {
  ...
  std::unique_ptr<NetworkConnectionFrequencyCap> frequency_cap_;
