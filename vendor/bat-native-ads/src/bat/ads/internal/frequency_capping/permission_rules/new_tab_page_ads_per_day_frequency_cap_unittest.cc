...
class BatAdsNewTabPageAdsPerDayFrequencyCapTest : public ::testing::Test {
 protected:
  BatAdsNewTabPageAdsPerDayFrequencyCapTest()
  ...
  ~BatAdsNewTabPageAdsPerDayFrequencyCapTest() override {
