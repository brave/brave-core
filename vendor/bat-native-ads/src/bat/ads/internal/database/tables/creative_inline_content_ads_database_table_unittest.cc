...
TEST_F(BatAdsCreativeInlineContentAdsDatabaseTableTest, GetForCategories) {
  // Arrange
...
TEST_F(BatAdsCreativeInlineContentAdsDatabaseTableTest,
       GetCreativeInlineContentAdsForEmptyCategories) {
  // Arrange
  CreativeInlineContentAdList creative_inline_content_ads;
...
TEST_F(BatAdsCreativeInlineContentAdsDatabaseTableTest,
       GetCreativeInlineContentAdsFromMultipleCategories) {
  // Arrange
  CreativeInlineContentAdList creative_inline_content_ads;
...
TEST_F(BatAdsCreativeInlineContentAdsDatabaseTableTest,
       GetCreativeInlineContentAdsMatchingCaseInsensitiveCategories) {
  // Arrange
  CreativeInlineContentAdList creative_inline_content_ads;
