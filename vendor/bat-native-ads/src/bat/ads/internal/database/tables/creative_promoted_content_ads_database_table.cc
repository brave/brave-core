...
void CreativePromotedContentAds::Delete(
    ResultCallback callback) {
  DBTransactionPtr transaction = DBTransaction::New();
...
void CreativePromotedContentAds::GetAll(
  ...
  AdsClientHelper::Get()->RunDBTransaction(std::move(transaction),
      std::bind(&CreativePromotedContentAds::OnGetAll, this,
          std::placeholders::_1, callback));
}

void CreativePromotedContentAds::set_batch_size(
...
void CreativePromotedContentAds::CreateTableV9(
    DBTransaction* transaction) {
  DCHECK(transaction);
...
void CreativePromotedContentAds::MigrateToV9(
    DBTransaction* transaction) {
  DCHECK(transaction);
