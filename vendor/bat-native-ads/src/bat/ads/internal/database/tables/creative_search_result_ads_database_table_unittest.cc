...
class BatAdsCreativeSearchResultAdsDatabaseTableTest : public UnitTestBase {
 protected:
  BatAdsCreativeSearchResultAdsDatabaseTableTest()
      : database_table_(
            std::make_unique<database::table::CreativeSearchResultAds>()) {}

  ~BatAdsCreativeSearchResultAdsDatabaseTableTest() override = default;

  void Save(const CreativeSearchResultAdList& creative_search_result_ads) {
    database_table_->Save(creative_search_result_ads,
                          [](const bool success) { ASSERT_TRUE(success); });
  }

  std::unique_ptr<database::table::CreativeSearchResultAds> database_table_;
};

TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       SaveEmptyCreativeSearchResultAds) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads = {};

  // Act
  Save(creative_search_result_ads);

  // Assert
}

TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       SaveCreativeSearchResultAds) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;

  CreativeDaypartInfo daypart_info;
  CreativeSearchResultAdInfo info_1;
  ...
  info_1.ptr = 1.0;
  creative_search_result_ads.push_back(info_1);

  CreativeSearchResultAdInfo info_2;
  ...
  info_2.ptr = 0.8;
  creative_search_result_ads.push_back(info_2);

  // Act
  Save(creative_search_result_ads);

  // Assert
  const CreativeSearchResultAdList expected_creative_search_result_ads =
  ...
  database_table_->GetForSegments(
      segments,
      [&expected_creative_search_result_ads](
          const bool success, const SegmentList& segments,
          const CreativeSearchResultAdList& creative_search_result_ads) {
        EXPECT_TRUE(success);
        EXPECT_TRUE(CompareAsSets(expected_creative_search_result_ads,
                                  creative_search_result_ads));
      });
}

TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       SaveCreativeSearchResultAdsInBatches) {
  // Arrange
  ...
  CreativeSearchResultAdInfo info_3;
  ...
  info_3.ptr = 1.0;
  creative_search_result_ads.push_back(info_3);
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       DoNotSaveDuplicateCreativeSearchResultAds) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest, GetForSegments) {
  // Arrange
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       GetCreativeSearchResultAdsForCreativeInstanceId) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
  ...
  // Assert
  const CreativeSearchResultAdInfo expected_creative_search_result_ad = info;
  ...
  database_table_->GetForCreativeInstanceId(
      ...
      [&expected_creative_search_result_ad](
          const bool success, const std::string& creative_instance_id,
          const CreativeSearchResultAdInfo& creative_search_result_ad) {
        ASSERT_TRUE(success);
        EXPECT_EQ(expected_creative_search_result_ad,
                  creative_search_result_ad);
      });
}

TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       GetCreativeSearchResultAdsForNonExistentCreativeInstanceId) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       GetCreativeSearchResultAdsForEmptySegments) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       GetCreativeSearchResultAdsForNonExistentSegment) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       GetCreativeSearchResultAdsFromMultipleSegments) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
  ...
  // Assert
  CreativeSearchResultAdList expected_creative_search_result_ads;
  expected_creative_search_result_ads.push_back(info_1);
  expected_creative_search_result_ads.push_back(info_2);
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       GetNonExpiredCreativeSearchResultAds) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest,
       GetCreativeSearchResultAdsMatchingCaseInsensitiveSegments) {
  // Arrange
  CreativeSearchResultAdList creative_search_result_ads;
...
TEST_F(BatAdsCreativeSearchResultAdsDatabaseTableTest, TableName) {
  // Arrange
  ...
  // Assert
  const std::string expected_table_name = "creative_search_result_ads";
