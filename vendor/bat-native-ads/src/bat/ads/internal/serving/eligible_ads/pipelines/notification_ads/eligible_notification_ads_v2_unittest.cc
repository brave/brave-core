...
class BatAdsEligibleNotificationAdsV2Test : public UnitTestBase {
 protected:
  BatAdsEligibleNotificationAdsV2Test()
      : database_table_(
...
TEST_F(BatAdsEligibleNotificationAdsV2Test, GetAds) {
  ...
  notification_ads::EligibleAdsV2 eligible_ads(&subdivision_targeting,
...
TEST_F(BatAdsEligibleNotificationAdsV2Test, GetIfNoEligibleAds) {
  // Arrange
