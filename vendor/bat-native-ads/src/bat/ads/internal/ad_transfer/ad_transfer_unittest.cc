...
class BatAdsAdTransferTest
 ...
 protected:
  ...
  void OnAdTransferFailed(
     const AdInfo& ad) override {
    ad_transfer_count_--;
  }

  int GetAdTransferCount() {
    return ad_transfer_count_;
  }
