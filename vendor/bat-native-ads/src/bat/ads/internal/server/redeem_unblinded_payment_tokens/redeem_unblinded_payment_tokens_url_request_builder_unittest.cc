...
privacy::UnblindedTokenList GetUnblindedTokens(
    const int count) {
...
TEST(BatAdsRedeemUnblindedPaymentTokensRequestTest,
    BuildUrl) {
  // Arrange
  WalletInfo wallet;
  ...
  RedeemUnblindedPaymentTokensUrlRequestBuilder
      url_request_builder(wallet, unblinded_tokens);
