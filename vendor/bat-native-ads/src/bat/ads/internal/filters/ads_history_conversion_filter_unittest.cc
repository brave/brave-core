...
class BatAdsHistoryConversionFilterTest
    : public ::testing::Test {
 protected:
  BatAdsHistoryConversionFilterTest()
      : filter_(std::make_unique<
          AdsHistoryConversionFilter>()) {
    // You can do set-up work for each test here
  }

  ~BatAdsHistoryConversionFilterTest() override {
...
TEST_F(BatAdsHistoryConversionFilterTest,
