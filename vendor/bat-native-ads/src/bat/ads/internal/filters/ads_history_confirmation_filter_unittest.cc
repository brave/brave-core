...
TEST(BatAdsHistoryConfirmationFilterTest,
  ...
  ad6.ad_content.type = AdContent::AdType::kAdNotification;
...
TEST(BatAdsHistoryConfirmationFilterTest,
  ...
  ad2.ad_content.type = AdContent::AdType::kNewTabPageAd;
  ...
  ad4.ad_content.type = AdContent::AdType::kNewTabPageAd;
  ...
  ad6.ad_content.type = AdContent::AdType::kNewTabPageAd;
  ...
  ad7.ad_content.type = AdContent::AdType::kNewTabPageAd;
  ...
  ad8.ad_content.type = AdContent::AdType::kNewTabPageAd;
