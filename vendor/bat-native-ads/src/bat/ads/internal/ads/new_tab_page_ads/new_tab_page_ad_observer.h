...
#ifndef BAT_ADS_INTERNAL_ADS_NEW_TAB_PAGE_ADS_NEW_TAB_PAGE_AD_OBSERVER_H_
#define BAT_ADS_INTERNAL_ADS_NEW_TAB_PAGE_ADS_NEW_TAB_PAGE_AD_OBSERVER_H_
...
class NewTabPageAdObserver : public base::CheckedObserver {
 public:
  ...
  virtual void OnNewTabPageAdViewed(
      const NewTabPageAdInfo& ad) {}

  // Invoked when a new tab page ad is clicked
  virtual void OnNewTabPageAdClicked(
      const NewTabPageAdInfo& ad) {}
...
#endif  // BAT_ADS_INTERNAL_ADS_NEW_TAB_PAGE_ADS_NEW_TAB_PAGE_AD_OBSERVER_H_
