...
ExclusionRulesBase::ExclusionRulesBase(
  ...
  TIME_PROFILER_BEGIN("perf.exclusion_rules");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "SplitTest");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules",
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "AntiTargeting");

  dislike_exclusion_rule_ = std::make_unique<DislikeExclusionRule>();
  exclusion_rules_.push_back(dislike_exclusion_rule_.get());
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "Dislike");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "Conversion");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "Transferred");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "TotalMax");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "PerMonth");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "PerWeek");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "DailyCap");
  ...
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "PerDay");

  daypart_exclusion_rule_ = std::make_unique<DaypartExclusionRule>();
  exclusion_rules_.push_back(daypart_exclusion_rule_.get());
  TIME_PROFILER_MEASURE_WITH_MESSAGE("perf.exclusion_rules", "Daypart");
}
