...
#ifndef BAT_ADS_INTERNAL_ADS_AD_NOTIFICATIONS_AD_NOTIFICATION_OBSERVER_H_
...
class AdNotificationObserver : public base::CheckedObserver {
 public:
  ...
  virtual void OnAdNotificationViewed(
      const AdNotificationInfo& ad) {}

  // Invoked when an ad notification is clicked
  virtual void OnAdNotificationClicked(
      const AdNotificationInfo& ad) {}

  // Invoked when an ad notification is dismissed
  virtual void OnAdNotificationDismissed(
      const AdNotificationInfo& ad) {}

  // Invoked when an ad notification times out
  virtual void OnAdNotificationTimedOut(
      const AdNotificationInfo& ad) {}
...
#endif  // BAT_ADS_INTERNAL_ADS_AD_NOTIFICATIONS_AD_NOTIFICATION_OBSERVER_H_
