...
const base::flat_set<base::StringPiece>& GetLanguageComponentIds() {
  static const base::NoDestructor<base::flat_set<base::StringPiece>>
      kLanguageComponentIds({"ijmgabghpbflfadffhpmjklamndnonha",
...
bool IsValidLanguageComponentId(const std::string& id) {
  return base::Contains(GetLanguageComponentIds(), id);
}
