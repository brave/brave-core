...
const base::flat_set<base::StringPiece>& GetCountryComponentIds() {
  static const base::NoDestructor<base::flat_set<base::StringPiece>>
      kCountryComponentIds({"jememeholcpjpoahinnlafoiaknnmfgl",
...
bool IsValidCountryComponentId(const std::string& id) {
  return base::Contains(GetCountryComponentIds(), id);
}
