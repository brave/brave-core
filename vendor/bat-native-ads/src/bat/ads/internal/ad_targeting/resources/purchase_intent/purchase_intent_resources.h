...
#ifndef BAT_ADS_INTERNAL_AD_TARGETING_RESOURCES_PURCHASE_INTENT_PURCHASE_INTENT_RESOURCES_H_  // NOLINT
#define BAT_ADS_INTERNAL_AD_TARGETING_RESOURCES_PURCHASE_INTENT_PURCHASE_INTENT_RESOURCES_H_  // NOLINT
...
const std::set<std::string> kPurchaseIntentIds = {
...
#endif  // BAT_ADS_INTERNAL_AD_TARGETING_RESOURCES_PURCHASE_INTENT_PURCHASE_INTENT_RESOURCES_H_  // NOLINT
