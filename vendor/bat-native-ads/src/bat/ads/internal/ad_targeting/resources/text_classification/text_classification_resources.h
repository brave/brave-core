...
#ifndef BAT_ADS_INTERNAL_AD_TARGETING_RESOURCES_TEXT_CLASSIFICATION_TEXT_CLASSIFICATION_RESOURCES_H_  // NOLINT
#define BAT_ADS_INTERNAL_AD_TARGETING_RESOURCES_TEXT_CLASSIFICATION_TEXT_CLASSIFICATION_RESOURCES_H_  // NOLINT
...
const std::set<std::string> kTextClassificationIds = {
...
const std::map<std::string, std::string> kTextClassificationLanguageCodes = {
  {
...
#endif  // BAT_ADS_INTERNAL_AD_TARGETING_RESOURCES_TEXT_CLASSIFICATION_TEXT_CLASSIFICATION_RESOURCES_H_  // NOLINT
