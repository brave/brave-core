...
static const std::vector<SearchProviderInfo> _search_providers = {
    SearchProviderInfo("Amazon",
                       ...
                       "?field-keywords={searchTerms}&mode=blended",  // NOLINT
                       false),
    ...
    SearchProviderInfo(
        ...
        "sort=relevance&search_category=0&page=",  // NOLINT
        false),
    SearchProviderInfo(
        "StartPage",
        "https://startpage.com",
        "https://www.startpage.com/do/"
        "dsearch?query={searchTerms}&cat=web&pl=opensearch",  // NOLINT
        true),
    SearchProviderInfo(
        "Infogalactic",
        "https://infogalactic.com",
        "https://infogalactic.com/w/"
        "index.php?title=Special:Search&search={searchTerms}",  // NOLINT
        false),
