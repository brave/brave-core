...
#ifndef BAT_ADS_INTERNAL_CLASSIFICATION_PAGE_CLASSIFIER_H_
#define BAT_ADS_INTERNAL_CLASSIFICATION_PAGE_CLASSIFIER_H_
...
#endif  // BAT_ADS_INTERNAL_CLASSIFICATION_PAGE_CLASSIFIER_H_
