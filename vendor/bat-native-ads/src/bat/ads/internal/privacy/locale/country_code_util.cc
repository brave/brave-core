...
const base::flat_set<base::StringPiece>& GetCountryCodeAnonymitySet() {
  static const base::NoDestructor<base::flat_set<base::StringPiece>>
      kCountryCodeAnonymitySet({
  ...
  return *kCountryCodeAnonymitySet;
}

const base::flat_set<base::StringPiece>& GetOtherCountryCodes() {
  static const base::NoDestructor<base::flat_set<base::StringPiece>>
      kOtherCountryCodes({
          "AS",  // American Samoa
          "AI",  // Anguilla
