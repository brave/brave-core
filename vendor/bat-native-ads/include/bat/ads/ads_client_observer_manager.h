...
#ifndef BRAVE_VENDOR_BAT_NATIVE_ADS_INCLUDE_BAT_ADS_ADS_CLIENT_OBSERVER_MANAGER_H_
#define BRAVE_VENDOR_BAT_NATIVE_ADS_INCLUDE_BAT_ADS_ADS_CLIENT_OBSERVER_MANAGER_H_
...
class AdsClientObserverManager {
 public:
  AdsClientObserverManager();

  AdsClientObserverManager(const AdsClientObserverManager& other) = delete;
  AdsClientObserverManager& operator=(const AdsClientObserverManager& other) =
      delete;

  AdsClientObserverManager(AdsClientObserverManager&& other) noexcept = delete;
  AdsClientObserverManager& operator=(
      AdsClientObserverManager&& other) noexcept = delete;

  virtual ~AdsClientObserverManager();
 ...
 private:
  base::ObserverList<ads::AdsClientObserver> observers_;
};

}  // namespace ads

#endif  // BRAVE_VENDOR_BAT_NATIVE_ADS_INCLUDE_BAT_ADS_ADS_CLIENT_OBSERVER_MANAGER_H_
