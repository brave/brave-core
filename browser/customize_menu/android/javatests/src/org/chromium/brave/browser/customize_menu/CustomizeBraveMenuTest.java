...
public class CustomizeBraveMenuTest {
    ...
    public void testApplyCustomization_RemovesHiddenItems() {
        ...
        PropertyModel item1 = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
                .with(AppMenuItemProperties.MENU_ITEM_ID, R.id.new_tab_menu_id)
                .with(AppMenuItemProperties.TITLE, "New Tab")
                .build();
        PropertyModel item2 = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
        ...
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, item1));
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, item2));

        // Hide download item.
        String key = String.format(BravePreferenceKeys.CUSTOMIZABLE_BRAVE_MENU_ITEM_ID_FORMAT,
        ...
        assertEquals(R.id.new_tab_menu_id, 
    ...
    public void testApplyCustomization_PreservesCustomizeAndSettingsItems() {
        ...
        PropertyModel customizeItem = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
                .with(AppMenuItemProperties.MENU_ITEM_ID, CustomizeBraveMenu.BRAVE_CUSTOMIZE_ITEM_ID)
                .with(AppMenuItemProperties.TITLE, "Customize")
                .build();
        PropertyModel settingsItem = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
        ...
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, settingsItem));
    ...
    public void testSanitizeSeparators_RemovesLeadingSeparators() {
        ...
        PropertyModel item = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
                .with(AppMenuItemProperties.MENU_ITEM_ID, R.id.new_tab_menu_id)
                .with(AppMenuItemProperties.TITLE, "New Tab")
                .build();
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, item));
    ...
    public void testPopulateBundle() {
        ...
        // Add test items.
        PropertyModel menuItem = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
                .with(AppMenuItemProperties.MENU_ITEM_ID, R.id.new_tab_menu_id)
                .with(AppMenuItemProperties.TITLE, "New Tab")
                .build();
        menuItems.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, menuItem));
        
        PropertyModel pageAction = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
                .with(AppMenuItemProperties.MENU_ITEM_ID, R.id.share_menu_id)
                .with(AppMenuItemProperties.TITLE, "Share")
                .build();
        pageActions.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, pageAction));
    ...
    public void testPropagateMenuItemExtras_NullPreference() {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(CustomizeBraveMenu.KEY_MAIN_MENU_ITEM_LIST, new ArrayList<>());
    ...
    public void testApplyCustomization_WithSeparators() {
        ...
        PropertyModel item2 = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
                ...
                .with(AppMenuItemProperties.TITLE, "Downloads")
                .build();
        PropertyModel item3 = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
                .with(AppMenuItemProperties.MENU_ITEM_ID, R.id.all_bookmarks_menu_id)
                .with(AppMenuItemProperties.TITLE, "Bookmarks")
                .build();
        PropertyModel separator = new PropertyModel.Builder(AppMenuItemProperties.ALL_KEYS)
        ...
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, item1));
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.DIVIDER, separator));
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, item2));
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.DIVIDER, separator));
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.DIVIDER, separator));
        mModelList.add(new MVCListAdapter.ListItem(
                AppMenuHandler.AppMenuItemType.STANDARD, item3));
