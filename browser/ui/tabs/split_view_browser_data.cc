...
void SplitViewBrowserData::TileTabs(const StripTile& tile) {
...
std::vector<StripTile>::iterator SplitViewBrowserData::FindTile(
...
std::vector<StripTile>::const_iterator SplitViewBrowserData::FindTile(
...
void SplitViewBrowserData::SwapTabsInTile(const StripTile& tile) {
...
std::optional<StripTile> SplitViewBrowserData::GetTile(
    const tabs::TabHandle& tab) const {
