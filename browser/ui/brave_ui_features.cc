...
// Enables a proof-of-concept that lets users add custom New Tab Page widgets
// generated by Leo AI chat. Widgets render in an isolated chrome-untrusted
// sandbox. Disabled by default (dev-only).
BASE_FEATURE(kBraveNtpCustomWidgets, base::FEATURE_DISABLED_BY_DEFAULT);
