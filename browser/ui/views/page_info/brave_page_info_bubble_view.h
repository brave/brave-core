...
class BravePageInfoBubbleView : public PageInfoBubbleView {
 ...
 private:
  ...
  // Applies Brave-specific customizations to the Chromium page info view.
  // Only applies changes when the Shields integration feature is enabled.
  void CustomizeChromiumView();
