...
void BravePageInfoBubbleView::UpdateTabButtons() {
  UpdateTabButton(Tab::kSiteSettings);
  UpdateTabButton(Tab::kShields);
}

void BravePageInfoBubbleView::UpdateTabButton(Tab tab) {
...
int BravePageInfoBubbleView::GetTabButtonText(Tab tab) const {
  switch (tab) {
...
const gfx::VectorIcon& BravePageInfoBubbleView::GetTabButtonIcon(Tab tab) {
  switch (tab) {
    case BravePageInfoBubbleView::Tab::kShields:
      return IsShieldsEnabledForWebContents() ? kLeoShieldDoneIcon
