...
//   views::SizeBounds GetAvailableSize(const views::View* child) const
//   override; std::vector<Tab*> AddTabs(
...
//   views::View* TargetForRect(views::View* root, const gfx::Rect& rect)
//   override;
