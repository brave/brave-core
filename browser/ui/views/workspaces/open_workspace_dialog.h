...
#ifndef BRAVE_BROWSER_UI_VIEWS_WORKSPACES_OPEN_WORKSPACE_DIALOG_H_
#define BRAVE_BROWSER_UI_VIEWS_WORKSPACES_OPEN_WORKSPACE_DIALOG_H_
...
class OpenWorkspaceDialog : public views::DialogDelegateView {
 ...
 private:
  OpenWorkspaceDialog(Browser* browser,
  ...
  std::vector<WorkspaceMetadata> workspaces_;
...
#endif  // BRAVE_BROWSER_UI_VIEWS_WORKSPACES_OPEN_WORKSPACE_DIALOG_H_
