...
void OnionLocationPageActionController::ResetPageAction() {
  page_action_controller_->HideSuggestionChip(kActionShowOnionLocation);
  page_action_controller_->Hide(kActionShowOnionLocation);
  page_action_controller_->SetAlwaysShowLabel(kActionShowOnionLocation, false);
  page_action_controller_->ClearOverrideChipColors(kActionShowOnionLocation);
  page_action_controller_->ClearOverrideText(kActionShowOnionLocation);
  page_action_controller_->ClearOverrideTooltip(kActionShowOnionLocation);
}
