...
class WaybackMachinePageActionController {
 ...
 private:
  ...
  // Unregisters from the current BraveWaybackMachineTabHelper. Must be called
  // before the helper's WebContents is destroyed or swapped out.
  void DetachFromTabHelper();
