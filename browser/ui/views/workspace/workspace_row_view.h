...
#ifndef BRAVE_BROWSER_UI_VIEWS_WORKSPACE_WORKSPACE_ROW_VIEW_H_
#define BRAVE_BROWSER_UI_VIEWS_WORKSPACE_WORKSPACE_ROW_VIEW_H_
...
class WorkspaceRowView : public views::View {
 ...
 private:
  void FormatStats(const WorkspaceInfo& info);
...
#endif  // BRAVE_BROWSER_UI_VIEWS_WORKSPACE_WORKSPACE_ROW_VIEW_H_
