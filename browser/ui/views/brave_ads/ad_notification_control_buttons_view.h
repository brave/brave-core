...
#ifndef BRAVE_BROWSER_UI_VIEWS_BRAVE_ADS_AD_NOTIFICATION_CONTROL_BUTTONS_VIEW_H_
#define BRAVE_BROWSER_UI_VIEWS_BRAVE_ADS_AD_NOTIFICATION_CONTROL_BUTTONS_VIEW_H_
...
#endif  // BRAVE_BROWSER_UI_VIEWS_BRAVE_ADS_AD_NOTIFICATION_CONTROL_BUTTONS_VIEW_H_
