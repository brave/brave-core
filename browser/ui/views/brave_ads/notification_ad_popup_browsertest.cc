...
IN_PROC_BROWSER_TEST_F(NotificationAdPopupBrowserTest, CheckThemeChanged) {
  ...
  const NotificationAd ad(notification_id, u"&#x1F389; You're now earning!",
                          u"You earn whenever a notification like this appears "
                          u"on your screen. You don't need to click to earn.",
                          {});
