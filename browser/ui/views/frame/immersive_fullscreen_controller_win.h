...
class ImmersiveFullscreenControllerWin
    : public aura::WindowObserver,
      ...
      public SimpleImmersiveRevealedLock::Delegate {
 public:
  ...
  [[nodiscard]] SimpleImmersiveRevealedLock* GetRevealedLock(
  ...
  // SimpleImmersiveRevealedLock::Delegate overrides:
 ...
 private:
  ...
  std::unique_ptr<SimpleImmersiveRevealedLock> located_event_revealed_lock_;
