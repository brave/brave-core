...
BraveBrowserViewTabbedLayoutImpl::CalculateContentsCornerRadii() const {
  ...
  // Corners that meet another UI element are drawn with the smaller border
  // radius; those that meet the window frame follow the window's own corner.
  // Sides are in visual coordinates, matching how the radii are painted.
