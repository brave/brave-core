...
// The translate bubble will be shown if ENABLE_BRAVE_TRANSLATE or
// ENABLE_EXTENSIONS build flag is enabled and Google Translate is not
// installed. In ENABLE_BRAVE_TRANSLATE case, we utilize chromium's translate
// UI directly along with go-translate. In ENABLE_EXTENSIONS case, we repurpose
// the translate bubble to offer Google Translate extension installation, and
// the bubble will only be shown when Google Translate is not installed.
