...
class BraveBrowserView : public BrowserView,
 ...
 public:
  ...
  void OnWillBreakTile(const StripTile& tile) override;
  void OnSwapTabsInTile(const StripTile& tile) override;
 ...
 private:
  ...
  bool IsActiveWebContentsTiled(const StripTile& tile);
