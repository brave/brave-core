...
class RewardsDOMHandler : public WebUIMessageHandler,
 ...
 private:
  void CheckInitialized(const base::ListValue* args);
...
void RewardsDOMHandler::RegisterMessages() {
  ...
  web_ui()->RegisterMessageCallback("brave_rewards.checkInitialized",
      base::BindRepeating(&RewardsDOMHandler::CheckInitialized,
...
void RewardsDOMHandler::CheckInitialized(
