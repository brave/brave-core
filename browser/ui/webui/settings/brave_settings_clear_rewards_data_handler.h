...
class ClearRewardsDataHandler : public SettingsPageUIHandler,
 ...
 private:
  ...
  void OnContributionStarted() override;

  void OnContributionComplete() override;
...
#endif  // BRAVE_BROWSER_UI_WEBUI_SETTINGS_BRAVE_SETTINGS_CLEAR_REWARDS_DATA_HANDLER_H_  // NOLINT
