...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
    ...
    {"customizeWireguardAllowedIPsLabel", IDS_SETTINGS_VPN_PAGE_CUSTOMIZE_WIREGUARD_ALLOWED_IPS_LABEL},
    {"customizeWireguardAllowedIPsDesc", IDS_SETTINGS_VPN_PAGE_CUSTOMIZE_WIREGUARD_ALLOWED_IPS_DESC},
    {"wireguardChangeAllowedIPsButtonLabel", IDS_SETTINGS_VPN_PAGE_CHANGE_WIREGUARD_ALLOWED_IPS_BUTTON_LABEL},
    {"changeAllowedIPsDialogTitle", IDS_SETTINGS_VPN_PAGE_CHANGE_WIREGUARD_ALLOWED_IPS_DIALOG_TITLE},
    {"changeAllowedIPsDialogLabel", IDS_SETTINGS_VPN_PAGE_CHANGE_WIREGUARD_ALLOWED_IPS_DIALOG_LABEL},
