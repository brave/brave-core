...
#endif
      {"braveCustomAvatarTitle", IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_TITLE},
      {"braveCustomAvatarUpload", IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_UPLOAD},
      {"braveCustomAvatarRemove", IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_REMOVE},
      {"braveCustomAvatarErrorFileTooLarge",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_FILE_TOO_LARGE},
      {"braveCustomAvatarErrorInvalidFormat",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_INVALID_FORMAT},
      {"braveCustomAvatarErrorDecodeFailed",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_DECODE_FAILED},
      {"braveCustomAvatarErrorTooLarge",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_TOO_LARGE},
      {"braveCustomAvatarErrorEmpty",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_EMPTY},
      {"braveCustomAvatarErrorSaveFailed",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_SAVE_FAILED},
      {"braveCustomAvatarErrorSharedBuffer",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_SHARED_BUFFER},
      {"braveCustomAvatarErrorProfileShuttingDown",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_PROFILE_SHUTTING_DOWN},
      {"braveCustomAvatarErrorNoProfile",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_NO_PROFILE},
      {"braveCustomAvatarErrorGeneric",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_GENERIC},
      {"braveCustomAvatarErrorActionFailed",
       IDS_SETTINGS_BRAVE_CUSTOM_AVATAR_ERROR_ACTION_FAILED},
