...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Pin shortcut page
      ...
      {"braveOriginHeadingDescription3",
       IDS_SETTINGS_BRAVE_ORIGIN_HEADING_DESCRIPTION3},
      {"braveOriginItemEnabledSubtitle",
       IDS_SETTINGS_BRAVE_ORIGIN_ITEM_ENABLED_SUBTITLE},
      ...
      {"braveOriginCrashReportingToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_CRASH_REPORTING_TOGGLE_TITLE},
