...
#endif
    {"autofillEnableAutocompleteLabel",
     IDS_SETTINGS_BRAVE_AUTOFILL_ENABLE_AUTOCOMPLETE_TOGGLE_LABEL},
    {"autofillEnableAutocompleteSublabel",
     IDS_SETTINGS_BRAVE_AUTOFILL_ENABLE_AUTOCOMPLETE_TOGGLE_SUBLABEL},
    {"autofillEnableProfilesLabel",
     IDS_SETTINGS_BRAVE_AUTOFILL_ENABLE_PROFILES_TOGGLE_LABEL},
    {"autofillEnableProfilesSublabel",
     IDS_SETTINGS_BRAVE_AUTOFILL_ENABLE_PROFILES_TOGGLE_SUBLABEL},
