...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveLeoPremiumLabelNonPremium",
       IDS_AI_CHAT_MODEL_PREMIUM_LABEL_NON_PREMIUM},
      {"braveLeoAssistantModelSelectionLabel",
       IDS_SETTINGS_LEO_ASSISTANT_MODEL_SELECTION_LABEL},
      {"braveLeoModelSubtitle-chat-basic", IDS_AI_CHAT_CHAT_BASIC_SUBTITLE},
      {"braveLeoModelSubtitle-chat-leo-expanded",
       IDS_AI_CHAT_CHAT_LEO_EXPANDED_SUBTITLE},
      {"braveLeoModelSubtitle-chat-claude-instant",
       IDS_AI_CHAT_CHAT_CLAUDE_INSTANT_SUBTITLE},
      {"braveLeoModelSubtitle-chat-claude-haiku",
       IDS_AI_CHAT_CHAT_CLAUDE_HAIKU_SUBTITLE},
      {"braveLeoModelSubtitle-chat-claude-sonnet",
       IDS_AI_CHAT_CHAT_CLAUDE_SONNET_SUBTITLE},
      {"braveLeoModelSubtitle-chat-qwen", IDS_AI_CHAT_CHAT_QWEN_SUBTITLE},
      {"braveLeoModelSubtitle-chat-vision-basic",
       IDS_AI_CHAT_CHAT_VISION_BASIC_SUBTITLE},
      {"braveLeoModelSubtitle-chat-deepseek-r1",
       IDS_AI_CHAT_CHAT_DEEPSEEK_R1_SUBTITLE},
      ...
      {"braveLeoModelSectionTitle", IDS_AI_CHAT_MENU_TITLE_MODELS},
