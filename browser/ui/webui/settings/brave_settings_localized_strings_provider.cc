...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
    ...
    {"siteSettingsClipboardDescription",
     IDS_SETTINGS_SITE_SETTINGS_CLIPBOARD_OVERRIDE_DESCRIPTION},
    {"siteSettingsClipboardAsk",
     IDS_SETTINGS_SITE_SETTINGS_CLIPBOARD_OVERRIDE_ALLOW},
    {"siteSettingsClipboardBlock",
     IDS_SETTINGS_SITE_SETTINGS_CLIPBOARD_OVERRIDE_BLOCK},
    {"siteSettingsClipboardAllowed",
     IDS_SETTINGS_SITE_SETTINGS_CLIPBOARD_OVERRIDE_ALLOW},
    {"siteSettingsClipboardBlocked",
     IDS_SETTINGS_SITE_SETTINGS_CLIPBOARD_OVERRIDE_BLOCK},
    {"siteSettingsClipboardAllowedExceptions",
     IDS_SETTINGS_SITE_SETTINGS_CLIPBOARD_OVERRIDE_ALLOWED_EXCEPTIONS},
    {"siteSettingsClipboardBlockedExceptions",
     IDS_SETTINGS_SITE_SETTINGS_CLIPBOARD_OVERRIDE_BLOCKED_EXCEPTIONS},
