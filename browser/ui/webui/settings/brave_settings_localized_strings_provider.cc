...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveSyncSetupSubtitle1", IDS_SETTINGS_BRAVE_SYNC_SETUP_SUBTITLE_1},
      {"braveSyncSetupSubtitle2", IDS_SETTINGS_BRAVE_SYNC_SETUP_SUBTITLE_2},
      ...
      {"braveSyncCreateBraveAccountButton", IDS_BRAVE_SYNC_CREATE_BRAVE_ACCOUNT_BUTTON},
      {"braveSyncCreateBraveAccountTitle", IDS_BRAVE_SYNC_CREATE_BRAVE_ACCOUNT_TITLE},
      {"braveSyncSignInToBraveAccountButton", IDS_BRAVE_SYNC_SIGN_IN_TO_BRAVE_ACCOUNT_BUTTON},
      {"braveSyncSignInToBraveAccountTitle", IDS_BRAVE_SYNC_SIGN_IN_TO_BRAVE_ACCOUNT_TITLE},
      {"braveSyncBraveAccountDesc", IDS_BRAVE_SYNC_BRAVE_ACCOUNT_DESC},
