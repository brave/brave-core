...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveLeoAssistantAutomaticallyAttachPageLabel",
       IDS_SETTINGS_LEO_ASSISTANT_AUTOMATICALLY_ATTACH_PAGE_LABEL},
      {"braveLeoAssistantAutomaticallyAttachPageDesc",
       IDS_SETTINGS_LEO_ASSISTANT_AUTOMATICALLY_ATTACH_PAGE_DESC},
