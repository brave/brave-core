...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveLeoAssistantCustomizationNameError",
       IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_NAME_ERROR},
      ...
      {"braveLeoAssistantCustomizationResetButton",
       IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_RESET_BUTTON},
      {"braveLeoAssistantCustomizationNameError",
       IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_NAME_ERROR},
      {"braveLeoAssistantCustomizationJobError",
       IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_JOB_ERROR},
      {"braveLeoAssistantCustomizationToneError",
       IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_TONE_ERROR},
      {"braveLeoAssistantCustomizationOtherError",
       IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_OTHER_ERROR},
      {"braveLeoAssistantMemoryInputError",
       IDS_SETTINGS_LEO_ASSISTANT_MEMORY_INPUT_ERROR},
