...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"braveAccountRowDescription", IDS_SETTINGS_BRAVE_ACCOUNT_ROW_DESCRIPTION},
      {"braveAccountGetStartedButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_GET_STARTED_BUTTON_LABEL},
      {"braveAccountManageAccountButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_MANAGE_ACCOUNT_BUTTON_LABEL},

      // 'Entry' dialog:
      {"braveAccountEntryDialogTitle", IDS_SETTINGS_BRAVE_ACCOUNT_ENTRY_DIALOG_TITLE},
      {"braveAccountEntryDialogDescription", IDS_SETTINGS_BRAVE_ACCOUNT_ENTRY_DIALOG_DESCRIPTION},
      {"braveAccountCreateBraveAccountButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_ENTRY_DIALOG_CREATE_BRAVE_ACCOUNT_BUTTON_LABEL},
      {"braveAccountHaveAccountSignInButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_HAVE_ACCOUNT_SIGN_IN_BUTTON_LABEL},
      {"braveAccountSelfCustodyButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_SELF_CUSTODY_BUTTON_LABEL},
      ...
      {"braveAccountEmailAddressInputErrorMessage", IDS_SETTINGS_BRAVE_ACCOUNT_EMAIL_ADDRESS_INPUT_ERROR_MESSAGE},
      {"braveAccountAccountNameInputLabel", IDS_SETTINGS_BRAVE_ACCOUNT_ACCOUNT_NAME_INPUT_LABEL},
      {"braveAccountAccountNameInputPlaceholder", IDS_SETTINGS_BRAVE_ACCOUNT_ACCOUNT_NAME_INPUT_PLACEHOLDER},
      {"braveAccountCreatePasswordInputLabel", IDS_SETTINGS_BRAVE_ACCOUNT_CREATE_PASSWORD_INPUT_LABEL},
      {"braveAccountPasswordStrengthCheckerWeak", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_WEAK},
      {"braveAccountPasswordStrengthCheckerMedium", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_MEDIUM},
      {"braveAccountPasswordStrengthCheckerStrong", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_STRONG},
      {"braveAccountPasswordStrengthCheckerTooltipTitle", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_TITLE},
      {"braveAccountPasswordStrengthCheckerTooltipLowercaseRequirement", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_LOWERCASE_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipUppercaseRequirement", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_UPPERCASE_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipNumberRequirement", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_NUMBER_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipSpecialCharacterRequirement", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_SPECIAL_CHARACTER_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipLengthRequirement", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_LENGTH_REQUIREMENT},
      {"braveAccountConfirmPasswordInputLabel", IDS_SETTINGS_BRAVE_ACCOUNT_CONFIRM_PASSWORD_INPUT_LABEL},
      {"braveAccountConfirmPasswordInputPlaceholder", IDS_SETTINGS_BRAVE_ACCOUNT_CONFIRM_PASSWORD_INPUT_PLACEHOLDER},
      {"braveAccountConfirmPasswordInputErrorMessage", IDS_SETTINGS_BRAVE_ACCOUNT_CONFIRM_PASSWORD_INPUT_ERROR_MESSAGE},
      {"braveAccountConfirmPasswordInputSuccessMessage", IDS_SETTINGS_BRAVE_ACCOUNT_CONFIRM_PASSWORD_INPUT_SUCCESS_MESSAGE},
      {"braveAccountCreateAccountButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_CREATE_ACCOUNT_BUTTON_LABEL},

      // 'Sign In' dialog:
      {"braveAccountSignInDialogTitle", IDS_SETTINGS_BRAVE_ACCOUNT_SIGN_IN_DIALOG_TITLE},
      {"braveAccountSignInDialogDescription", IDS_SETTINGS_BRAVE_ACCOUNT_SIGN_IN_DIALOG_DESCRIPTION},
      {"braveAccountPasswordInputLabel", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_INPUT_LABEL},
      {"braveAccountForgotPasswordButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_FORGOT_PASSWORD_BUTTON_LABEL},
      {"braveAccountSignInButtonLabel", IDS_SETTINGS_BRAVE_ACCOUNT_SIGN_IN_BUTTON_LABEL},

      // 'Forgot Password' dialog:
      {"braveAccountForgotPasswordDialogTitle", IDS_SETTINGS_BRAVE_ACCOUNT_FORGOT_PASSWORD_DIALOG_TITLE},
      {"braveAccountForgotPasswordDialogDescription", IDS_SETTINGS_BRAVE_ACCOUNT_FORGOT_PASSWORD_DIALOG_DESCRIPTION},
      ...
      // Common:
      {"braveAccountEmailAddressInputLabel", IDS_SETTINGS_BRAVE_ACCOUNT_EMAIL_ADDRESS_INPUT_LABEL},
      {"braveAccountEmailAddressInputPlaceholder", IDS_SETTINGS_BRAVE_ACCOUNT_EMAIL_ADDRESS_INPUT_PLACEHOLDER},
      {"braveAccountPasswordInputPlaceholder", IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_INPUT_PLACEHOLDER},
      // </Brave Account>
