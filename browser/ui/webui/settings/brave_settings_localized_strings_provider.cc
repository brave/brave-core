...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveLeoAssistantEndpointValidAsPrivateIp_1",
       IDS_SETTINGS_LEO_ASSISTANT_ENDPOINT_VALID_AS_PRIVATE_IP_1},
      {"braveLeoAssistantEndpointValidAsPrivateIp_2",
       IDS_SETTINGS_LEO_ASSISTANT_ENDPOINT_VALID_AS_PRIVATE_IP_2},
      {"braveLeoAssistantEndpointValidAsPrivateIp_3",
       IDS_SETTINGS_LEO_ASSISTANT_ENDPOINT_VALID_AS_PRIVATE_IP_3},
