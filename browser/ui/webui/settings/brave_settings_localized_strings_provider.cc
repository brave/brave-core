...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveNewTabPrivateWindowSearchBox",
       IDS_SETTINGS_NEW_TAB_PRIVATE_WINDOW_SEARCH_BOX},
      {"braveNewTabPrivateWindowSearchBoxDesc",
       IDS_SETTINGS_NEW_TAB_PRIVATE_WINDOW_SEARCH_BOX_DESC},
