...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"braveAccountEmailAddressInputErrorMessage",
       IDS_SETTINGS_BRAVE_ACCOUNT_EMAIL_ADDRESS_INPUT_ERROR_MESSAGE},
      ...
      {"braveAccountPasswordStrengthCheckerWeak",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_WEAK},
      {"braveAccountPasswordStrengthCheckerMedium",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_MEDIUM},
      {"braveAccountPasswordStrengthCheckerStrong",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_STRONG},
      {"braveAccountPasswordStrengthCheckerTooltipTitle",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_TITLE},
      {"braveAccountPasswordStrengthCheckerTooltipLowercaseRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_LOWERCASE_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipUppercaseRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_UPPERCASE_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipNumberRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_NUMBER_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipSpecialCharacterRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_SPECIAL_CHARACTER_REQUIREMENT},
      {"braveAccountPasswordStrengthCheckerTooltipLengthRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_CHECKER_TOOLTIP_LENGTH_REQUIREMENT},
      ...
      // Common:
      {"braveAccountEmailAddressInputLabel",
       IDS_SETTINGS_BRAVE_ACCOUNT_EMAIL_ADDRESS_INPUT_LABEL},
      {"braveAccountEmailAddressInputPlaceholder",
       IDS_SETTINGS_BRAVE_ACCOUNT_EMAIL_ADDRESS_INPUT_PLACEHOLDER},
