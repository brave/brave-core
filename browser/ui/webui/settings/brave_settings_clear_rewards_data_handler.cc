...
void ClearRewardsDataHandler::HandleClearRewardsData(
  ...
  for (const base::Value& type : *data_type_list) {
    ...
    switch (data_type) {
      case RewardsDataType::REWARDS_AUTO_CONTRIBUTE:
          remove_mask |=
            BraveBrowsingDataRemoverDelegate::DATA_TYPE_REWARDS_AUTO_CONTRIBUTE;
        break;
      case RewardsDataType::REWARDS_ALL_DATA:
          remove_mask |=
            BraveBrowsingDataRemoverDelegate::DATA_TYPE_REWARDS_ALL_DATA;
        break;
  ...
  remover->SetEmbedderDelegate(
        static_cast<BraveBrowsingDataRemoverDelegate*>(
...
void ClearRewardsDataHandler::OnContributionStarted() {
  UpdateContributionInProgress(true);
}

void ClearRewardsDataHandler::OnContributionComplete() {
  UpdateContributionInProgress(false);
}
