      ...
      {std::string("rewards"),
       {
           ...
           {"4fcfa7f92c5fc22c2b6f34701bfdcd0a.jpeg",
            IDR_BRAVE_REWARDS_IMG_BART_TEMP},  // NOLINT
       ...
       {std::string("rewards"),
        {{"adsCurrentEarnings", IDS_BRAVE_REWARDS_LOCAL_ADS_CURRENT_EARNINGS},
         ...
         {"contributionNonVerified",
          IDS_BRAVE_REWARDS_LOCAL_CONTR_ALLOW_NON_VERIFIED},  // NOLINT
         ...
         {"grantAlreadyClaimedText",
          IDS_BRAVE_REWARDS_LOCAL_GRANT_ALREADY_CLAIMED_TEXT},  // NOLINT
       ...
       {std::string("sync"),
        {
            ...
            {"settingsDescription",
             IDS_BRAVE_SYNC_ENABLED_SETTINGS_DESCRIPTION},
            ...
            {"deleteSyncDescription",
             IDS_BRAVE_SYNC_RESET_REMOVAL_INSTRUCTIONS},
            {"startSyncChainHowTo",
             IDS_BRAVE_SYNC_RESET_START_NEW_INSTRUCTIONS},
            ...
            {"errorSyncInitFailedTitle",
             IDS_BRAVE_SYNC_ERROR_INIT_FAILED_TITLE},
       ...
       {std::string("rewards-internals"),
        {
            ...
            {"retryStepCurrent",
             IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_CURRENT},
            {"retryStepFinal", IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_FINAL},
            {"retryStepPayload",
             IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_PAYLOAD},
            {"retryStepPrepare",
             IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_PREPARE},
            ...
            {"retryStepUnknown",
             IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_UNKNOWN},
            {"retryStepViewing",
             IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_VIEWING},
            {"retryStepVote", IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_VOTE},
            {"retryStepWinners",
             IDS_BRAVE_REWARDS_INTERNALS_RETRY_STEP_WINNERS},
            {"rewardsNotEnabled",
