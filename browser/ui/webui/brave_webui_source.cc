  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      ...
      std::string("rewards"), {
        ...
        { "donationAbilitySC",  IDS_BRAVE_REWARDS_LOCAL_DONAT_ABILITY_SC },
      ...
      std::string("tip"), {
        ...
        { "soundcloudTipTitle", IDS_BRAVE_UI_SC_TIP_TITLE },
        { "soundcloudTipTitleEmpty", IDS_BRAVE_UI_SC_TIP_TITLE_EMPTY },
        { "rewardsBannerText1", IDS_BRAVE_UI_REWARDS_BANNER_TEXT1 },
        { "rewardsBannerText2", IDS_BRAVE_UI_REWARDS_BANNER_TEXT2 },
        { "sendDonation", IDS_BRAVE_UI_SEND_DONATION },
