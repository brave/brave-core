  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      ...
      std::string("welcome"), {
        ...
        { "serviceText", IDS_BRAVE_WELCOME_PAGE_SERVICE_TEXT },
        { "termsOfService", IDS_BRAVE_UI_TERMS_OF_SERVICE },
        { "turnOnRewards", IDS_BRAVE_WELCOME_PAGE_REWARDS_BUTTON },
        { "turningOnRewards", IDS_BRAVE_WELCOME_PAGE_TURNING_ON_REWARDS },
