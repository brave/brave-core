  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      ...
      std::string("rewards"), {
        ...
        { "rewardsRestoreConfirmation1", IDS_BRAVE_UI_REWARDS_RESTORE_CONFIRMATION1 },  // NOLINT
        { "rewardsRestoreConfirmation2", IDS_BRAVE_UI_REWARDS_RESTORE_CONFIRMATION2 },  // NOLINT
        { "rewardsTokenGrantTitle", IDS_REWARDS_WIDGET_TOKEN_GRANT_TITLE },
