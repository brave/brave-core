  ...
  static std::map<std::string, std::vector<WebUISimpleItem>> localized_strings = {  // NOLINT
      {std::string("newtab"),
       {{"adsTrackersBlocked", IDS_BRAVE_NEW_TAB_TOTAL_ADS_TRACKERS_BLOCKED},
        ...
        {"contributeWidgetValidatingCreds",
         IDS_CONTRIBUTE_WIDGET_VALIDATING_CREDS},  // NOLINT
        {"contributeWidgetDisconnectTitle",
         IDS_CONTRIBUTE_WIDGET_DISCONNECT_TITLE},  // NOLINT
        {"contributeWidgetDisconnectText",
         IDS_CONTRIBUTE_WIDGET_DISCONNECT_TEXT},  // NOLINT
        {"contributeWidgetDisconnectButton",
         IDS_CONTRIBUTE_WIDGET_DISCONNECT_BUTTON},  // NOLINT
        {"contributeWidgetCancelText", IDS_BRAVE_UI_CANCEL},
        {"contributeWidgetAccountDisconnected",
         IDS_CONTRIBUTE_WIDGET_ACCOUNT_DISCONNECTED},  // NOLINT
        {"contributeWidgetConfigureButton",
         IDS_CONTRIBUTE_WIDGET_CONFIGURE_BUTTON},  // NOLINT
        ...
        {"contributeWidgetUnableToConvert",
         IDS_CONTRIBUTE_WIDGET_UNABLE_TO_CONVERT},  // NOLINT
        {"contributeWidgetRetry", IDS_CONTRIBUTE_WIDGET_RETRY},
        {"contributeWidgetInsufficientFunds",
         IDS_CONTRIBUTE_WIDGET_INSUFFICIENT_FUNDS},  // NOLINT
        {"contributeWidgetConversionFailed",
         IDS_CONTRIBUTE_WIDGET_CONVERSION_FAILED},  // NOLINT
        ...
        {"contributeWidgetAddressUnavailable",
         IDS_CONTRIBUTE_WIDGET_ADDRESS_UNAVAILABLE},  // NOLINT
        {"contributeWidgetDepositAddress",
         IDS_CONTRIBUTE_WIDGET_DEPOSIT_ADDRESS},
        {"contributeWidgetConfirmConversion",
         IDS_CONTRIBUTE_WIDGET_CONFIRM_CONVERSION},  // NOLINT
        ...
        {"contributeWidgetPreviewConvert",
         IDS_CONTRIBUTE_WIDGET_PREVIEW_CONVERT},
        {"contributeWidgetSummary", IDS_CONTRIBUTE_WIDGET_SUMMARY},
        {"contributeWidgetAuthInvalid", IDS_CONTRIBUTE_WIDGET_AUTH_INVALID},
        {"contributeWidgetAuthInvalidCopy",
         IDS_CONTRIBUTE_WIDGET_AUTH_INVALID_COPY},  // NOLINT
