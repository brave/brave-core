  ...
  static std::map<std::string, std::vector<WebUISimpleItem> > resources = {
    {
      std::string("newtab"), {
        ...
        // New tab Backgrounds
        { "ntp-1-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND1 },
        { "ntp-2-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND2 },
        { "ntp-3-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND3 },
        { "ntp-4-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND4 },
        { "ntp-5-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND5 },
        { "ntp-6-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND6 },
        { "ntp-7-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND7 },
        { "ntp-8-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND8 },
        { "ntp-9-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND9 },
        { "ntp-10-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND10 },
        { "ntp-11-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND11 },
        { "ntp-12-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND12 },
        { "ntp-13-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND13 },
        { "ntp-14-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND14 },
        { "ntp-15-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND15 },
        { "ntp-16-min.webp", IDR_BRAVE_NEW_TAB_BACKGROUND16 },
