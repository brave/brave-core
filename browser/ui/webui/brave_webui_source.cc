  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      ...
      std::string("rewards"), {
        ...
        { "donationAbilityStackOverflow",  IDS_BRAVE_REWARDS_LOCAL_DONAT_ABILITY_SO },
      ...
      std::string("tip"), {
        ...
        { "stackoverflowTipTitle", IDS_BRAVE_UI_SO_TIP_TITLE },
        { "stackoverflowTipTitleEmpty", IDS_BRAVE_UI_SO_TIP_TITLE_EMPTY },
        { "rewardsBannerText1", IDS_BRAVE_UI_REWARDS_BANNER_TEXT1 },
        { "rewardsBannerText2", IDS_BRAVE_UI_REWARDS_BANNER_TEXT2 },
        { "sendDonation", IDS_BRAVE_UI_SEND_DONATION },
