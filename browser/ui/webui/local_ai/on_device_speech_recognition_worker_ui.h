...
// hosts the Parakeet-CTC-110M WASM bundle. Runs in an isolated
// (untrusted) renderer process since it processes raw microphone
// audio.
...
// Registers the chrome-untrusted://on-device-speech-recognition-worker/
// URL and creates UntrustedOnDeviceSpeechRecognitionWorkerUI
// instances for it.
