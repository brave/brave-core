...
class RewardsPageHandler : public mojom::RewardsPageHandler {
 public:
  ...
  void ToggleAdLike(brave_ads::mojom::ReactionInfoPtr mojom_reaction,
                    ToggleAdLikeCallback callback) override;
  void ToggleAdDislike(brave_ads::mojom::ReactionInfoPtr mojom_reaction,
                       ToggleAdDislikeCallback callback) override;
  void ToggleAdInappropriate(brave_ads::mojom::ReactionInfoPtr mojom_reaction,
