...
static constexpr webui::LocalizedString kStrings[] = {
    ...
    {"connectProvidersUnavailableText",
     IDS_REWARDS_CONNECT_PROVIDERS_UNAVAILABLE_TEXT},
    {"connectProvidersUnavailableTitle",
     IDS_REWARDS_CONNECT_PROVIDERS_UNAVAILABLE_TITLE},
    ...
    {"resetExternalWalletButtonLabel",
     IDS_REWARDS_RESET_EXTERNAL_WALLET_BUTTON_LABEL},
    {"resetExternalWalletNote", IDS_REWARDS_RESET_EXTERNAL_WALLET_NOTE},
    {"resetExternalWalletText", IDS_REWARDS_RESET_EXTERNAL_WALLET_TEXT},
    {"resetExternalWalletTitle", IDS_REWARDS_RESET_EXTERNAL_WALLET_TITLE},
    ...
    {"switchAccountCountrySelectLabel",
     IDS_REWARDS_SWITCH_ACCOUNT_COUNTRY_SELECT_LABEL},
    {"switchAccountText1", IDS_REWARDS_SWITCH_ACCOUNT_TEXT_1},
    {"switchAccountText2", IDS_REWARDS_SWITCH_ACCOUNT_TEXT_2},
    {"switchAccountText3", IDS_REWARDS_SWITCH_ACCOUNT_TEXT_3},
    {"switchAccountTitle", IDS_REWARDS_SWITCH_ACCOUNT_TITLE},
