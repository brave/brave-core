...
#ifndef BRAVE_BROWSER_UI_WEBUI_TREZOR_BRIDGE_TREZOR_BRIDGE_UI_H_
#define BRAVE_BROWSER_UI_WEBUI_TREZOR_BRIDGE_TREZOR_BRIDGE_UI_H_
...
#endif  // BRAVE_BROWSER_UI_WEBUI_TREZOR_BRIDGE_TREZOR_BRIDGE_UI_H_
