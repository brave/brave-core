...
#ifndef BRAVE_BROWSER_UI_WEBUI_BRAVE_WALLET_ANDROID_LEDGER_PAGE_UI_H_
#define BRAVE_BROWSER_UI_WEBUI_BRAVE_WALLET_ANDROID_LEDGER_PAGE_UI_H_
...
class LedgerPageUI : public ui::MojoWebUIController,
                     public brave_wallet::mojom::PageHandlerFactory {
 public:
  explicit LedgerPageUI(content::WebUI* web_ui, const std::string& name);
  LedgerPageUI(const LedgerPageUI&) = delete;
  LedgerPageUI& operator=(const LedgerPageUI&) = delete;
  ~LedgerPageUI() override;
...
#endif  // BRAVE_BROWSER_UI_WEBUI_BRAVE_WALLET_ANDROID_LEDGER_PAGE_UI_H_
