...
#ifndef BRAVE_BROWSER_UI_WEBUI_BRAVE_REWARDS_SYNC_INTERNALS_MESSAGE_HANDLER_H_
#define BRAVE_BROWSER_UI_WEBUI_BRAVE_REWARDS_SYNC_INTERNALS_MESSAGE_HANDLER_H_
...
class BraveRewardsSyncInternalsMessageHandler
    : public content::WebUIMessageHandler,
      public syncer::SyncServiceObserver,
      public syncer::ProtocolEventObserver,
      public syncer::InvalidationsListener {
 public:
  BraveRewardsSyncInternalsMessageHandler();

  BraveRewardsSyncInternalsMessageHandler(
      const BraveRewardsSyncInternalsMessageHandler&) = delete;
  BraveRewardsSyncInternalsMessageHandler& operator=(
      const BraveRewardsSyncInternalsMessageHandler&) = delete;

  ~BraveRewardsSyncInternalsMessageHandler() override;
 ...
 protected:
  ...
  explicit BraveRewardsSyncInternalsMessageHandler(
 ...
 private:
  ...
  base::WeakPtrFactory<BraveRewardsSyncInternalsMessageHandler>
      weak_ptr_factory_{this};
};

#endif  // BRAVE_BROWSER_UI_WEBUI_BRAVE_REWARDS_SYNC_INTERNALS_MESSAGE_HANDLER_H_
