...
#include "brave/grit/hello_world_resources.h"
#include "brave/grit/hello_world_resources_map.h"
...
HelloWorldUI::HelloWorldUI(content::WebUI* web_ui)
  ...
  webui::SetupWebUIDataSource(source, base::span(kHelloWorldResources),
