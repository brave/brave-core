...
class BraveAccountDialogsUIConfig : public content::DefaultWebUIConfig<BraveAccountDialogsUI> {
 public:
...
class BraveAccountDialogsDialog : public ui::WebDialogDelegate {
 public:
  ...
  BraveAccountDialogsDialog& operator=(const BraveAccountDialogsDialog&) = delete;
