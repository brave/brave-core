...
// Registration is not gated on the navigation opt-in: what the opt-in decides
// is whether the worker can serve anything, not whether it can be installed.
// Without it the worker stays inert - see
