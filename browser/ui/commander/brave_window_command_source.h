...
#ifndef BRAVE_BROWSER_UI_COMMANDER_BRAVE_WINDOW_COMMAND_SOURCE_H_
#define BRAVE_BROWSER_UI_COMMANDER_BRAVE_WINDOW_COMMAND_SOURCE_H_
...
#endif  // BRAVE_BROWSER_UI_COMMANDER_BRAVE_WINDOW_COMMAND_SOURCE_H_
