...
void BraveShieldsTabHelper::MaybeNotifyAfterRepeatedReloads(
  ...
  // If the page is reloaded between `kAdblockOnlyModeReloadsCountMin` and
  // `kAdblockOnlyModeReloadsCountMax` times in
  // `kAdblockOnlyModeReloadsCountInterval`, notify observers.
