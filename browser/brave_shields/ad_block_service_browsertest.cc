...
class AdBlockOnlyModeTest : public AdBlockServiceTest {
 public:
  AdBlockOnlyModeTest() {
...
IN_PROC_BROWSER_TEST_F(AdBlockOnlyModeTest, CheckEnabledFilterLists) {
  InstallRegionalAdBlockComponent(brave_shields::kCookieListUuid, true);
...
class AdBlockOnlyModeFeatureDisabledTest : public AdBlockServiceTest {
 public:
  AdBlockOnlyModeFeatureDisabledTest() {
...
IN_PROC_BROWSER_TEST_F(AdBlockOnlyModeFeatureDisabledTest,
