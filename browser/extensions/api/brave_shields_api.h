...
class BraveShieldsContentSettingGetFunction : public UIThreadExtensionFunction {
 public:
...
class BraveShieldsContentSettingSetFunction : public UIThreadExtensionFunction {
 public:
