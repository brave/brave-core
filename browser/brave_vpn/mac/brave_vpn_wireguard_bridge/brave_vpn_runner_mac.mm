...
BraveVpnRunnerMac::BraveVpnRunnerMac() {
  ...
  base::mac::SetBaseBundleID(bundle.bundleIdentifier.UTF8String);
  if (std::string(base::mac::BaseBundleID()).empty()) {
...
void BraveVpnRunnerMac::CreateTunnelProvider(const std::string& config) {
  ...
  std::string protocolBundlerID = base::mac::BaseBundleID();
