...
// Verifies that the BraveAdsEnabled administrator policy prevents or permits
...
class BraveAdsPolicyBrowserTest : public PlatformBrowserTest,
 ...
 public:
  ...
  void SetUpInProcessBrowserTestFixture() override {
    ...
    policies.Set(policy::key::kBraveAdsEnabled, policy::POLICY_LEVEL_MANDATORY,
                 policy::POLICY_SCOPE_USER, policy::POLICY_SOURCE_PLATFORM,
                 base::Value(IsAdsEnabledByPolicy()),
                 /*external_data_fetcher=*/nullptr);
    configuration_policy_provider_.UpdateChromePolicy(policies);
  }

  bool IsAdsEnabledByPolicy() { return GetParam(); }
...
INSTANTIATE_TEST_SUITE_P(
    ...
    [](const testing::TestParamInfo<BraveAdsPolicyBrowserTest::ParamType>&
           info) {
      return absl::StrFormat("BraveAds%sByPolicy",
