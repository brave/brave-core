...
public class ImportFlow {
    ...
    private static enum ImportStatusResult {
        ...
        NUM_PASSWORDS_EXCEEDED(8, R.string.password_manager_ui_import_error_limit_exceeded),
                        ...
                        (errorId) -> {
                            ...
                            showImportErrorDialog(
                                    mDelegate
                                            ...
                                            .getResources()
                                            .getString(
                                                    ImportStatusResult.fromInt(errorId)
                                                            .locStrId()));
                        });
            } else {
                showImportErrorDialog(
    ...
    private void showImportSuccessDialog(int count) {
        ...
        new AlertDialog.Builder(mDelegate.getActivity())
                ...
                .setMessage(
                        res.getString(R.string.password_settings_import_file_success_count, count))
                .setPositiveButton(
