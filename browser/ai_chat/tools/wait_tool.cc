...
WaitTool::WaitTool(BrowserToolTaskProvider* task_provider,
...
void WaitTool::UseTool(const std::string& input_json,
  ...
  data_decoder::DataDecoder::ParseJsonIsolated(
      input_json,
      base::BindOnce(&WaitTool::OnParseJson, weak_ptr_factory_.GetWeakPtr(),
                     std::move(callback)));
}

void WaitTool::OnParseJson(UseToolCallback callback,
  ...
  std::optional<int> wait_time_ms = dict.FindInt("wait_time_ms");
