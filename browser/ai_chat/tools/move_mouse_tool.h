...
#ifndef BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_MOVE_MOUSE_TOOL_H_
#define BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_MOVE_MOUSE_TOOL_H_
...
class MoveMouseTool : public Tool {
 public:
  MoveMouseTool(BrowserToolTaskProvider* task_provider,
...
#endif  // BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_MOVE_MOUSE_TOOL_H_
