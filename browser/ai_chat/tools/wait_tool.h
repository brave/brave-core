...
#ifndef BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_WAIT_TOOL_H_
#define BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_WAIT_TOOL_H_
...
class WaitTool : public Tool {
 public:
  WaitTool(BrowserToolTaskProvider* task_provider,
...
#endif  // BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_WAIT_TOOL_H_
