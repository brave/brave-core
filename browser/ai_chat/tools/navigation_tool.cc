...
NavigationTool::NavigationTool(BrowserToolTaskProvider* task_provider,
...
void NavigationTool::OnTabHandleCreated(UseToolCallback callback,
  ...
  // TODO(cr140): actions will change from proto to class, we shouldn't
  // have to deal with optimization_guide proto at all.
