...
#ifndef BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_NAVIGATION_TOOL_H_
#define BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_NAVIGATION_TOOL_H_
...
class NavigationTool : public Tool {
 public:
  NavigationTool(BrowserToolTaskProvider* task_provider,
...
#endif  // BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_NAVIGATION_TOOL_H_
