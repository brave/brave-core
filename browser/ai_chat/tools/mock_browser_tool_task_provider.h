...
#ifndef BRAVE_BROWSER_AI_CHAT_TOOLS_MOCK_BROWSER_TOOL_TASK_PROVIDER_H_
#define BRAVE_BROWSER_AI_CHAT_TOOLS_MOCK_BROWSER_TOOL_TASK_PROVIDER_H_
...
class MockBrowserToolTaskProvider : public BrowserToolTaskProvider {
 public:
  MockBrowserToolTaskProvider();
  ~MockBrowserToolTaskProvider() override;
...
#endif  // BRAVE_BROWSER_AI_CHAT_TOOLS_MOCK_BROWSER_TOOL_TASK_PROVIDER_H_
