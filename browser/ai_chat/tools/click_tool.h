...
#ifndef BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_CLICK_TOOL_H_
#define BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_CLICK_TOOL_H_
...
class ClickTool : public Tool {
 public:
  ClickTool(BrowserToolTaskProvider* task_provider,
...
#endif  // BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_CLICK_TOOL_H_
