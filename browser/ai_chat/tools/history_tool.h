...
#ifndef BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_HISTORY_TOOL_H_
#define BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_HISTORY_TOOL_H_
...
class HistoryTool : public Tool {
 public:
  HistoryTool(BrowserToolTaskProvider* task_provider,
...
#endif  // BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_HISTORY_TOOL_H_
