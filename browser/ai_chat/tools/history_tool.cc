...
HistoryTool::HistoryTool(BrowserToolTaskProvider* task_provider,
...
void HistoryTool::UseTool(const std::string& input_json,
  ...
  data_decoder::DataDecoder::ParseJsonIsolated(
      input_json,
      base::BindOnce(&HistoryTool::OnParseJson, weak_ptr_factory_.GetWeakPtr(),
                     std::move(callback)));
}

void HistoryTool::OnParseJson(UseToolCallback callback,
