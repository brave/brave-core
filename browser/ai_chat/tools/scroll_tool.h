...
#ifndef BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_SCROLL_TOOL_H_
#define BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_SCROLL_TOOL_H_
...
class ScrollTool : public Tool {
 public:
  ScrollTool(BrowserToolTaskProvider* task_provider,
...
#endif  // BRAVE_BRAVE_BROWSER_AI_CHAT_TOOLS_SCROLL_TOOL_H_
