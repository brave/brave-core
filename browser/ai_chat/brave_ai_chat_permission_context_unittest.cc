...
class BraveAIChatPermissionContextTest
    : public ChromeRenderViewHostTestHarness {
 public:
  BraveAIChatPermissionContextTest() = default;
  ~BraveAIChatPermissionContextTest() override = default;

  ContentSetting RequestPermission(
      BraveAIChatPermissionContext* permission_context,
      const GURL& url) {
...
TEST_F(BraveAIChatPermissionContextTest, BlockForNonBraveSearch) {
...
TEST_F(BraveAIChatPermissionContextTest, NotAllowedInInsecureOrigins) {
  BraveAIChatPermissionContext permission_context(browser_context());
