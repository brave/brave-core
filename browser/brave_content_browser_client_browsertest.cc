...
class BraveContentBrowserClientTest : public InProcessBrowserTest {
  public:
    void SetUpOnMainThread() override {
      ...
      torrent_extension_url_ = GURL("chrome-extension://lgjmpdmojkpocjcopdikifhejkkjglho/extension/brave_webtorrent.html?https://webtorrent.io/torrents/sintel.torrent");
    }
