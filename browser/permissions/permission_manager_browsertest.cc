...
class PermissionManagerBrowserTest : public InProcessBrowserTest {
 public:
  ...
  void SetUpOnMainThread() override {
    ...
    wallet_service_ = brave_wallet::BraveWalletServiceFactory::GetForContext(
        browser()->profile());
  }
  ...
  bool IsEthereumPendingRequestsEmpty() {
    PermissionContextBase* context =
        permission_manager()->GetPermissionContextForTesting(
            ContentSettingsType::BRAVE_ETHEREUM);
    return context->IsPendingEthereumRequestsEmptyForTesting();
  }
...
IN_PROC_BROWSER_TEST_F(PermissionManagerBrowserTest,
  ...
  // Test ignoring request.
  permission_request_manager->IgnoreEthereumPermissionRequests();
  ...
  permission_request_manager->AcceptEthereumPermissionRequests(
