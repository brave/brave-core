...
using syncer::ModelTypeStoreService;
...
RewardsChromeSyncClient::RewardsChromeSyncClient(Profile* profile)
    : ChromeSyncClient(profile),
      ...
      vg_sync_service_(
          brave_rewards::VgSyncServiceFactory::GetForProfile(profile)) {}
...
RewardsChromeSyncClient::CreateDataTypeControllers(syncer::SyncService*) {
  ...
  controllers.push_back(std::make_unique<ModelTypeController>(
      ...
      std::make_unique<syncer::ForwardingModelTypeControllerDelegate>(
          vg_sync_service_->GetControllerDelegateForVgBodies().get()),
      std::make_unique<syncer::ForwardingModelTypeControllerDelegate>(
          vg_sync_service_->GetControllerDelegateForVgBodies().get())));
  ...
  controllers.push_back(std::make_unique<ModelTypeController>(
      ...
      std::make_unique<syncer::ForwardingModelTypeControllerDelegate>(
          vg_sync_service_->GetControllerDelegateForVgSpendStatuses().get()),
      std::make_unique<syncer::ForwardingModelTypeControllerDelegate>(
          vg_sync_service_->GetControllerDelegateForVgSpendStatuses().get())));
...
ModelTypeStoreService* RewardsChromeSyncClient::GetModelTypeStoreService() {
  DCHECK(model_type_store_service_);
  return model_type_store_service_.get();
}
