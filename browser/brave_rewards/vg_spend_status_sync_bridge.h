...
#ifndef BRAVE_BROWSER_BRAVE_REWARDS_VG_SPEND_STATUS_SYNC_BRIDGE_H_
#define BRAVE_BROWSER_BRAVE_REWARDS_VG_SPEND_STATUS_SYNC_BRIDGE_H_
...
class VgSpendStatusSyncBridge : public syncer::ModelTypeSyncBridge {
 public:
  VgSpendStatusSyncBridge(
      std::unique_ptr<syncer::ModelTypeChangeProcessor> change_processor,
      syncer::OnceModelTypeStoreFactory store_factory);

  VgSpendStatusSyncBridge(const VgSpendStatusSyncBridge&) = delete;
  VgSpendStatusSyncBridge& operator=(const VgSpendStatusSyncBridge&) = delete;

  ~VgSpendStatusSyncBridge() override;
 ...
 private:
  ...
  base::OnceCallback<void(std::vector<sync_pb::VgSpendStatusSpecifics>)>
      when_vg_spend_statuses_ready_;
  std::unique_ptr<syncer::ModelTypeStore> store_;
  base::WeakPtrFactory<VgSpendStatusSyncBridge> weak_ptr_factory_{this};
};
}  // namespace brave_rewards

#endif  // BRAVE_BROWSER_BRAVE_REWARDS_VG_SPEND_STATUS_SYNC_BRIDGE_H_
