...
TEST_F(ThemeCommandLineHandlerTest, ProcessUserColorSwitch) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetUserColor, "0,255,128");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessColorSchemeSwitch) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorScheme, "dark");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessColorSchemeSwitchLight) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorScheme, "light");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessColorSchemeSwitchSystem) {
  ...
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorScheme, "system");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessDefaultThemeSwitch) {
  ...
  command_line_->AppendSwitch(brave::themes::switches::kSetDefaultTheme);
...
TEST_F(ThemeCommandLineHandlerTest, ProcessGrayscaleSwitch) {
  ...
  // brave::themes::switches::kSetGrayscaleTheme is now a boolean flag - presence means true
  command_line_->AppendSwitch(brave::themes::switches::kSetGrayscaleTheme);
...
TEST_F(ThemeCommandLineHandlerTest, ProcessColorVariantSwitch) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorVariant, "tonal_spot");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessColorVariantSwitchNeutral) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorVariant, "neutral");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessColorVariantSwitchVibrant) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorVariant, "vibrant");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessColorVariantSwitchExpressive) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorVariant, "expressive");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessUserColorAndVariantTogether) {
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetUserColor, "255,100,50");
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorVariant, "vibrant");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessInvalidUserColor) {
  ...
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetUserColor, "256,0,0");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessMalformedUserColor) {
  ...
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetUserColor, "not-a-color");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessInvalidColorScheme) {
  ...
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorScheme, "invalid");
...
TEST_F(ThemeCommandLineHandlerTest, ProcessInvalidColorVariant) {
  ...
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorVariant, "invalid");
...
TEST_F(ThemeCommandLineHandlerTest, DefaultThemeTakesPrecedence) {
  // Test that brave::themes::switches::kSetDefaultTheme takes precedence over other switches
  command_line_->AppendSwitch(brave::themes::switches::kSetDefaultTheme);
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetUserColor, "255,0,0");
  command_line_->AppendSwitchASCII(brave::themes::switches::kSetColorScheme, "dark");

  // Process browser-wide switch first (brave::themes::switches::kSetDefaultTheme)
  ProcessBrowserWideThemeCommandLineSwitches(command_line_.get(),
                                             profile_.get());

  // Don't process per-profile switches when default theme is set
  // In production, the per-profile function would check for brave::themes::switches::kSetDefaultTheme
