...
#if !BUILDFLAG(IS_ANDROID)
class BraveStatsUpdaterDisabledBrowserTest
    : public BraveStatsUpdaterBrowserTest {
 public:
  void SetUp() override {
    brave_stats::BraveStatsUpdater::DisableAutoStartForTesting();
    BraveStatsUpdaterBrowserTest::SetUp();
  }
};

// The stats updater should not reach the endpoint
IN_PROC_BROWSER_TEST_F(BraveStatsUpdaterDisabledBrowserTest,
