...
TEST_F(BraveStatsUpdaterTest, SavePrefsWritesLastCheckedAt) {
  base::Time ping_time;
  ASSERT_TRUE(base::Time::FromUTCString("2026-04-22T15:30:00", &ping_time));
  SetCurrentTimeForTest(ping_time);
