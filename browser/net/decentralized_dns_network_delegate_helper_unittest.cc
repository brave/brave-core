...
TEST_F(DecentralizedDnsNetworkDelegateHelperTest,
  ...
  struct TestCase {
    ...
    bool is_valid;
      ...
      {"https://brave.pudgy", true},    {"https://brave.tball", true},
      {"https://brave.stepn", true},    {"https://brave.secret", true},
      {"https://brave.raiin", true},    {"https://brave.pog", true},
      {"https://brave.clay", true},     {"https://brave.metropolis", true},
      {"https://brave.witg", true},     {"https://brave.ubu", true},
      {"https://brave.kryptic", true},  {"https://brave.farms", true},
      {"https://brave.dfz", true},      {"https://brave", false},
