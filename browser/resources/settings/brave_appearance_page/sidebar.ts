 ...
 */
export class SettingsBraveAppearanceSidebarElement
extends SettingsBraveAppearanceSidebarElementBase {
  static get is() {
  ...
  private onShowOptionChanged_() {
    this.sidebarShowEnabledLabel_ =
      (this.get('prefs.brave.sidebar.sidebar_show_option.value') === 3)
...
customElements.define(
  SettingsBraveAppearanceSidebarElement.is,
  SettingsBraveAppearanceSidebarElement)
