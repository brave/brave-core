...
export class BraveSettingsGettingStarted
extends SettingsViewMixin(PolymerElement) {
  static get is() {
  ...
  override getAssociatedControlFor(childViewId: string): HTMLElement {
    switch (childViewId) {
      case 'manageProfile':
        return this.shadowRoot!.querySelector('settings-people-page')!.
          shadowRoot!.querySelector('#edit-profile')!
      default:
...
customElements.define(
  BraveSettingsGettingStarted.is, BraveSettingsGettingStarted)
