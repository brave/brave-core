 ...
 */
export class SettingBraveDefaultExtensionsPageElement
extends SettingBraveDefaultExtensionsPageElementBase {
  static get is() {
  ...
  override ready() {
    ...
    // same as upstream.
    const setWidevineEnabledPref = (enabled: boolean) =>
      this.setWidevineEnabledPref_(enabled)
  ...
  openWebStoreUrl_() {
    window.open(
      loadTimeData.getString('getMoreExtensionsUrl'), undefined, 'noreferrer')
  }
...
customElements.define(
  SettingBraveDefaultExtensionsPageElement.is,
