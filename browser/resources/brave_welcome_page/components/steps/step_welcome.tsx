    ...
    <div className='content'>
      <div className='left-content'>
        <div className='left-text-content'>
          ...
          <p>
            Experience the web without being watched. Brave shields you from
            trackers, ads, and fingerprinting, all automatically.
          </p>
        </div>
      </div>
...
export function StepWelcomeFooter({
  onNext,
  onBack,
  onSkip,
  isFirstStep,
