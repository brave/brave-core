...
export function VPNWidget() {
  ...
  const [purchased, connectionState, region] = useVPNState((state) => [
    state.purchased,
    state.connectionState,
    state.connectionRegion
  ])
      ...
      <div data-css-scope={style.scope}>
        ...
        <div className='content'>
          ...
          <div className='purchase-actions'>
            <Button
              size='small'
              onClick={() => vpnModel.startTrial()}
            >
              {getString('vpnStartTrialLabel')}
            </Button>
            <button
              className='restore'
              onClick={() => vpnModel.restorePurchase()}
            >
    ...
    return (
      <div className='region'>
        <div className='country'>
          {region.country}
          <button onClick={() => vpnModel.openVpnPanel()}>
      ...
      <div className={`content ${connectionState}`}>
        ...
        <div className='connection-toggle'>
          <Toggle
            ...
            onChange={() => vpnModel.toggleConnection()}
          />
        </div>
      </div>
    </div>
