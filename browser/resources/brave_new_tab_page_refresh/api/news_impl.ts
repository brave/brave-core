...
import {
  ...
  isNewsPublisherEnabled } from './news_api'
...
export function createNewsAPI(): NewsAPI {
      ...
      new mojom.ConfigurationListenerReceiver({
        changed(newConfiguration) {
          ...
          store.update({
            ...
            showNewsFeed: newsConfig.showOnNTP,
  ...
  return {
    ...
    setNewsEnabled(newsEnabled) {
      ...
      newsConfig = { ...newsConfig, isOptedIn: newsEnabled }
    ...
    setShowNewsFeed(showNewsFeed) {
      ...
      newsConfig = { ...newsConfig, showOnNTP: showNewsFeed }
      newsController.setConfiguration(newsConfig)
