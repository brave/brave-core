...
#define BRAVE_ABOUT_FLAGS_FEATURE_ENTRIES                                      \
  EXPAND_FEATURE_ENTRIES(                                                      \
      ...
      {                                                                        \
          "brave-ntp-custom-widgets",                                          \
          "AI-generated custom widgets on the NTP",                            \
          "Enables adding custom New Tab Page widgets generated by Leo AI "    \
          "chat. Widgets render in an isolated sandbox.",                      \
          kOsDesktop,                                                          \
          FEATURE_VALUE_TYPE(features::kBraveNtpCustomWidgets),                \
      },                                                                       \
      {                                                                        \
