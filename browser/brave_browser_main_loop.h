...
#ifndef BRAVE_CONTENT_BROWSER_BRAVE_BROWSER_MAIN_LOOP_H_
#define BRAVE_CONTENT_BROWSER_BRAVE_BROWSER_MAIN_LOOP_H_
...
#endif  // BRAVE_CONTENT_BROWSER_BRAVE_BROWSER_MAIN_LOOP_H_
