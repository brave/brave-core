...
class TestContainedTabHandler : public ContainedTabHandler {
 public:
  TestContainedTabHandler()
      : id_(std::string(ContainedTabHandler::kIdPrefix) + "default") {}
  ~TestContainedTabHandler() override = default;
...
class ContainersBrowserTest : public InProcessBrowserTest {
 public:
  ...
  void SetUpOnMainThread() override {
    ...
    ContainedTabHandlerRegistry::GetInstance().RegisterContainedTabHandler(
        std::make_unique<TestContainedTabHandler>());
  }
