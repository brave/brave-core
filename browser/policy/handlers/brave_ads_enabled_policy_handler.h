...
#ifndef BRAVE_BROWSER_POLICY_HANDLERS_BRAVE_ADS_ENABLED_POLICY_HANDLER_H_
#define BRAVE_BROWSER_POLICY_HANDLERS_BRAVE_ADS_ENABLED_POLICY_HANDLER_H_
...
#endif  // BRAVE_BROWSER_POLICY_HANDLERS_BRAVE_ADS_ENABLED_POLICY_HANDLER_H_
