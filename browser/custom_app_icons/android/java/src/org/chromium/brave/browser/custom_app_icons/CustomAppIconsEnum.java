...
//             "org.chromium.chrome.browser.ChromeTabbedActivity"),
    ICON_3D(
            R.drawable.ic_launcher_3d,
            R.string.launcher_3d_title,
            ".Icon3dAlias"),
    ICON_80S(
            R.drawable.ic_launcher_80s,
            R.string.launcher_80s_title,
            ".Icon80sAlias"),
    ICON_AQUA(
            R.drawable.ic_launcher_aqua,
            R.string.launcher_aqua_title,
            ".IconAquaAlias"),
    ICON_BAT(
            R.drawable.ic_launcher_bat,
    ...
    ICON_TERMINAL(
            ...
            ".IconTerminalAlias"),
    ICON_WINDOWS(
            R.drawable.ic_launcher_windows,
