...
#include "brave/vendor/bat-native-confirmations/src/redeem_payment_tokens_request.h"
...
TEST_F(ConfirmationsRedeemPaymentTokensRequestTest, CreatePayload) {
  ...
  // Assert
  std::string expected_payload = R"({"paymentId":"e7fcf220-d3f4-4111-a0b2-6157d0347567"})";
