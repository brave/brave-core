...
TEST_F(ConfirmationsSecurityHelperTest, Sign) {
  ...
  // Assert
  std::string expected_signature = R"(keyId="primary",algorithm="ed25519",headers="digest",signature="p6qg0RfYtYmo4B6WG9Mcap5BxmqDRpxlGrBOnKy5G5ZBnnnn9G8yMWYGZnxcj/6tY8sesQdD9rsVTh0zXId7BA==")";
...
TEST_F(ConfirmationsSecurityHelperTest, Sign_InvalidPublicKey) {
  ...
  // Assert
  std::string expected_signature = "p6qg0RfYtYmo4B6WG9Mcap5BxmqDRpxlGrBOnKy5G5ZBnnnn9G8yMWYGZnxcj/6tY8sesQdD9rsVTh0zXId7BA==";
...
TEST_F(ConfirmationsSecurityHelperTest, GetSHA256) {
  ...
  // Assert
  std::string expected_sha256_base64 = "aZnA/ebclJA35jQ19ouTeW0X75OmXNnoBvAnDuXJtNI=";
