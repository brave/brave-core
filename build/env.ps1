...
# Sets environment variables generated by build/commands/scripts/genEnv.js.
#
# This allows you to run gn, ninja, gclient, and other tools with a
# Brave-specific environment.
#
# If you modify this script, make sure to update .cmd/.sh versions.
