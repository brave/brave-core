...
const braveAndroidCustomAppIconsStringsPath = path.resolve(path.join(srcDir, 'brave','browser','custom_app_icons', 'android', 'java', 'strings', 'android_custom_app_icons_strings.grd'))
