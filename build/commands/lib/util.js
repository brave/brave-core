...
const util = {
  ...
  writeGnBuildArgs: (outputDir, buildArgs) => {
    // Generate build arguments in .gni format to be imported into args.gn.
    ...
    // Import args_generated.gni into args.gn. This approach enables
    // customization of args.gn without the build scripts resetting it during
    // each execution.
    ...
    if (!isArgsGnValid) {
      fs.writeFileSync(argsGnFilePath, generatedArgsImportLine + '\n')
