...
exports.update = () => {
  ...
  // Also map brave_origin string files
  autoGeneratedBraveToChromiumMapping[
    path.join(braveAppDir, 'brave_origin_strings.grd')
  ] = path.join(chromeAppDir, 'brave_origin_strings.grd')
  autoGeneratedBraveToChromiumMapping[
    path.join(braveAppDir, 'settings_brave_origin_strings.grdp')
  ] = path.join(chromeAppDir, 'settings_brave_origin_strings.grdp')
  autoGeneratedBraveToChromiumMapping[
    path.join(braveComponentsDir, 'components_brave_origin_strings.grd')
  ] = path.join(chromeComponentsDir, 'components_brave_origin_strings.grd')
