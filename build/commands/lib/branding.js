...
exports.update = () => {
  ...
  autoGeneratedBraveToChromiumMapping[
    path.join(braveAppDir, 'brave_strings_main.grdp')
  ] = path.join(chromeAppDir, 'brave_strings_main.grdp')
  autoGeneratedBraveToChromiumMapping[
    path.join(braveAppDir, 'settings_brave_strings.grdp')
  ] = path.join(chromeAppDir, 'settings_brave_strings.grdp')
  autoGeneratedBraveToChromiumMapping[
    path.join(braveComponentsDir, 'components_brave_strings_main.grdp')
  ] = path.join(chromeComponentsDir, 'components_brave_strings_main.grdp')
