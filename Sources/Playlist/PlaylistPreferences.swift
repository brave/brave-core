...
extension Preferences {
  final public class Playlist {
    ...
    public static let listViewSide = Option<String>(key: "playlist.listViewSide", default: PlayListSide.left.rawValue)
    /// The count of how many times  Add to Playlist URL-Bar onboarding has been shown
    public static let addToPlaylistURLBarOnboardingCount = Option<Int>(key: "playlist.addToPlaylistURLBarOnboardingCount", default: 0)
    /// The last played item url
    public static let lastPlayedItemUrl = Option<String?>(key: "playlist.last.played.item.url", default: nil)
    /// The last played item time
    public static let lastPlayedItemTime = Option<Double>(key: "playlist.last.played.item.time", default: 0.0)
    /// Whether to play the video when controller loaded
    public static let firstLoadAutoPlay = Option<Bool>(key: "playlist.firstLoadAutoPlay", default: false)
