...
extension Strings {
  ...
  public static let tabsSettingsSectionTitle = NSLocalizedString("SettingsTabsSectionTitle", tableName: "BraveShared", bundle: .strings, value: "Tabs", comment: "Tabs settings section title")
  public static let tabsOptionTopBar = NSLocalizedString("SettingsTabsOptionTopBar", tableName: "BraveShared", bundle: .strings, value: "Top Bar", comment: "An option for the URL bar position. (Top Bar and Bottom Bar). Refers to the location of the url bar")
  public static let tabsOptionBottomBar = NSLocalizedString("SettingsTabsOptionBottomBar", tableName: "BraveShared", bundle: .strings, value: "Bottom Bar", comment: "An option for the URL bar position. (Top Bar and Bottom Bar). Refers to the location of the url bar")
...
extension Strings {
  ...
  public static let showTabsBar = NSLocalizedString("ShowTabsBar", tableName: "BraveShared", bundle: .strings, value: "Tabs Bar", comment: "Setting to show/hide the tabs bar")
  ...
  public static let filterListDownloadedLabel = NSLocalizedString("Downloaded", tableName: "BraveShared", bundle: .strings, value: "Downloaded", comment: "A label representing the state of a filter list that is downloaded")
  public static let filterListDownloadingLabel = NSLocalizedString("Downloading", tableName: "BraveShared", bundle: .strings, value: "Downloading", comment: "A label representing the state of a filter list that is currently being downloaded")
  public static let filterListNotDownloadedLabel = NSLocalizedString("NotDownloaded", tableName: "BraveShared", bundle: .strings, value: "Not downloaded", comment: "A label representing the state of a filter list that is not downloaded")
  ...
  public static let neverShow = NSLocalizedString("NeverShow", tableName: "BraveShared", bundle: .strings, value: "Off", comment: "Setting preference to always hide the browser tabs bar.")
  public static let alwaysShow = NSLocalizedString("AlwaysShow", tableName: "BraveShared", bundle: .strings, value: "On", comment: "Setting preference to always show the browser tabs bar.")
  public static let showInLandscapeOnly = NSLocalizedString("ShowInLandscapeOnly", tableName: "BraveShared", bundle: .strings, value: "Landscape Only", comment: "Setting preference to only show the browser tabs bar when the device is in the landscape orientation.")
