...
extension Strings {
  public struct Sync {
    ...
    public static let syncJoinChainCodewordsWarning =
      NSLocalizedString(
        "syncJoinChainCodewordsWarning",
        tableName: "BraveShared",
        bundle: .module,
        value: "This will share your Brave data, including potentially your passwords, with the device that generated these code words. Please double check that these code words were generated by a device that you own. Are you sure you want to do this?",
        comment: "Default name for a device")
    public static let syncJoinChainCameraWarning =
    NSLocalizedString(
      "syncJoinChainCameraWarning",
      tableName: "BraveShared",
      bundle: .module,
      value: "This will share your Brave data, including potentially your passwords, with the device that generated this QR code. Please double check that this QR code was generated by a device that you own. Are you sure you want to do this?",
      comment: "Default name for a device")
    public static let syncDeviceFetchErrorAlertDescription =
      NSLocalizedString(
        "login.syncDeviceFetchErrorAlertDescription",
        tableName: "BraveShared",
        bundle: .module,
    ...
    public static let syncDevicesInSyncChainTitle =
      NSLocalizedString(
        "login.syncDevicesInSyncChainTitle",
        tableName: "BraveShared",
        bundle: .module,
    ...
    public static let syncMaximumDeviceReachedErrorDescription =
      NSLocalizedString(
        "login.syncMaximumDeviceReachedErrorDescription",
        tableName: "BraveShared",
        bundle: .module,
        value: "Cant join sync chain. Exceeds the maximum number of devices (10)",
