...
class Upgrade(Versioned):
  ...
  """
    ...
    This helper is used to check for the MacOS SDK, Windows SDK. It looks for
    diff of a given file to find if a certain key has been updade in-between
    the working and target version.
    ...
    def _check_win_sdk(self) -> Optional[Dict]:
        """Check for Windows SDK updates.
    ...
    def _check_mac_sdk(self) -> Optional[Dict]:
        """Check for Windows SDK updates.
    ...
    This function returns an advisory record if the MacoOS SDK has been updated.
        ...
        if result:
            ...
            result['advice'] = (
                ...
                'toolchain. Update `XCODE_VERSION` and SDK version in '
                'build/mac/download_hermetic_xcode.py for the new download '
                'URL.')
        return result
