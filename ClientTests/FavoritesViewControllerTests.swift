...
class FavoritesViewControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        vc = FavoritesViewController(profile: MockProfile(), dataSource: dataSource, fromOverlay: false, rewards: nil)
    ...
    func testFavoritesViewControllerLoadsView() {
        let viewController = FavoritesViewController(profile: MockProfile(),
                                                     dataSource: MockFavoritesDataSource(), fromOverlay: false, rewards: nil)
