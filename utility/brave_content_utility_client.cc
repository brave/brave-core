...
auto RunLedgerFactory(
    mojo::PendingReceiver<ledger::mojom::LedgerImplFactory> receiver) {
  return std::make_unique<ledger::LedgerImplFactoryImpl>(std::move(receiver));
}
