...
extension Strings {
  ...
  public static let autoRedirectAMPPages = NSLocalizedString("AutoRedirectAMPPages", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Auto-Redirect AMP Pages", comment: "This is a title for a setting toggle that enables/disables auto-redirect of Google's AMP (Accelerated Mobile Page) pages to the original (non-AMP) pages. The text 'AMP' is not to be translated.")
  public static let autoRedirectAMPPagesDescription = NSLocalizedString("AutoRedirectAMPPagesDescription", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Always visit original (non-AMP) page URLs, instead of Google's Accelerated Mobile Page versions", comment: "This is a description for a setting toggle that enables/disables auto-redirect of Google's AMP (Accelerated Mobile Page) pages to the original (non-AMP) pages. The text 'AMP' and 'Accelerated Mobile Page' is not to be translated.")
