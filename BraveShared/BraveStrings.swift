...
public extension Strings {
    ...
    public static let BraveSync = NSLocalizedString("BraveSync", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Brave (beta) Sync", comment: "Brave sync page title")
