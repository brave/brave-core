...
import getWidgetBrowserAPI, * as BraveVPN from '../../../api/braveVpn';
...
const Shield = () => (
  <svg width="64" height="64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path className={styles.background} d="M34.309 1.49a5.685 5.685 0 0 0-4.618 0L9.793 10.334a5.685 5.685 0 0 0-3.376 5.195v13.36C6.417 44.666 17.332 59.42 32 63c14.668-3.582 25.583-18.334 25.583-34.11V15.528a5.685 5.685 0 0 0-3.376-5.195L34.309 1.49Z" stroke="#000" strokeWidth="1.5" />
    ...
    <defs>
      <linearGradient id="shieldGradient" x1="54.925" y1="58.715" x2="-2.622" y2="12.177" gradientUnits="userSpaceOnUse">
        <stop offset=".026" stopColor="#FA7250" />
        <stop offset=".401" stopColor="#FF1893" />
        <stop offset=".995" stopColor="#A78AFF" />
      </linearGradient>
    </defs>
  </svg>
)
...
export const VPNWidget = ({
  ...
  return (
    <StyledCard>
      ...
      <WidgetWrapper>
        <WidgetBody className={connectionState === BraveVPN.ConnectionState.CONNECTED && styles.connected}>
