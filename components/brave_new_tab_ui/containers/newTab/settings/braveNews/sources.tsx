...
function CategoryList (props: CategoryListProps) {
  ...
  return (
    <>
      <SettingsSectionTitle>{getLocale('braveNewsSourcesTitle')}</SettingsSectionTitle>
...
const categoryNameAll = getLocale('braveNewsCategoryNameAll')
      ...
      <>
        <Styled.YourSources>
          <SettingsSectionTitle isLayoutControlled={true}>
            {/* getLocale('braveNewsYourSourcesTitle') */}
            Your Sources
          </SettingsSectionTitle>
