...
class NewTabPage extends React.Component<Props, State> {
  ...
  allWidgetsHidden = () => {
    ...
    return hideAllWidgets || [
      ...
      braveTalkSupported && showBraveTalk && !isBraveTalkDisabledByPolicy,
  ...
  renderBraveTalkWidget (showContent: boolean, position: number) {
    const { newTabData } = this.props
    const { showBraveTalk, textDirection, braveTalkSupported, isBraveTalkDisabledByPolicy } = newTabData
