...
export const enum types {
  ...
  ON_CONTRIBUTE_USER_TLD = '@@newtab/ON_CONTRIBUTE_USER_TLD',
  ...
  SET_CONTRIBUTE_SUPPORTED = '@@newtab/SET_CONTRIBUTE_SUPPORTED',
  ON_BINANCE_ACCOUNT_BALANCES = '@@newtab/ON_BINANCE_ACCOUNT_BALANCES',
  ON_CONTRIBUTE_ACCOUNT_BALANCES = '@@newtab/ON_CONTRIBUTE_ACCOUNT_BALANCES',
  ON_BINANCE_CLIENT_URL = '@@newtab/ON_BINANCE_CLIENT_URL',
  ON_CONTRIBUTE_CLIENT_URL = '@@newtab/ON_CONTRIBUTE_CLIENT_URL',
  ...
  CONNECT_TO_CONTRIBUTE = '@@newtab/CONNECT_TO_CONTRIBUTE',
  DISCONNECT_BINANCE = '@@newtab/DISCONNECT_BINANCE',
  DISCONNECT_CONTRIBUTE = '@@newtab/DISCONNECT_CONTRIBUTE',
