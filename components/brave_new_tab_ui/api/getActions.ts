...
import * as ftxActions from '../components/widgets/ftx/actions'
...
export function getActionsForDispatch (dispatch: Dispatch) {
  const allActions = Object.assign({}, newTabActions, stackWidgetActions, gridSitesActions, binanceActions, rewardsActions, geminiActions, cryptoDotComActions, ftxActions)
  return {
