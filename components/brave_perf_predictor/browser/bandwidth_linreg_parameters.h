...
[[clang::no_destroy]] const std::array<std::string, feature_count>
    feature_sequence{
        "adblockRequests",
...
// added in the meantime to fix the build error. Remove this attribute and
// provide a proper fix.
[[clang::no_destroy]] const std::array<std::string, 190> relevant_entities{
    "Google Analytics",
    "Facebook",
    "Google CDN",
    "Twitter",
...
// added in the meantime to fix the build error. Remove this attribute and
// provide a proper fix.
[[clang::no_destroy]] const base::flat_set<std::string> relevant_entity_set(
...
// added in the meantime to fix the build error. Remove this attribute and
// provide a proper fix.
[[clang::no_destroy]] const base::flat_map<std::string,
                                           stdfactor> stdfactor_map = {
