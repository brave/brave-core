...
static const base::NoDestructor<std::array<std::string, feature_count>>
    feature_sequence({
        "adblockRequests",
...
static const base::NoDestructor<std::array<std::string, 190>> relevant_entities(
    {
        "Google Analytics",
        "Facebook",
        "Google CDN",
...
static const base::NoDestructor<base::flat_map<std::string, stdfactor>>
    stdfactor_map({
        {"adblockRequests",
