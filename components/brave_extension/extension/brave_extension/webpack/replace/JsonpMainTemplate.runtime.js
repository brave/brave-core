...
module.exports = function () {
  ...
  function evalCode (code, context) {
    return (function () { return eval(code) }.call(context)) // eslint-disable-line 
  }

  context.hotDownloadUpdateChunk = function (chunkId) { // eslint-disable-line no-unused-vars
    var src = __webpack_require__.p + '' + chunkId + '.' + hotCurrentHash + '.hot-update.js' // eslint-disable-line 
