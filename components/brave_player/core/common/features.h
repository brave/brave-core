...
#ifndef BRAVE_COMPONENTS_BRAVE_PLAYER_CORE_COMMON_FEATURES_H_
#define BRAVE_COMPONENTS_BRAVE_PLAYER_CORE_COMMON_FEATURES_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_PLAYER_CORE_COMMON_FEATURES_H_
