...
#ifndef BRAVE_COMPONENTS_CLIENT_ATTESTATION_LOADER_H_
#define BRAVE_COMPONENTS_CLIENT_ATTESTATION_LOADER_H_
...
#endif  // BRAVE_COMPONENTS_CLIENT_ATTESTATION_LOADER_H_
