...
class BraveOriginSettingsHandlerImpl
 ...
 public:
  ...
  void GetBraveOriginPref(const std::string& pref_name,
                          GetBraveOriginPrefCallback callback) override;
  void SetBraveOriginPref(const std::string& pref_name,
                          base::Value value,
                          SetBraveOriginPrefCallback callback) override;
