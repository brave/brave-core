...
void BraveOriginPolicyManager::AddObserver(BravePolicyObserver* observer) {
...
void BraveOriginPolicyManager::RemoveObserver(BravePolicyObserver* observer) {
...
void BraveOriginPolicyManager::SetPolicyValue(
  ...
  if (profile_id.has_value()) {
    observers_.Notify(&BravePolicyObserver::OnProfilePolicyChanged, policy_key,
                      profile_id.value());
  } else {
    observers_.Notify(&BravePolicyObserver::OnBrowserPolicyChanged, policy_key);
  }
}
