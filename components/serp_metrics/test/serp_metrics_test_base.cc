...
void SerpMetricsTestBase::SetUp() {
  local_state_.registry()->RegisterTimePref(std::string(prefs::kLastReportedAt),
                                            base::Time());
  local_state_.registry()->RegisterTimePref(
      std::string(prefs::kLastWeeklyReportedAt), base::Time());
  local_state_.registry()->RegisterTimePref(
      std::string(prefs::kLastMonthlyReportedAt), base::Time());
