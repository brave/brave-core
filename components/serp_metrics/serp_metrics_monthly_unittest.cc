...
// The retention window covers three full calendar months,
...
TEST_F(SerpMetricsMonthlyTest, BraveSearchCountForStalePeriod) {
  // Month 0: Stale
  serp_metrics_->RecordSearch(SerpMetricType::kBrave);
  serp_metrics_->RecordSearch(SerpMetricType::kBrave);
  AdvanceClockByOneMonth();
...
TEST_F(SerpMetricsMonthlyTest, GoogleSearchCountForStalePeriod) {
  // Month 0: Stale
  serp_metrics_->RecordSearch(SerpMetricType::kGoogle);
  serp_metrics_->RecordSearch(SerpMetricType::kGoogle);
  AdvanceClockByOneMonth();
...
TEST_F(SerpMetricsMonthlyTest, OtherSearchCountForStalePeriod) {
  // Month 0: Stale
  serp_metrics_->RecordSearch(SerpMetricType::kOther);
  serp_metrics_->RecordSearch(SerpMetricType::kOther);
  AdvanceClockByOneMonth();
...
TEST_F(SerpMetricsMonthlyTest, SearchCountsForLastMonthAndStalePeriod) {
  // Month 0: Stale
  serp_metrics_->RecordSearch(SerpMetricType::kBrave);
  serp_metrics_->RecordSearch(SerpMetricType::kGoogle);
  serp_metrics_->RecordSearch(SerpMetricType::kGoogle);
...
TEST_F(SerpMetricsMonthlyTest, SearchCountForStalePeriodOnCuspOfMonthRollover) {
  // Month 0: Stale
  serp_metrics_->RecordSearch(SerpMetricType::kBrave);
  serp_metrics_->RecordSearch(SerpMetricType::kGoogle);
  serp_metrics_->RecordSearch(SerpMetricType::kOther);
...
TEST_F(SerpMetricsMonthlyTest, DoNotCountSearchesOutsideGivenRetentionPeriod) {
  ...
  // Month 5: This month (no searches)
...
TEST_F(SerpMetricsMonthlyTest,
       LastCheckedAtOnLastMonthStartYieldsZeroStalePeriod) {
  // Month 0: Stale
  serp_metrics_->RecordSearch(SerpMetricType::kBrave);
  AdvanceClockByOneMonth();
...
TEST_F(SerpMetricsMonthlyTest,
       SearchRecordedOnDecember31CountsAsLastMonthInJanuary) {
  base::Time time;
