...
#ifndef BRAVE_COMPONENTS_SERP_METRICS_SEARCH_ENGINE_INFO_H_
#define BRAVE_COMPONENTS_SERP_METRICS_SEARCH_ENGINE_INFO_H_
...
#endif  // BRAVE_COMPONENTS_SERP_METRICS_SEARCH_ENGINE_INFO_H_
