...
// does not support `TimeDelta` field trial parameters. Three 31-day months
// ensure the previous calendar month always falls within the retention window
// when the monthly ping fires, since the worst case is a full 31-day prior
// month plus up to 31 days into the current month plus up to 31 days until the
// next monthly ping fires.
