...
class SerpMetricsTimePeriodStorageDSTEndTest
...
TEST_P(SerpMetricsTimePeriodStorageDSTEndTest,
       CreatesNewDailyBucketAfterDSTEnd) {
...
INSTANTIATE_TEST_SUITE_P(
    DSTEndTimezones,
    SerpMetricsTimePeriodStorageDSTEndTest,
    kDSTEndTimezones,
