...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_STATE_STATE_KEYS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_STATE_STATE_KEYS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_STATE_STATE_KEYS_H_
