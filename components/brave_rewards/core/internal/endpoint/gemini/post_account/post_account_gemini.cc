...
#include "brave/components/brave_rewards/core/internal/endpoint/gemini/post_account/post_account_gemini.h"
...
PostAccount::PostAccount(RewardsEngine& engine) : engine_(engine) {}
