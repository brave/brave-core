...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_LEGACY_WALLET_INFO_PROPERTIES_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_LEGACY_WALLET_INFO_PROPERTIES_H_
