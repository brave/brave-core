...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_LEGACY_REPORT_BALANCE_PROPERTIES_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_LEGACY_REPORT_BALANCE_PROPERTIES_H_
