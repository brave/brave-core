...
#include "brave/components/brave_rewards/core/internal/legacy/report_balance_properties.h"
...
#include "brave/components/brave_rewards/core/internal/legacy/bat_util.h"
