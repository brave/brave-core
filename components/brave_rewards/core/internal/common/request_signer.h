...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_COMMON_REQUEST_SIGNER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_COMMON_REQUEST_SIGNER_H_
