...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_PUBLISHER_PREFIX_LIST_READER_H_

#include <string>

#include "brave/components/brave_rewards/core/internal/publisher/prefix_iterator.h"
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_PUBLISHER_PREFIX_LIST_READER_H_
