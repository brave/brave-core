...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_PUBLISHER_MEDIA_HELPER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_PUBLISHER_MEDIA_HELPER_H_
