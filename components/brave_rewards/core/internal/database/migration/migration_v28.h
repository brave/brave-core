...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_MIGRATION_MIGRATION_V28_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_MIGRATION_MIGRATION_V28_H_
