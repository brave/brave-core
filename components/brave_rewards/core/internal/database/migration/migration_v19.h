...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_MIGRATION_MIGRATION_V19_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_MIGRATION_MIGRATION_V19_H_
