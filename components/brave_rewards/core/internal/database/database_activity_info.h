...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_DATABASE_ACTIVITY_INFO_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_DATABASE_ACTIVITY_INFO_H_
