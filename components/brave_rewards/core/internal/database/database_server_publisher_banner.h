...
#include "brave/components/brave_rewards/core/internal/database/database_server_publisher_links.h"
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_DATABASE_SERVER_PUBLISHER_BANNER_H_
