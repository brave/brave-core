...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_DATABASE_EXTERNAL_TRANSACTIONS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_DATABASE_EXTERNAL_TRANSACTIONS_H_
