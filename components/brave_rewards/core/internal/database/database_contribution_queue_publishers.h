...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_DATABASE_CONTRIBUTION_QUEUE_PUBLISHERS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_DATABASE_DATABASE_CONTRIBUTION_QUEUE_PUBLISHERS_H_
