...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_WALLET_PROVIDER_LINKAGE_CHECKER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_WALLET_PROVIDER_LINKAGE_CHECKER_H_
