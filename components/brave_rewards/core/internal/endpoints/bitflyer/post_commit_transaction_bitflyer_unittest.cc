...
#include "brave/components/brave_rewards/core/internal/endpoints/bitflyer/post_commit_transaction_bitflyer.h"
...
using PostCommitTransactionBitFlyerParamType =
    std::tuple<std::string,          // test name suffix
               net::HttpStatusCode,  // post commit transaction endpoint status
                                     // code
