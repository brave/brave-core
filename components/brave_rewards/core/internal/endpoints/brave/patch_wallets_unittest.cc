...
#include "brave/components/brave_rewards/core/internal/test/rewards_engine_test.h"
...
using PatchWalletsParamType =
    std::tuple<std::string,          // test name suffix
               net::HttpStatusCode,  // post create wallet endpoint response
                                     // status code
