...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_BRAVE_POST_WALLETS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_BRAVE_POST_WALLETS_H_
