...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_BRAVE_POST_CONNECT_UPHOLD_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_BRAVE_POST_CONNECT_UPHOLD_H_
