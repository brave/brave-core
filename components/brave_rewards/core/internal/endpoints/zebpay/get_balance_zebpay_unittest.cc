...
#include "brave/components/brave_rewards/core/internal/endpoints/zebpay/get_balance_zebpay.h"
...
using GetBalanceZebPayParamType =
    std::tuple<std::string,          // test name suffix
               net::HttpStatusCode,  // GET balance ZebPay endpoint response
                                     // status code
