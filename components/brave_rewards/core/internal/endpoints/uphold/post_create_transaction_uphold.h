...
#include "brave/components/brave_rewards/core/internal/endpoints/common/post_create_transaction.h"
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_UPHOLD_POST_CREATE_TRANSACTION_UPHOLD_H_
