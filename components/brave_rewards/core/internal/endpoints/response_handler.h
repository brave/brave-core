...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_RESPONSE_HANDLER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_RESPONSE_HANDLER_H_
...
class ResponseHandler {
 ...
 private:
  static void OnResponse(RewardsEngine& engine,
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_RESPONSE_HANDLER_H_
