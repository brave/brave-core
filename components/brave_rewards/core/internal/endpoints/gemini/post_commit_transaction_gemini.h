...
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_INTERNAL_ENDPOINTS_GEMINI_POST_COMMIT_TRANSACTION_GEMINI_H_

#include <optional>
#include <string>
#include <vector>

#include "brave/components/brave_rewards/core/internal/endpoints/common/post_commit_transaction.h"
