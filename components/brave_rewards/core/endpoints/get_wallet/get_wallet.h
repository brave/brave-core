...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_GET_WALLET_GET_WALLET_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_GET_WALLET_GET_WALLET_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_GET_WALLET_GET_WALLET_H_
