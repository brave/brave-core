...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_POST_CONNECT_GEMINI_POST_CONNECT_GEMINI_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_POST_CONNECT_GEMINI_POST_CONNECT_GEMINI_H_
...
class PostConnectGemini final : public PostConnect {
 public:
  PostConnectGemini(std::string&& linking_info,
