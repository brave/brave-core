...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_POST_CONNECT_BITFLYER_POST_CONNECT_BITFLYER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_POST_CONNECT_BITFLYER_POST_CONNECT_BITFLYER_H_
...
class PostConnectBitflyer final : public PostConnect {
 public:
  PostConnectBitflyer(std::string&& linking_info);
