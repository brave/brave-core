...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_GET_PARAMETERS_GET_PARAMETERS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_GET_PARAMETERS_GET_PARAMETERS_H_
