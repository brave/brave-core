...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_UPHOLD_POST_OAUTH_POST_OAUTH_UPHOLD_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENDPOINTS_UPHOLD_POST_OAUTH_POST_OAUTH_UPHOLD_H_
...
class PostOAuthUphold final : public RequestBuilder,
 ...
 public:
  ...
  PostOAuthUphold(std::string&& code);
