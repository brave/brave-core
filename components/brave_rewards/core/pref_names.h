...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_PREF_NAMES_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_PREF_NAMES_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_PREF_NAMES_H_
