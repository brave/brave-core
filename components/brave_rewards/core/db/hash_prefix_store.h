...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_DB_HASH_PREFIX_STORE_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_DB_HASH_PREFIX_STORE_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_DB_HASH_PREFIX_STORE_H_
