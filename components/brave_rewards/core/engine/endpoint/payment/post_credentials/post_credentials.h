...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_PAYMENT_POST_CREDENTIALS_POST_CREDENTIALS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_PAYMENT_POST_CREDENTIALS_POST_CREDENTIALS_H_
...
class PostCredentials {
 public:
  explicit PostCredentials(RewardsEngine& engine);
  ~PostCredentials();
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINT_PAYMENT_POST_CREDENTIALS_POST_CREDENTIALS_H_
