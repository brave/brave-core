...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_LEGACY_PUBLISHER_STATE_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_LEGACY_PUBLISHER_STATE_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_LEGACY_PUBLISHER_STATE_H_
