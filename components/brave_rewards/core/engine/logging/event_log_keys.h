...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_LOGGING_EVENT_LOG_KEYS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_LOGGING_EVENT_LOG_KEYS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_LOGGING_EVENT_LOG_KEYS_H_
