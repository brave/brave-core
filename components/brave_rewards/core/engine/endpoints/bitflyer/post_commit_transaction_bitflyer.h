...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_BITFLYER_POST_COMMIT_TRANSACTION_BITFLYER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_BITFLYER_POST_COMMIT_TRANSACTION_BITFLYER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_BITFLYER_POST_COMMIT_TRANSACTION_BITFLYER_H_
