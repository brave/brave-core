...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_UTIL_SIGNER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_UTIL_SIGNER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_UTIL_SIGNER_H_
