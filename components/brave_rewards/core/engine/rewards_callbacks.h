...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_REWARDS_CALLBACKS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_REWARDS_CALLBACKS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_REWARDS_CALLBACKS_H_
