...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_INITIALIZATION_MANAGER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_INITIALIZATION_MANAGER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_INITIALIZATION_MANAGER_H_
