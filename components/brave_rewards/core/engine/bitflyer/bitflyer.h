...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_BITFLYER_BITFLYER_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_BITFLYER_BITFLYER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_BITFLYER_BITFLYER_H_
