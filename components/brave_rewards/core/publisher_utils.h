...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_PUBLISHER_UTILS_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_PUBLISHER_UTILS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_PUBLISHER_UTILS_H_
