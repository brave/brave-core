...
class MediaYouTubeTest : public MockLedgerTest {};

TEST_F(MediaYouTubeTest, GetMediaIdFromUrl) {
  // missing video id
...
TEST_F(MediaYouTubeTest, GetPublisherKeyFromUrl) {
  // path is empty
  std::string path = "";
  std::string key;
...
TEST_F(MediaYouTubeTest, GetUserFromUrl) {
  // path is empty
  std::string path = "/";
...
TEST_F(MediaYouTubeTest, GetBasicPath) {
...
TEST_F(MediaYouTubeTest, GetNameFromChannel) {
...
TEST_F(MediaYouTubeTest, GetPublisherName) {
...
TEST_F(MediaYouTubeTest, GetLinkType) {
...
TEST_F(MediaYouTubeTest, GetMediaIdFromParts) {
...
TEST_F(MediaYouTubeTest, GetMediaDurationFromParts) {
  base::flat_map<std::string, std::string> parts;
...
TEST_F(MediaYouTubeTest, GetVideoUrl) {
...
TEST_F(MediaYouTubeTest, GetChannelUrl) {
...
TEST_F(MediaYouTubeTest, GetFavIconUrl) {
  // null case
  std::string data;
...
TEST_F(MediaYouTubeTest, GetChannelId) {
  // null case
  std::string data;
...
TEST_F(MediaYouTubeTest, GetChannelIdFromCustomPathPage) {
  // null case
  std::string data;
...
TEST_F(MediaYouTubeTest, IsPredefinedPath) {
  // null case
  std::string path;
...
TEST_F(MediaYouTubeTest, GetPublisherKey) {
