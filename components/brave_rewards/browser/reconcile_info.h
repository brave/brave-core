...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_BROWSER_RECONCILE_INFO_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_BROWSER_RECONCILE_INFO_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_BROWSER_RECONCILE_INFO_H_
