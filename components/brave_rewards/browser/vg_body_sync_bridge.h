...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_BROWSER_VG_BODY_SYNC_BRIDGE_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_BROWSER_VG_BODY_SYNC_BRIDGE_H_
...
class VgBodySyncBridge : public syncer::ModelTypeSyncBridge {
 ...
 private:
  ...
  base::OnceCallback<void(std::vector<sync_pb::VgBodySpecifics>)>
      when_vg_bodies_ready_;
  std::unique_ptr<syncer::ModelTypeStore> store_;
  base::WeakPtrFactory<VgBodySyncBridge> weak_ptr_factory_{this};
};
}  // namespace brave_rewards

#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_BROWSER_VG_BODY_SYNC_BRIDGE_H_
