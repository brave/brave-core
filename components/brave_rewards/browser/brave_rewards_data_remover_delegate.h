...
class BraveRewardsDataRemoverDelegate
    : public ChromeBrowsingDataRemoverDelegate
{
 public:
  ...
  explicit BraveRewardsDataRemoverDelegate(content::BrowserContext* context);

  ~BraveRewardsDataRemoverDelegate() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BraveRewardsDataRemoverDelegate);
};
