...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CONTENT_SERVICE_SANDBOX_TYPE_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CONTENT_SERVICE_SANDBOX_TYPE_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CONTENT_SERVICE_SANDBOX_TYPE_H_
