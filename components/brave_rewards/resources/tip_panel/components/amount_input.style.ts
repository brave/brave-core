...
export const selector = styled.div`
  --amount-selector-border-color: var(--color-divider-subtle);

  display: flex;
  gap: 1px;
  border-radius: 8px;
  overflow: hidden;
  border: solid 1px var(--color-divider-subtle);
  ...
  button.selected {
    background: var(--color-container-interactive-background);
...
export const customInput = styled.div`
  input {
    border: none;
    margin: 0;
    background: var(--color-container-highlight);
    border-radius: 8px;
    padding: 6px 0;
    width: 3em;
    text-align: center;
