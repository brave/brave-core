...
const getTweetMetaData =
    (tweet: Element): RewardsTip.TweetMetaData|null => {
      if (!tweet) {
        return null
      }
      ...
      const tweetTimestampElements =
          tweet.getElementsByClassName('js-short-timestamp')
      if (!tweetTimestampElements || tweetTimestampElements.length === 0) {
        return null
      }

      const tweetTimestamp =
          tweetTimestampElements[0].getAttribute('data-time') || ''
...
const createBraveTipAction =
    (tweet: Element) => {
      ...
      braveTipAction.setAttribute(
          'data-original-title', getMessage('twitterTipsHoverText'))

      // Create the tip button
      const braveTipButton = document.createElement('button')
      braveTipButton.className =
      ...
      braveTipIcon.style.content =
          'url(\'data:image/svg+xml;utf8,<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 105 100" style="enable-background:new 0 0 105 100;" xml:space="preserve"><style type="text/css">.st1{fill:%23662D91;}.st2{fill:%239E1F63;}.st3{fill:%23FF5000;}.st4{fill:%23FFFFFF;stroke:%23FF5000;stroke-width:0.83;stroke-miterlimit:10;}</style><title>BAT_icon</title><g id="Layer_2_1_"><g id="Layer_1-2"><polygon class="st1" points="94.8,82.6 47.4,55.4 0,82.9 "/><polygon class="st2" points="47.4,0 47.1,55.4 94.8,82.6 "/><polygon class="st3" points="0,82.9 47.2,55.9 47.4,0 "/><polygon class="st4" points="47.1,33.7 28,66.5 66.7,66.5 "/></g></g></svg>\')'
      ...
      braveTipActionCountPresentation.className =
          'ProfileTweet-actionCountForPresentation'
      braveTipActionCountPresentation.textContent =
          getMessage('twitterTipsIconLabel')
      ...
      chrome.runtime.sendMessage('rewardsEnabled', function(rewards) {
        const msg = {
          ...
          for (let i = 0; i < tweets.length; ++i) {
            const actions =
                tweets[i].getElementsByClassName('js-actions')[0] if (actions) {
              const braveTipActions =
                  actions.getElementsByClassName('action-brave-tip')
