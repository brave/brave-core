...
export const localeStrings: { [K in StringKey]: string }  = {
  ...
  authorizeDeviceLimitReachedText: 'Your $1 account could not be connected because you have already connected too many devices or profiles to your $1 account.',
  authorizeDeviceLimitReachedTitle: 'Device limit exceeded',
  ...
  unsupportedRegionText1: 'Unfortunately, it looks like you’re in a region where Brave Rewards is not available.',
