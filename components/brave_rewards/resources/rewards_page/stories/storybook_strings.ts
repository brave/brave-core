...
export const localeStrings: { [K in StringKey]: string } = {
  ...
  adsRegionNotSupportedText:
    'Brave Private Ads are not yet available in your region.',
  ...
  authorizeFlaggedWalletText2:
    "While your profile is flagged, you may continue to see ads, but won't be eligible to receive payouts. You also won't be able to connect a custodial account to Brave Rewards.",
  ...
  authorizeMismatchedCountriesText:
    "Hmm, it looks like your Brave Rewards country does not match the country of the $1 account you're trying to connect.",
  authorizeMismatchedCountriesTitle: 'Country mismatch',
  authorizeMismatchedProviderAccountsText:
    'Hmm, it looks like your Brave Rewards has already been verified with another $1 account. Please try verifying again using your previous account.',
  ...
  batUtilityTitle: 'Basic Attention Token – BAT',
  ...
  captchaSolvedText:
    'Brave Ads will resume. Thanks for helping us protect Brave Rewards.',
  ...
  contributeLoggedOutText:
    'It looks like you’re logged out of $1 for Brave Rewards. Log in again to continue.',
  ...
  payoutAccountTooltip:
    'Your BAT earnings will be paid to this payout account.',
