...
export const localeStrings = {
  ...
  notificationBackupWalletTitle: 'Back up Brave Rewards',
  notificationBackupWalletText: 'Please back up your Brave Rewards.',
  notificationBackupWalletAction: 'Back up now',
