...
export const enum types {
  ...
  GET_TRANSACTION_HISTORY_FOR_THIS_CYCLE =
      '@@rewards/GET_TRANSACTION_HISTORY_FOR_THIS_CYCLE',
  ON_TRANSACTION_HISTORY_FOR_THIS_CYCLE =
      '@@rewards/ON_TRANSACTION_HISTORY_FOR_THIS_CYCLE',
