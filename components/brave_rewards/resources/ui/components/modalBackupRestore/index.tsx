  ...
  getBackup = () => {
    ...
    return (
      <>
        <StyledContent>
          {
            formatMessage(getLocale('rewardsBackupText1'), {
              tags: {
          ...
          {
            formatMessage(getLocale('rewardsBackupText3'), {
              tags: {
                $1: (content) => (
                  <StyledLink
                    href="https://support.brave.com/hc/en-us/articles/6776407919885"
                    id={'backup-learn-more-link'}
                    key='link'>
                    {content}
                  </StyledLink>
                )
