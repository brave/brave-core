...
module.exports = function (genPath) {
  return {
    ...
    // react-markdown uses this deep in its tree, and the browser variant uses innerHTML, conflicting with UntrustedWebUI instances
    // we redirect to an alternative implementation that uses a lookup table instead of innerHTML
