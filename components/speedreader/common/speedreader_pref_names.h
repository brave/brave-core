...
#ifndef BRAVE_COMPONENTS_SPEEDREADER_COMMON_SPEEDREADER_PREF_NAMES_H_
#define BRAVE_COMPONENTS_SPEEDREADER_COMMON_SPEEDREADER_PREF_NAMES_H_
...
#endif  // BRAVE_COMPONENTS_SPEEDREADER_COMMON_SPEEDREADER_PREF_NAMES_H_
