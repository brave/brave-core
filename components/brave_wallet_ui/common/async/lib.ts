...
export async function findENSAddress (address: string, offchainExplicitlyAllowed: boolean) {
  const apiProxy = getAPIProxy()
  return apiProxy.jsonRpcService.ensGetEthAddr(address, offchainExplicitlyAllowed)
}
