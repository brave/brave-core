...
export function useAssets () {
  ...
  const assetsByValueAndNetwork = React.useMemo(() => {
    ...
    return assetsByNetwork.sort(function (a, b) {
      const aBalance = getBalance(networkList, selectedAccount, a)
      const bBalance = getBalance(networkList, selectedAccount, b)
  ...
  }, [selectedAccount, assetsByNetwork, getBalance, computeFiatAmount, networkList])
