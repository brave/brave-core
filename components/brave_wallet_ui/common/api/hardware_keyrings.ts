...
import EthereumLedgerBridgeKeyring from '../../common/hardware/ledgerjs/eth_ledger_bridge_keyring_new'
...
export type HardwareKeyring = EthereumLedgerBridgeKeyring | TrezorBridgeKeyring | SolanaLedgerBridgeKeyring
