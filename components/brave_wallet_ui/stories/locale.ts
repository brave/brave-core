...
provideStrings({
  ...
  braveWalletNftPinningBenefitsHeading: 'When you run IPFS on your computer you can:',
  braveWalletNftPinningBenefitOne: 'Help your NFT data online.',
  braveWalletNftPinningBenefitTwo: 'Assist in verifying authenticity of content and supporting the growth and maintenance of the IPFS network.',
  ...
  braveWalletNftPinningRunNodeDescription: 'IPFS is like a big library where people can store their files, including NFT data. It\'s designed to make data retrieval faster and more efficient, so that when you request data, you can get it from the closest library or the nearest location to you where someone else already has the copy of data. This means that your NFT data can be accessed quickly and easily, as long as your NFT data stays online.',
