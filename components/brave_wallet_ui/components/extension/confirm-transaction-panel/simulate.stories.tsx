...
export const _ConfirmSimulatedTransaction = () => {
...
_ConfirmSimulatedTransaction.story = {
  name: 'Confirm Simulated Transaction'
}

export default _ConfirmSimulatedTransaction
