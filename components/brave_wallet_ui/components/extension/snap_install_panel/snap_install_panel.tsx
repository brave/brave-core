...
export const SnapInstallPanel = ({ pending }: Props) => {
  ...
  if (state === BraveWallet.SnapInstallState.kInstalling) {
    return (
      <div style={styles.centered}>
        <ProgressRing mode='indeterminate' />
        <p style={styles.statusText}>
          {installData
            ? `Installing ${installData.manifest.proposedName}…`
            : 'Downloading snap…'}
        </p>
      </div>
    )
  ...
  if (state === BraveWallet.SnapInstallState.kSuccess) {
    return (
      <div style={styles.centered}>
        ...
        <p style={styles.statusText}>
          {installData
            ? `${installData.manifest.proposedName} installed!`
            : 'Snap installed!'}
        </p>
      </div>
    )
  ...
  // Pending approval — installData must be present
  if (!installData) {
    return null
  }
    ...
    <div style={styles.page}>
      ...
      <div style={styles.section}>
        ...
        <span style={styles.value}>
          {formatBytes(installData.bundleSizeBytes)}
        </span>
      </div>
