...
export const PortfolioAsset = (props: Props) => {
  ...
  const goBack = React.useCallback(() => {
    ...
    if (isShowingMarketData) {
      history.push(WalletRoutes.ExploreMarket)
      return
    }
    ...
    >
      <StyledWrapper>
        ...
        <Row padding='0px 20px'>
          <ButtonRow>
            {isAssetBuySupported && (
              <BridgeToAuroraButton onClick={onSelectBuy} noBottomMargin={true}>
        ...
        {!isShowingMarketData && (
          <Column padding='0px 24px 24px 24px' fullWidth={true}>
        ...
        {isShowingMarketData && selectedCoinMarket && (
          <Column padding='0px 20px 20px 20px' fullWidth={true}>
            <CoinStats
