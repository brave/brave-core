...
export const importWalletAttempts = ({ page }: State) =>
  page.importWalletAttempts
export const invalidMnemonic = ({ page }: State) => page.invalidMnemonic
export const isCryptoWalletsInitialized = ({ page }: State) =>
  page.isCryptoWalletsInitialized
export const isFetchingNFTMetadata = ({ page }: State) =>
  page.isFetchingNFTMetadata
export const isImportWalletsCheckComplete = ({ page }: State) =>
  page.isImportWalletsCheckComplete
export const isMetaMaskInitialized = ({ page }: State) =>
  page.isMetaMaskInitialized
