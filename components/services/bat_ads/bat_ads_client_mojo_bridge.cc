...
void OnGetCreativePublisherAdsToPreFetch(
  ...
  for (const auto& json : json_list) {
    ads::CreativePublisherAdInfo ad;
    if (ad.FromJson(json) != ads::Result::SUCCESS) {
      callback(ads::Result::FAILED, creative_instance_ids, {});
      return;
    }
  ...
  callback(ToAdsResult(result), creative_instance_ids, ads);
}

void BatAdsClientMojoBridge::GetCreativePublisherAdsToPreFetch(
    const std::vector<std::string>& creative_instance_ids,
  ...
  bat_ads_client_->GetCreativePublisherAdsToPreFetch(
      creative_instance_ids,
          base::BindOnce(&OnGetCreativePublisherAdsToPreFetch,
              std::move(callback)));
}
...
void BatAdsClientMojoBridge::GetExpiredCreativePublisherAds(
    const std::vector<std::string>& creative_instance_ids,
  ...
  bat_ads_client_->GetExpiredCreativePublisherAds(
      creative_instance_ids,
          base::BindOnce(&OnGetExpiredCreativePublisherAds,
              std::move(callback)));
}
