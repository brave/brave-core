...
const char kNewTabPageShowReferralBackgroundImage[] =
    "brave.new_tab_page.show_referral_background_image";
const char kReferralImagesServiceComponent[] =
    "brave.referral_images_service_component";
