...
// static
void SessionInfoHandler::Register() {
  sessions::ContentSerializedNavigationDriver::GetInstance()
      ->RegisterExtendedInfoHandler(kStoragePartitionSessionInfoKey,
                                    std::make_unique<SessionInfoHandler>());
}

SessionInfoHandler::SessionInfoHandler() = default;

SessionInfoHandler::~SessionInfoHandler() = default;

std::string SessionInfoHandler::GetExtendedInfo(
...
void SessionInfoHandler::RestoreExtendedInfo(const std::string& info_string,
...
SessionInfoHandler::GetStoragePartitionConfigToRestore(
  ...
  return content::StoragePartitionConfig::Create(
      ...
      partition_name ? *partition_name : std::string(),
