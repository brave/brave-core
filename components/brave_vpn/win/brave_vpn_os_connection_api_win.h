...
#ifndef BRAVE_COMPONENTS_BRAVE_VPN_WIN_BRAVE_VPN_OS_CONNECTION_API_WIN_H_
#define BRAVE_COMPONENTS_BRAVE_VPN_WIN_BRAVE_VPN_OS_CONNECTION_API_WIN_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_VPN_WIN_BRAVE_VPN_OS_CONNECTION_API_WIN_H_
