...
5. Build the project like regular (`pnpm run build`).
6. You can build the policy templates using `pnpm run build --target=brave/components/policy:pack_policy_templates`.
