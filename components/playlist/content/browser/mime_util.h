...
#ifndef BRAVE_COMPONENTS_PLAYLIST_CONTENT_BROWSER_MIME_UTIL_H_
#define BRAVE_COMPONENTS_PLAYLIST_CONTENT_BROWSER_MIME_UTIL_H_
...
#endif  // BRAVE_COMPONENTS_PLAYLIST_CONTENT_BROWSER_MIME_UTIL_H_
