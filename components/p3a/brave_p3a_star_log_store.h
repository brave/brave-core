...
#ifndef BRAVE_COMPONENTS_P3A_BRAVE_P3A_STAR_LOG_STORE_H_
#define BRAVE_COMPONENTS_P3A_BRAVE_P3A_STAR_LOG_STORE_H_
...
class BraveP3AStarLogStore : public metrics::LogStore {
 public:
  explicit BraveP3AStarLogStore(PrefService* local_state,
                                size_t keep_epoch_count);
  ~BraveP3AStarLogStore() override;
...
#endif  // BRAVE_COMPONENTS_P3A_BRAVE_P3A_STAR_LOG_STORE_H_
