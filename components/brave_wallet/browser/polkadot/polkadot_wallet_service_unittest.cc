...
TEST_F(PolkadotWalletServiceUnitTest, SignTransferExtrinsic) {
      ...
      R"(
            {
              ...
              "result":{
                ...
                "apis":[
                  ...
                  ["0xaf2c0297a23e6d3d",15],
                  ["0x49eaaf1b548a0cb0",6],
                  ["0x91d5df18b0d2cf58",3],
  ...
  url_loader_factory_.SetInterceptor(base::BindLambdaForTesting(
      [&, self = this](const network::ResourceRequest& req) {
        ...
        EXPECT_TRUE(pos != req_res_pairs.end());
  ...
  constexpr static std::string_view kExpectedExtrinsic =
      ...
      "00"    // Address type.
      // Sender pubkey.
      R"(d6b2a5cc606ea86342001dd036b301c15a5cba63c413cad5ca0e8f47e6fa9516)"
      "01"  // Signature type (0x01 => Sr25519)
      // Signature
      R"(36376696cfb3470732527fff9fe146da430ec75a3bb3236b8720e2e19df0c1709fcb3667049de2ff68185770bd9221a9b2e9a650d962d7015a6ee91e5de2d586)"
      "5501"    // Mortal era.
