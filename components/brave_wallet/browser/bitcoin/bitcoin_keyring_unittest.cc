...
TEST(BitcoinKeyringUnitTest, TestVectors) {
  ...
  EXPECT_EQ(keyring.GetAddress(0, BitcoinKeyId(0, 1)),
            "bc1qnjg0jd8228aq7egyzacy8cys3knf9xvrerkf9g");
  EXPECT_EQ(keyring.GetAddress(0, BitcoinKeyId(1, 0)),
...
TEST(BitcoinKeyringUnitTest, GetAddress) {
  ...
  EXPECT_EQ(keyring.GetAddress(1, BitcoinKeyId(0, 0)),
            "bc1qku0qh0mc00y8tk0n65x2tqw4trlspak0fnjmfz");
  EXPECT_EQ(keyring.GetAddress(1, BitcoinKeyId(0, 1)),
  ...
  EXPECT_EQ(testnet_keyring.GetAddress(0, BitcoinKeyId(0, 1)),
            "tb1qd7spv5q28348xl4myc8zmh983w5jx32cjhkn97");
  EXPECT_EQ(testnet_keyring.GetAddress(0, BitcoinKeyId(1, 0)),
            "tb1q9u62588spffmq4dzjxsr5l297znf3z6j5p2688");

  EXPECT_EQ(testnet_keyring.GetAddress(1, BitcoinKeyId(0, 0)),
            "tb1qp7shgcwx3mpzgxjvff0d77vuhchcldzfy60x6s");
  EXPECT_EQ(testnet_keyring.GetAddress(1, BitcoinKeyId(0, 1)),
            "tb1qynt29nsj8j972la4lu3efu42m5us2svmc8ekx8");
  EXPECT_EQ(testnet_keyring.GetAddress(1, BitcoinKeyId(1, 0)),
