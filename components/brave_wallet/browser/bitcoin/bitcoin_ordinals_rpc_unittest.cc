...
class BitcoinOrdinalsRpcUnitTest : public testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    bitcoin_rpc_ = std::make_unique<bitcoin_ordinals_rpc::BitcoinOrdinalsRpc>(
 ...
 protected:
  ...
  std::unique_ptr<bitcoin_ordinals_rpc::BitcoinOrdinalsRpc> bitcoin_rpc_;
...
TEST_F(BitcoinOrdinalsRpcUnitTest, Throttling) {
  ...
  for (auto& test_case : test_cases) {
    ...
    base::MockCallback<
        bitcoin_ordinals_rpc::BitcoinOrdinalsRpc::GetChainHeightCallback>
        callback;
...
TEST_F(BitcoinOrdinalsRpcUnitTest, GetChainHeight) {
  using GetChainHeightResult = base::expected<uint32_t, std::string>;
  base::MockCallback<
      bitcoin_ordinals_rpc::BitcoinOrdinalsRpc::GetChainHeightCallback>
      callback;
...
TEST_F(BitcoinOrdinalsRpcUnitTest, GetFeeEstimates) {
  using GetFeeEstimatesResult =
      base::expected<std::map<uint32_t, double>, std::string>;
  base::MockCallback<
      bitcoin_ordinals_rpc::BitcoinOrdinalsRpc::GetFeeEstimatesCallback>
      callback;
...
TEST_F(BitcoinOrdinalsRpcUnitTest, GetTransaction) {
  base::MockCallback<
      bitcoin_ordinals_rpc::BitcoinOrdinalsRpc::GetTransactionCallback>
      callback;
  ...
  EXPECT_CALL(callback, Run(Truly([&](auto& arg) {
                bitcoin_ordinals_rpc::Transaction tx;
                tx.txid = txid;
...
TEST_F(BitcoinOrdinalsRpcUnitTest, GetAddressStats) {
  base::MockCallback<
      bitcoin_ordinals_rpc::BitcoinOrdinalsRpc::GetAddressStatsCallback>
      callback;
  ...
  bitcoin_ordinals_rpc::AddressStats stats;
...
TEST_F(BitcoinOrdinalsRpcUnitTest, GetUtxoList) {
  base::MockCallback<
      bitcoin_ordinals_rpc::BitcoinOrdinalsRpc::GetUtxoListCallback>
      callback;
  ...
  bitcoin_ordinals_rpc::UnspentOutputs utxos;
  utxos.emplace_back();
  utxos.back().txid =
...
TEST_F(BitcoinOrdinalsRpcUnitTest, PostTransaction) {
  base::MockCallback<
      bitcoin_ordinals_rpc::BitcoinOrdinalsRpc::PostTransactionCallback>
      callback;
