  ...
  static base::NoDestructor<std::vector<mojom::BlockchainToken>> tokens(
      {{"", "Avalanche", "", false, false, false, "AVAX", 18, true, "", "",
       ...
       {"0x0D8775F648430679A709E98d2b0Cb6250d2887EF", "Basic Attention Token",
        "bat.png", true, false, false, "BAT", 18, true, "", "", mojom::kMainnetChainId,
        mojom::CoinType::ETH},
       ...
       {"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174", "USD Coin", "usdc.png",
        true, false, false, "USDC", 6, true, "", "", mojom::kPolygonMainnetChainId,
        mojom::CoinType::ETH},
       {"0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E", "USD Coin", "usdc.png",
        true, false, false, "USDC", 6, true, "", "", mojom::kAvalancheMainnetChainId,
        mojom::CoinType::ETH},
       ...
       {"0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e", "Yearn.Finance",
        "yfi.png", true, false, false, "YFI", 18, true, "", "", mojom::kMainnetChainId,
        mojom::CoinType::ETH},
       ...
       {"0x03ab458634910AaD20eF5f1C8ee96F1D6ac54919", "Rai Reflex Index",
        "rai.png", true, false, false, "RAI", 18, true, "", "", mojom::kMainnetChainId,
        mojom::CoinType::ETH}});
  return *tokens;
}
  ...
  static base::NoDestructor<std::vector<mojom::BlockchainToken>> tokens(
      {{"", "Ethereum", "", false, false, false, "ETH", 18, true, "", "",
       ...
       {"0xD8763CBa276a3738E6DE85b4b3bF5FDed6D6cA73", "Celo Euro", "ceur.png",
        true, false, false, "CEUR", 18, true, "", "", mojom::kCeloMainnetChainId,
        mojom::CoinType::ETH},
       {"0x765DE816845861e75A25fCA122bb6898B8B1282a", "Celo Dollar", "cusd.png",
        true, false, false, "CUSD", 18, true, "", "", mojom::kCeloMainnetChainId,
        mojom::CoinType::ETH},
       {"0x6b175474e89094c44da98b954eedeac495271d0f", "DAI Stablecoin",
        "dai.png", true, false, false, "DAI", 18, true, "", "", mojom::kMainnetChainId,
        mojom::CoinType::ETH},
       {"", "Ethereum", "", false, false, false, "ETH", 18, true, "", "",
       ...
       {"0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619", "Ethereum", "eth.png",
        true, false, false, "ETH", 18, true, "", "", mojom::kPolygonMainnetChainId,
        mojom::CoinType::ETH},
       {"0xbbba073c31bf03b8acf7c28ef0738decf3695683", "Sandbox", "sand.png",
        true, false, false, "SAND", 18, true, "", "", mojom::kPolygonMainnetChainId,
        mojom::CoinType::ETH},
       ...
       {"EPeUFDgHRxs9xxEPVaL6kfGQvCon7jmAWKVUHuux1Tpz", "Basic Attention Token",
        "bat.png", true, false, false, "BAT", 18, true, "", "", mojom::kSolanaMainnet,
        mojom::CoinType::SOL}});
  return *tokens;
}
  ...
  static base::NoDestructor<std::vector<mojom::BlockchainToken>> tokens(
      {{"", "Ethereum", "", false, false, false, "ETH", 18, true, "", "",
       ...
       {"0xbb0e17ef65f82ab018d8edd776e8dd940327b28b", "Axie Infinity",
        "axs.png", true, false, false, "AXS", 18, true, "", "", mojom::kMainnetChainId,
        mojom::CoinType::ETH}});
  return *tokens;
}
