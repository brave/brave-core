...
#ifndef BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_ZCASH_CREATE_TRANSPARENT_TO_IRONWOOD_TRANSACTION_TASK_H_
#define BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_ZCASH_CREATE_TRANSPARENT_TO_IRONWOOD_TRANSACTION_TASK_H_
...
// Creates a v6 transaction: spends transparent UTXOs, outputs to the
// Ironwood pool.
class ZCashCreateTransparentToIronwoodTransactionTask {
 public:
  ...
  virtual ~ZCashCreateTransparentToIronwoodTransactionTask();
 ...
 private:
  ...
  base::WeakPtrFactory<ZCashCreateTransparentToIronwoodTransactionTask>
      weak_ptr_factory_{this};
};

}  // namespace brave_wallet

#endif  // BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_ZCASH_CREATE_TRANSPARENT_TO_IRONWOOD_TRANSACTION_TASK_H_
