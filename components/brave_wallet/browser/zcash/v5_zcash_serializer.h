...
#ifndef BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_V5_ZCASH_SERIALIZER_H_
#define BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_V5_ZCASH_SERIALIZER_H_
...
// ZCash v5 transaction serialization (ZIP-225 / ZIP-244).
class ZCashV5Serializer {
 public:
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(ZCashV5SerializerTest, OrchardBundle);
...
#endif  // BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_V5_ZCASH_SERIALIZER_H_
