...
#ifndef BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_ZCASH_BLOCKS_BATCH_SCAN_TASK_
#define BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_ZCASH_BLOCKS_BATCH_SCAN_TASK_
...
class ZCashBlocksBatchScanTask {
 public:
  ...
  ZCashBlocksBatchScanTask(ZCashShieldSyncService* sync_service,
                           uint32_t from,
                           uint32_t to,
 ...
 private:
  ...
  void UpdateDatabase();
  void OnDatabaseUpdated(std::optional<ZCashOrchardStorage::Error> error);
...
#endif  // BRAVE_COMPONENTS_BRAVE_WALLET_BROWSER_ZCASH_ZCASH_BLOCK_BATCH_SCAN_TASK_
