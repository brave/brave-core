...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletApprovalForAllWarningTitle",
     IDS_BRAVE_WALLET_APPROVAL_FOR_ALL_WARNING_TITLE},
    {"braveWalletApprovalForAllWarningDescription",
     IDS_BRAVE_WALLET_APPROVAL_FOR_ALL_WARNING_DESCRIPTION},
    {"braveWalletWarning", IDS_BRAVE_WALLET_WARNING},
