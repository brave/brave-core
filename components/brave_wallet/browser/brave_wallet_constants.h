...
constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletRemoveNftModalHeader", IDS_BRAVE_WALLET_REMOVE_NFT_MODAL_HEADER},
    {"braveWalletRemoveNftModalDescription", IDS_BRAVE_WALLET_REMOVE_NFT_MODAL_DESCRIPTION},
    {"braveWalletRemoveNftModalCancel", IDS_BRAVE_WALLET_REMOVE_NFT_MODAL_CANCEL},
    {"braveWalletRemoveNftModalConfirm", IDS_BRAVE_WALLET_REMOVE_NFT_MODAL_CONFIRM},
