...
constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletBuyNotSupportedTooltip", IDS_BRAVE_WALLET_BUY_NOT_SUPPORTED_TOOLTIP},
    {"braveWalletSwapNotSupportedTooltip", IDS_BRAVE_WALLET_SWAP_NOT_SUPPORTED_TOOLTIP},
