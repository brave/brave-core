...
const char kBraveWalletP3ATotalSignMonthlyStorage[] =
    "brave.wallet.total_sign_monthly_storage";
const char kBraveWalletP3AEthSignMonthlyStorage[] =
    "brave.wallet.eth_sign_monthly_storage";
