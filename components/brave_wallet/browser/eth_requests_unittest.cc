...
TEST(EthRequestUnitTest, EthGetBalance) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetStorageAt) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetTransactionCount) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetBlockTransactionCountByHash) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetBlockTransactionCountByNumber) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetUncleCountByBlockHash) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetCode) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthSign) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthSignTransaction) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthSendTransaction) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthSendRawTransaction) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthCall) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthEstimateGas) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetBlockByHash) {
  ASSERT_EQ(
      eth_getBlockByHash(
...
TEST(EthRequestUnitTest, EthGetTransactionByBlockHashAndIndex) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetTransactionByBlockNumberAndIndex) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetTransactionReceipt) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetUncleByBlockHashAndIndex) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetUncleByBlockNumberAndIndex) {
  ASSERT_EQ(
...
TEST(EthRequestUnitTest, EthGetCompilers) {
  ASSERT_EQ(
      eth_getCompilers(),
      R"({"id":1,"jsonrpc":"2.0","method":"eth_getCompilers","params":[]})");  // NOLINT
}

TEST(EthRequestUnitTest, EthCompileSolidity) {
  ASSERT_EQ(
