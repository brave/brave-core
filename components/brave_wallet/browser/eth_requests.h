...
#ifndef BRAVE_COMPONENTS_BRAVE_WALLET_ETH_REQUESTS_H_
#define BRAVE_COMPONENTS_BRAVE_WALLET_ETH_REQUESTS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_WALLET_ETH_REQUESTS_H_
