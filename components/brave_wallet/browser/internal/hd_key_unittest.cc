...
TEST(HDKeyUnitTest, GenerateFromExtendedKey) {
  ...
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_pri->parent_fingerprint_),
            "31a507b8");
  ...
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_pri->GetIdentifier()),
  ...
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_pub->parent_fingerprint_),
            "31a507b8");
  ...
  EXPECT_EQ(
      ...
      "024d902e1a2fc7a8755ab5b694c575fce742c48d9ff192e63df5193e4c7afe1f9c");
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_pub->GetIdentifier()),
            "26132fdbe7bf89cbc64cf8dafa3f9f88b8666220");
  ...
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_zprv->parent_fingerprint_),
            "7ef32bdb");
  ...
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_zprv->GetIdentifier()),
  ...
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_vprv->parent_fingerprint_),
            "0ef4b1af");
  ...
  EXPECT_EQ(brave_wallet::HexEncodeLower(hdkey_from_vprv->GetIdentifier()),
...
TEST(HDKeyUnitTest, SignDer) {
  ...
  EXPECT_EQ(
      brave_wallet::HexEncodeLower(*signature),
