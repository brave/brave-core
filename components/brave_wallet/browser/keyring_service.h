...
class KeyringService : public KeyedService, public mojom::KeyringService {
 public:
  ...
  static void SetAccountMetaForKeyring(
      ...
      const std::string& id);
  static std::string GetDefaultKeyringIdForCoin(mojom::CoinType coin);
 ...
 private:
  ...
  absl::optional<std::string> FindImportedFilecoinKeyring(
      const std::string& address) const;
  absl::optional<std::string> FindBasicFilecoinKeyring(
      const std::string& address) const;
  absl::optional<std::string> FindHardwareFilecoinKeyring(
      const std::string& address) const;
  absl::optional<std::string> FindFilecoinKeyring(
      const std::string& address) const;

  std::string GetImportedKeyringId(mojom::CoinType coin_type,
                                   const std::string& address) const;
  std::string GetBasicKeyringId(mojom::CoinType coin_type,
                                const std::string& address) const;
