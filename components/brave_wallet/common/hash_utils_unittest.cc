...
TEST(HashUtilsUnitTest, DoubleSHA256Hash) {
  ...
  // EMPTY
  EXPECT_EQ(base::HexEncodeLower(DoubleSHA256Hash(std::vector<uint8_t>{})),
            "5df6e0e2761359d30a8275058e299fcc0381534545f55cf43e41983f5d4c9456");
}

TEST(HashUtilsUnitTest, Hash160) {
  EXPECT_EQ(
      base::HexEncodeLower(Hash160(std::vector<uint8_t>{0x61, 0x62, 0x63})),
      "bb1be98c142444d7a56aa3981c3942a978e4dc33");

  EXPECT_EQ(base::HexEncodeLower(Hash160(std::vector<uint8_t>{})),
