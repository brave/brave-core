...
TEST(CashAddrUnitTest, TestVectors_Addresses) {
  std::vector<std::tuple<std::string, AddressType, std::string, ChainType>>
      vectors = {{"ecash:qpj6zczese9zlk78exdywgag89duduvgavmld27rw2",
                  AddressType::PUBKEY,
                  "65a16059864a2fdbc7c99a4723a8395bc6f188eb", ChainType::MAIN},
                 {"ecash:pp60yz0ka2g8ut4y3a604czhs2hg5ejj2u37npfnk5",
                  AddressType::SCRIPT,
                  "74f209f6ea907e2ea48f74fae05782ae8a665257", ChainType::MAIN},
                 {"ectest:qpfuqvradpg65r88sfd63q7xhkddys45scc07d7pk5",
                  AddressType::PUBKEY,
                  "53c0307d6851aa0ce7825ba883c6bd9ad242b486", ChainType::TEST},
                 {"ectest:pp35nfqcl3zh35g2xu44fdzu9qxv33pc9u2q0rkcs9",
                  AddressType::SCRIPT,
                  "6349a418fc4578d10a372b54b45c280cc8c4382f", ChainType::TEST},
                 {"ecreg:qpfuqvradpg65r88sfd63q7xhkddys45scr94988sn",
                  AddressType::PUBKEY,
                  "53c0307d6851aa0ce7825ba883c6bd9ad242b486", ChainType::REG},
                 {"ecreg:pp35nfqcl3zh35g2xu44fdzu9qxv33pc9u32yt07kz",
                  AddressType::SCRIPT,
                  "6349a418fc4578d10a372b54b45c280cc8c4382f", ChainType::REG}};

  for (auto [cashAddr, address_type, hash_hex, chain_type] : vectors) {
