...
var solanaWeb3 = $(function (exports) {
  ...
  const validatorFns = $(function () {
    ...
    result.stringOrUint8Array = $(val => typeof val === "string" || isBytes$1(val));
  ...
  var ut = $Object.freeze($(function () {
    ...
    result.aInRange = aInRange;
    result.abool = abool;
    result.abytes = abytes$1;
  ...
  function pow(num, power, modulo) {
    ...
    if (modulo <= _0n$4) throw new Error("invalid modulus");
  ...
  function wNAF(c, bits) {
    return $(function () {
      ...
      result.hasPrecomputes = $(function (elm) {
        return getW(elm) !== 1;
      });
      result.unsafeLadder = $(function (elm, n, p = c.ZERO) {
        let d = elm;
        while (n > _0n$3) {
      ...
      result.wNAFUnsafe = $(function (W, precomputes, n, acc = c.ZERO) {
        const {
          windows: windows,
          windowSize: windowSize
        } = calcWOpts(W, bits);
      ...
      result.getPrecomputes = $(function (W, P, transform) {
      ...
      result.wNAFCached = $(function (P, n, transform) {
        const W = getW(P);
        return this.wNAF(W, this.getPrecomputes(W, P, transform), n);
      });
      result.wNAFCachedUnsafe = $(function (P, n, transform, prev) {
        const W = getW(P);
        if (W === 1) return this.unsafeLadder(P, n, prev);
        return this.wNAFUnsafe(W, this.getPrecomputes(W, P, transform), n, prev);
      });
      result.setWindowSize = $(function (P, W) {
        validateW(W, bits);
  ...
  var bs58 = getDefaultExportFromCjs(bs58Exports);
  function anumber(n) {
    if (!Number.isSafeInteger(n) || n < 0) throw new Error("positive integer expected, got " + n);
  }
  $(anumber);
  ...
  const SHA256_IV$1 = new Uint32Array($Array.of(1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225));
  ...
  function requireEncoding_lib() {
    ...
    $(TextDecoder);
    TextDecoder.prototype = $(function () {
      let result = $Object.create(null, undefined);
    ...
    $(TextEncoder);
    TextEncoder.prototype = $(function () {
      let result = $Object.create(null, undefined);
  ...
  function requireLib() {
    ...
    const encoding = __importStar(requireEncoding_lib());
  ...
  class PublicKey extends Struct$1 {
    ...
    static async createWithSeed(fromPublicKey, seed, programId) {
      const buffer = bufferExports.Buffer.concat($Array.of(fromPublicKey.toBuffer(), bufferExports.Buffer.from(seed), programId.toBuffer()));
    ...
    static createProgramAddressSync(seeds, programId) {
      ...
      seeds.forEach($(function (seed) {
        ...
        buffer = bufferExports.Buffer.concat($Array.of(buffer, toBuffer(seed)));
      }));
      buffer = bufferExports.Buffer.concat($Array.of(buffer, programId.toBuffer(), bufferExports.Buffer.from("ProgramDerivedAddress")));
      const publicKeyBytes = sha256$1(buffer);
    ...
    static findProgramAddressSync(seeds, programId) {
      ...
      while (nonce != 0) {
        try {
          const seedsWithNonce = seeds.concat(bufferExports.Buffer.from($Array.of(nonce)));
  ...
  class Account {
    ...
    get secretKey() {
      return bufferExports.Buffer.concat($Array.of(this._secretKey, this._publicKey), 64);
    }
  }
  const BPF_LOADER_DEPRECATED_PROGRAM_ID = new PublicKey("BPFLoader1111111111111111111111111111111111");
  var Layout = $Object.create(null, undefined);
  var hasRequiredLayout;
  function requireLayout() {
    if (hasRequiredLayout) return Layout;
    hasRequiredLayout = 1;
    $Object.defineProperty(Layout, "__esModule", $(function () {
      let result = $Object.create(null, undefined);
      result.value = true;
      return result;
    })());
  ...
  const publicKey = (property = "publicKey") => LayoutExports.blob(32, property);
  $(publicKey);
  const signature = (property = "signature") => LayoutExports.blob(64, property);
  $(signature);
  const rustString = (property = "string") => {
    const rsl = LayoutExports.struct($Array.of(LayoutExports.u32("length"), LayoutExports.u32("lengthPadding"), LayoutExports.blob(LayoutExports.offset(LayoutExports.u32(), -8), "chars")), property);
    ...
    rslShim.encode = $((str, b, offset) => {
      const data = $(function () {
        let result = $Object.create(null, undefined);
        result.chars = bufferExports.Buffer.from(str, "utf8");
        return result;
      })();
      return _encode(data, b, offset);
    });
    rslShim.alloc = $(str => LayoutExports.u32().span + LayoutExports.u32().span + bufferExports.Buffer.from(str, "utf8").length);
    return rslShim;
  };
  $(rustString);
  const authorized = (property = "authorized") => LayoutExports.struct($Array.of(publicKey("staker"), publicKey("withdrawer")), property);
  $(authorized);
  const lockup = (property = "lockup") => LayoutExports.struct($Array.of(LayoutExports.ns64("unixTimestamp"), LayoutExports.ns64("epoch"), publicKey("custodian")), property);
  $(lockup);
  const voteInit = (property = "voteInit") => LayoutExports.struct($Array.of(publicKey("nodePubkey"), publicKey("authorizedVoter"), publicKey("authorizedWithdrawer"), LayoutExports.u8("commission")), property);
  $(voteInit);
  const voteAuthorizeWithSeedArgs = (property = "voteAuthorizeWithSeedArgs") => LayoutExports.struct($Array.of(LayoutExports.u32("voteAuthorizationType"), publicKey("currentAuthorityDerivedKeyOwnerPubkey"), rustString("currentAuthorityDerivedKeySeed"), publicKey("newAuthorized")), property);
  ...
  class Message {
    ...
    get compiledInstructions() {
      return this.instructions.map($(ix => $(function () {
        ...
        result.data = bs58.decode(ix.data);
        return result;
      })()));
    }
    ...
    static compile(args) {
      ...
      const instructions = accountKeys.compileInstructions(args.instructions).map($(ix => $(function () {
        ...
        result.data = bs58.encode(ix.data);
        return result;
      })()));
    ...
    serialize() {
      ...
      const instructions = this.instructions.map($(instruction => {
        ...
        return $(function () {
          ...
          result.keyIndicesCount = bufferExports.Buffer.from(keyIndicesCount);
          result.keyIndices = accounts;
          result.dataLength = bufferExports.Buffer.from(dataCount);
          result.data = data;
          return result;
        })();
      }));
      ...
      instructions.forEach($(instruction => {
        const instructionLayout = LayoutExports.struct($Array.of(LayoutExports.u8("programIdIndex"), LayoutExports.blob(instruction.keyIndicesCount.length, "keyIndicesCount"), LayoutExports.seq(LayoutExports.u8("keyIndex"), instruction.keyIndices.length, "keyIndices"), LayoutExports.blob(instruction.dataLength.length, "dataLength"), LayoutExports.seq(LayoutExports.u8("userdatum"), instruction.data.length, "data")));
        const length = instructionLayout.encode(instruction, instructionBuffer, instructionBufferLength);
        instructionBufferLength += length;
      }));
      instructionBuffer = instructionBuffer.slice(0, instructionBufferLength);
      const signDataLayout = LayoutExports.struct($Array.of(LayoutExports.blob(1, "numRequiredSignatures"), LayoutExports.blob(1, "numReadonlySignedAccounts"), LayoutExports.blob(1, "numReadonlyUnsignedAccounts"), LayoutExports.blob(keyCount.length, "keyCount"), LayoutExports.seq(publicKey("key"), numKeys, "keys"), publicKey("recentBlockhash")));
      const transaction = $(function () {
        let result = $Object.create(null, undefined);
        result.numRequiredSignatures = bufferExports.Buffer.from($Array.of(this.header.numRequiredSignatures));
        result.numReadonlySignedAccounts = bufferExports.Buffer.from($Array.of(this.header.numReadonlySignedAccounts));
        result.numReadonlyUnsignedAccounts = bufferExports.Buffer.from($Array.of(this.header.numReadonlyUnsignedAccounts));
        result.keyCount = bufferExports.Buffer.from(keyCount);
        result.keys = this.accountKeys.map($(key => toBuffer(key.toBytes())));
        result.recentBlockhash = bs58.decode(this.recentBlockhash);
        return result;
      }).bind(this)();
    ...
    static from(buffer) {
      ...
      const messageArgs = $(function () {
        ...
        result.recentBlockhash = bs58.encode(bufferExports.Buffer.from(recentBlockhash));
  ...
  class MessageV0 {
    ...
    serializeAddressTableLookups() {
      ...
      for (const lookup of this.addressTableLookups) {
        ...
        const addressTableLookupLayout = LayoutExports.struct($Array.of(publicKey("accountKey"), LayoutExports.blob(encodedWritableIndexesLength.length, "encodedWritableIndexesLength"), LayoutExports.seq(LayoutExports.u8(), lookup.writableIndexes.length, "writableIndexes"), LayoutExports.blob(encodedReadonlyIndexesLength.length, "encodedReadonlyIndexesLength"), LayoutExports.seq(LayoutExports.u8(), lookup.readonlyIndexes.length, "readonlyIndexes")));
    ...
    static populate(message, signatures = $Array.of()) {
      ...
      signatures.forEach($((signature, index) => {
        const sigPubkeyPair = $(function () {
          let result = $Object.create(null, undefined);
          result.signature = signature == bs58.encode(DEFAULT_SIGNATURE) ? null : bs58.decode(signature);
      ...
      message.instructions.forEach($(instruction => {
        ...
        transaction.instructions.push(new TransactionInstruction($(function () {
          ...
          result.data = bs58.decode(instruction.data);
          return result;
        })()));
      }));
  ...
  class VersionedTransaction {
    ...
    serialize() {
      ...
      const transactionLayout = LayoutExports.struct($Array.of(LayoutExports.blob(encodedSignaturesLength.length, "encodedSignaturesLength"), LayoutExports.seq(signature(), this.signatures.length, "signatures"), LayoutExports.blob(serializedMessage.length, "serializedMessage")));
  ...
  class SendTransactionError extends Error {
    ...
    get transactionError() {
      return $(function () {
        let result = $Object.create(null, undefined);
        result.message = this.transactionMessage;
        result.logs = $Array.isArray(this.transactionLogs) ? this.transactionLogs : undefined;
        return result;
      }).bind(this)();
    }
    get logs() {
  ...
  async function sendAndConfirmTransaction(connection, transaction, signers, options) {
    ...
    if (status.err) {
      if (signature != null) {
        throw new SendTransactionError($(function () {
          let result = $Object.create(null, undefined);
          result.action = "send";
          result.signature = signature;
          result.transactionMessage = `Status: (${JSON.stringify(status)})`;
          return result;
        })());
      }
  ...
  const NonceAccountLayout = LayoutExports.struct($Array.of(LayoutExports.u32("version"), LayoutExports.u32("state"), publicKey("authorizedPubkey"), publicKey("nonce"), LayoutExports.struct($Array.of(FeeCalculatorLayout), "feeCalculator")));
  ...
  function encodeValue(value) {
    if ($Array.isArray(value)) {
      ...
      return encodeURIComponent(String(value != null && $Object.getPrototypeOf(value) === null ? $(function () {
        let result = $Object.create(null, undefined);
  ...
  $(encodeContextObject);
  function getErrorMessage(code, context = $Object.create(null, undefined)) {
    {
  ...
  function createDecoder(decoder) {
    return $Object.freeze($(function () {
      let result = $Object.create(null, undefined);
      $Object.assign(result, decoder);
      result.decode = $((bytes, offset = 0) => decoder.read(bytes, offset)[0]);
      return result;
    })());
  }
  $(createDecoder);
  ...
  function combineCodec(encoder, decoder) {
    ...
    if (isFixedSize(encoder) && isFixedSize(decoder) && encoder.fixedSize !== decoder.fixedSize) {
      throw new SolanaError(SOLANA_ERROR__CODECS__ENCODER_DECODER_FIXED_SIZE_MISMATCH, $(function () {
        let result = $Object.create(null, undefined);
        result.decoderFixedSize = decoder.fixedSize;
        result.encoderFixedSize = encoder.fixedSize;
        return result;
      })());
    }
    if (!isFixedSize(encoder) && !isFixedSize(decoder) && encoder.maxSize !== decoder.maxSize) {
      throw new SolanaError(SOLANA_ERROR__CODECS__ENCODER_DECODER_MAX_SIZE_MISMATCH, $(function () {
        let result = $Object.create(null, undefined);
        result.decoderMaxSize = decoder.maxSize;
        result.encoderMaxSize = encoder.maxSize;
        return result;
      })());
    }
    return $(function () {
      ...
      $Object.assign(result, decoder);
      $Object.assign(result, encoder);
      result.decode = decoder.decode;
      result.encode = encoder.encode;
      result.read = decoder.read;
      result.write = encoder.write;
      return result;
    })();
  }
  $(combineCodec);
  function assertByteArrayIsNotEmptyForCodec(codecDescription, bytes, offset = 0) {
    if (bytes.length - offset <= 0) {
      throw new SolanaError(SOLANA_ERROR__CODECS__CANNOT_DECODE_EMPTY_BYTE_ARRAY, $(function () {
        let result = $Object.create(null, undefined);
        result.codecDescription = codecDescription;
        return result;
      })());
    }
  }
  ...
  function assertByteArrayHasEnoughBytesForCodec(codecDescription, expected, bytes, offset = 0) {
    ...
    if (bytesLength < expected) {
      throw new SolanaError(SOLANA_ERROR__CODECS__INVALID_BYTE_LENGTH, $(function () {
        let result = $Object.create(null, undefined);
        result.bytesLength = bytesLength;
        result.codecDescription = codecDescription;
  ...
  function assertNumberIsBetweenForCodec(codecDescription, min, max, value) {
    if (value < min || value > max) {
      throw new SolanaError(SOLANA_ERROR__CODECS__NUMBER_OUT_OF_RANGE, $(function () {
        let result = $Object.create(null, undefined);
        result.codecDescription = codecDescription;
        result.max = max;
        result.min = min;
  ...
  function numberEncoderFactory(input) {
    return createEncoder($(function () {
      let result = $Object.create(null, undefined);
      result.fixedSize = input.size;
      result.write = $(function (value, bytes, offset) {
        if (input.range) {
  ...
  function numberDecoderFactory(input) {
    return createDecoder($(function () {
      let result = $Object.create(null, undefined);
      result.fixedSize = input.size;
      result.read = $(function (bytes, offset = 0) {
        assertByteArrayIsNotEmptyForCodec(input.name, bytes, offset);
        assertByteArrayHasEnoughBytesForCodec(input.name, input.size, bytes, offset);
        const view = new DataView(toArrayBuffer(bytes, offset, input.size));
        return $Array.of(input.get(view, isLittleEndian(input.config)), offset + input.size);
      });
      return result;
    })());
  }
  ...
  $(toArrayBuffer);
  var getU64Encoder = (config = $Object.create(null, undefined)) => numberEncoderFactory($(function () {
    let result = $Object.create(null, undefined);
    result.config = config;
    result.name = "u64";
    result.range = $Array.of(0n, BigInt("0xffffffffffffffff"));
    result.set = $((view, value, le) => view.setBigUint64(0, BigInt(value), le));
    result.size = 8;
    return result;
  })());
  $(getU64Encoder);
  var getU64Decoder = (config = $Object.create(null, undefined)) => numberDecoderFactory($(function () {
    let result = $Object.create(null, undefined);
    result.config = config;
    result.get = $((view, le) => view.getBigUint64(0, le));
    result.name = "u64";
    result.size = 8;
    return result;
  })());
  $(getU64Decoder);
  var getU64Codec = (config = $Object.create(null, undefined)) => combineCodec(getU64Encoder(config), getU64Decoder(config));
  $(getU64Codec);
  ...
  const SYSTEM_INSTRUCTION_LAYOUTS = $Object.freeze($(function () {
    ...
    result.Create = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 0;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), LayoutExports.ns64("lamports"), LayoutExports.ns64("space"), publicKey("programId")));
      return result;
    })();
    result.Assign = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 1;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("programId")));
      return result;
    })();
    result.Transfer = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 2;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), u64("lamports")));
      return result;
    })();
    result.CreateWithSeed = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 3;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("base"), rustString("seed"), LayoutExports.ns64("lamports"), LayoutExports.ns64("space"), publicKey("programId")));
      return result;
    })();
    result.AdvanceNonceAccount = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 4;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction")));
      return result;
    })();
    result.WithdrawNonceAccount = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 5;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), LayoutExports.ns64("lamports")));
      return result;
    })();
    result.InitializeNonceAccount = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 6;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("authorized")));
      return result;
    })();
    ...
    result.Allocate = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 8;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), LayoutExports.ns64("space")));
      return result;
    })();
    result.AllocateWithSeed = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 9;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("base"), rustString("seed"), LayoutExports.ns64("space"), publicKey("programId")));
      return result;
    })();
    result.AssignWithSeed = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 10;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("base"), rustString("seed"), publicKey("programId")));
      return result;
    })();
    result.TransferWithSeed = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 11;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), u64("lamports"), rustString("seed"), publicKey("programId")));
      return result;
    })();
  ...
  class Loader {
    ...
    static async load(connection, payer, program, programId, data) {
      ...
      const dataLayout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), LayoutExports.u32("offset"), LayoutExports.u32("bytesLength"), LayoutExports.u32("bytesLengthPadding"), LayoutExports.seq(LayoutExports.u8("byte"), LayoutExports.offset(LayoutExports.u32(), -8), "bytes")));
      ...
      {
        const dataLayout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction")));
  ...
  class StructError extends TypeError {
    constructor(failure, failures) {
      ...
      this.failures = $(() => cached ?? (cached = $Array.of(failure, ...failures())));
    }
  }
  ...
  function record(Key, Value) {
    return new Struct($(function () {
      ...
      result.coercer = $(function (value) {
        return isNonArrayObject(value) ? $(function () {
          let result = $Object.create(null, undefined);
          $Object.assign(result, value);
          return result;
        })() : value;
    ...
    return new Struct($(function () {
      ...
      result.entries = $(function* (value) {
        if ($Array.isArray(value)) {
          ...
          for (let i = 0; i < length; i++) {
            yield $Array.of(i, value[i], Structs[i] || Never);
          }
        }
      });
      result.validator = $(function (value) {
  ...
  function union(Structs) {
    ...
    return new Struct($(function () {
      ...
      result.type = "union";
      result.schema = null;
      result.coercer = $(function (value, ctx) {
        for (const S of Structs) {
          const [error, coerced] = S.validate(value, $(function () {
            let result = $Object.create(null, undefined);
            result.coerce = true;
            result.mask = ctx.mask;
            return result;
          })());
          if (!error) {
            return coerced;
  ...
  var RpcClient = getDefaultExportFromCjs(browserExports);
  ...
  var CommonClient = class extends EventEmitter {
    ...
    constructor(webSocketFactory, address = "ws://localhost:8080", {
      ...
      max_reconnects = 5,
      ...rest_options
    } = $Object.create(null, undefined), generate_request_id, dataPack) {
      super();
      this.webSocketFactory = webSocketFactory;
      this.queue = $Object.create(null, undefined);
      this.rpc_id = 0;
      ...
      if (this.autoconnect) this._connect(this.address, $(function () {
        let result = $Object.create(null, undefined);
        ...
        $Object.assign(result, this.rest_options);
        return result;
      }).bind(this)());
    }
    connect() {
      if (this.socket) return;
      this._connect(this.address, $(function () {
        let result = $Object.create(null, undefined);
        result.autoconnect = this.autoconnect;
        result.reconnect = this.reconnect;
        result.reconnect_interval = this.reconnect_interval;
    ...
    call(method, params, timeout, ws_opts) {
      ...
      return new Promise($((resolve, reject) => {
        ...
        const message = $(function () {
          ...
          result.jsonrpc = "2.0";
          result.method = method;
          result.params = params || void 0;
          result.id = rpc_id;
          return result;
        })();
        this.socket.send(this.dataPack.encode(message), ws_opts, $(error => {
          if (error) return reject(error);
          this.queue[rpc_id] = $(function () {
            let result = $Object.create(null, undefined);
    ...
    _connect(address, options) {
      ...
      this.socket.addEventListener("message", $(({
        ...
        if (message instanceof ArrayBuffer) message = bufferExports.Buffer.from(message).toString();
        try {
        ...
        if (message.notification && this.listeners(message.notification).length) {
          ...
          const args = $Array.of(message.notification);
  ...
  class RpcWebSocketClient extends CommonClient {
    constructor(address, options, generate_request_id) {
      const webSocketFactory = url => {
        const rpc = WebSocket(url, $(function () {
          let result = $Object.create(null, undefined);
  ...
  class AddressLookupTableAccount {
    ...
    static deserialize(accountData) {
      ...
      const {
        addresses: addresses
      } = LayoutExports.struct($Array.of(LayoutExports.seq(publicKey(), numSerializedAddresses, "addresses"))).decode(accountData.slice(LOOKUP_TABLE_META_SIZE));
      return $(function () {
        let result = $Object.create(null, undefined);
  ...
  const LookupTableMetaLayout = $(function () {
    let result = $Object.create(null, undefined);
    result.index = 1;
    result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("typeIndex"), u64("deactivationSlot"), LayoutExports.nu64("lastExtendedSlot"), LayoutExports.u8("lastExtendedStartIndex"), LayoutExports.u8(), LayoutExports.seq(publicKey(), LayoutExports.offset(LayoutExports.u8(), -1), "authority")));
    return result;
  })();
  const URL_RE = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i;
  ...
  function applyDefaultMemcmpEncodingToFilters(filters) {
    return filters.map($(filter => "memcmp" in filter ? $(function () {
      let result = $Object.create(null, undefined);
      $Object.assign(result, filter);
      result.memcmp = $(function () {
        let result = $Object.create(null, undefined);
        $Object.assign(result, filter.memcmp);
        result.encoding = filter.memcmp.encoding ?? "base58";
        return result;
      })();
      return result;
    })() : filter));
  }
  $(applyDefaultMemcmpEncodingToFilters);
  ...
  const ParsedInstructionStruct = type($(function () {
    let result = $Object.create(null, undefined);
  ...
  const PartiallyDecodedInstructionStruct = type($(function () {
    let result = $Object.create(null, undefined);
    result.programId = PublicKeyFromString;
  ...
  const SimulatedTransactionResponseStruct = jsonRpcResultAndContext(type($(function () {
    ...
    result.innerInstructions = optional(nullable(array(type($(function () {
      let result = $Object.create(null, undefined);
      result.index = number();
      result.instructions = array(union($Array.of(ParsedInstructionStruct, PartiallyDecodedInstructionStruct)));
      return result;
    })()))));
    return result;
  })()));
  ...
  const ParsedOrRawAccountData = coerce(union($Array.of(instance(bufferExports.Buffer), ParsedAccountDataResult)), union($Array.of(RawAccountDataResult, ParsedAccountDataResult)), $(value => {
    if ($Array.isArray(value)) {
  ...
  const TokenBalanceResult = type($(function () {
    ...
    result.programId = optional(string());
  ...
  const COMMON_HTTP_HEADERS = $(function () {
    let result = $Object.create(null, undefined);
    result["solana-client"] = `js/${"1.0.0-maintenance"}`;
    return result;
  })();
  class Connection {
    ...
    async getProgramAccounts(programId, configOrCommitment) {
      ...
      const args = this._buildArgs($Array.of(programId.toBase58()), commitment, encoding || "base64", $(function () {
        let result = $Object.create(null, undefined);
        $Object.assign(result, configWithoutEncoding);
        $Object.assign(result, configWithoutEncoding.filters ? $(function () {
          let result = $Object.create(null, undefined);
          result.filters = applyDefaultMemcmpEncodingToFilters(configWithoutEncoding.filters);
          return result;
        })() : null);
        return result;
      })());
    ...
    async getRecentBlockhashAndContext(commitment) {
      ...
      const feeCalculator = $(function () {
        let result = $Object.create(null, undefined);
        result.lamportsPerSignature = $(function () {
      ...
      return $(function () {
        ...
        result.value = $(function () {
          ...
          result.feeCalculator = feeCalculator;
          return result;
        })();
        return result;
      })();
    ...
    async simulateTransaction(transactionOrMessage, configOrSigners, includeAccounts) {
      ...
      if ("error" in res) {
        ...
        throw new SendTransactionError($(function () {
          ...
          result.signature = "";
          result.transactionMessage = res.error.message;
          result.logs = logs;
          return result;
        })());
      }
    ...
    async sendEncodedTransaction(encodedTransaction, options) {
      ...
      if ("error" in res) {
        ...
        throw new SendTransactionError($(function () {
          let result = $Object.create(null, undefined);
          result.action = skipPreflight ? "send" : "simulate";
          result.signature = "";
          result.transactionMessage = res.error.message;
          result.logs = logs;
          return result;
          ...
          case "unsubscribed":
            ...
            await $(async () => {
              ...
              try {
                ...
                console.error(`Received ${e instanceof Error ? "" : "JSON-RPC "}error calling \`${method}\``, $(function () {
                  let result = $Object.create(null, undefined);
                  result.args = args;
                  result.error = e;
                  return result;
    ...
    _makeSubscription(subscriptionConfig, args) {
      ...
      const hash = fastStableStringify($Array.of(subscriptionConfig.method, args));
    ...
    onAccountChange(publicKey, callback, commitmentOrConfig) {
      ...
      const args = this._buildArgs($Array.of(publicKey.toBase58()), commitment || this._commitment || "finalized", "base64", config);
    ...
    onProgramAccountChange(programId, callback, commitmentOrConfig, maybeFilters) {
      ...
      const args = this._buildArgs($Array.of(programId.toBase58()), commitment || this._commitment || "finalized", "base64", config ? config : maybeFilters ? $(function () {
        let result = $Object.create(null, undefined);
        result.filters = applyDefaultMemcmpEncodingToFilters(maybeFilters);
        return result;
      })() : undefined);
      return this._makeSubscription($(function () {
        let result = $Object.create(null, undefined);
  ...
  const LOOKUP_TABLE_INSTRUCTION_LAYOUTS = $Object.freeze($(function () {
    ...
    result.CreateLookupTable = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 0;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), u64("recentSlot"), LayoutExports.u8("bumpSeed")));
      return result;
    })();
    ...
    result.ExtendLookupTable = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 2;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), u64(), LayoutExports.seq(publicKey(), LayoutExports.offset(LayoutExports.u32(), -8), "addresses")));
      return result;
    })();
  ...
  class AddressLookupTableProgram {
    ...
    static createLookupTable(params) {
      const [lookupTableAddress, bumpSeed] = PublicKey.findProgramAddressSync($Array.of(params.authority.toBuffer(), getU64Encoder().encode(params.recentSlot)), this.programId);
  ...
  const COMPUTE_BUDGET_INSTRUCTION_LAYOUTS = $Object.freeze($(function () {
    ...
    result.RequestUnits = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 0;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u8("instruction"), LayoutExports.u32("units"), LayoutExports.u32("additionalFee")));
      return result;
    })();
    result.RequestHeapFrame = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 1;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u8("instruction"), LayoutExports.u32("bytes")));
      return result;
    })();
    result.SetComputeUnitLimit = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 2;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u8("instruction"), LayoutExports.u32("units")));
      return result;
    })();
    result.SetComputeUnitPrice = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 3;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u8("instruction"), u64("microLamports")));
      return result;
    })();
    return result;
  })());
  ...
  $(rotlBL);
  const SHA3_PI = $Array.of();
  const SHA3_ROTL = $Array.of();
  const _SHA3_IOTA = $Array.of();
  ...
  const DER = $(function () {
    ...
    result._tlv = $(function () {
      let result = $Object.create(null, undefined);
      result.encode = $((tag, data) => {
        const {
          Err: E
        } = DER;
      ...
      result.decode = $(function (tag, data) {
        const {
          Err: E
        } = DER;
        let pos = 0;
        ...
        return $(function () {
          let result = $Object.create(null, undefined);
          result.v = v;
          result.l = data.subarray(pos + length);
          return result;
        })();
      });
      return result;
    })();
    result._int = $(function () {
      let result = $Object.create(null, undefined);
      result.encode = $(function (num) {
        const {
          Err: E
        } = DER;
    ...
    result.toSig = $(function (hex) {
      ...
      return $(function () {
        let result = $Object.create(null, undefined);
        result.r = int.decode(rBytes);
        result.s = int.decode(sBytes);
        return result;
      })();
    });
  ...
  function weierstrassPoints(opts) {
    ...
    const toAffineMemo = memoized($((p, iz) => {
      ...
      if (Fp.eql(z, Fp.ONE)) return $(function () {
        let result = $Object.create(null, undefined);
        result.x = x;
        result.y = y;
        return result;
  ...
  $(sqrtMod);
  const Fpk1 = Field(secp256k1P, undefined, undefined, $(function () {
    let result = $Object.create(null, undefined);
    result.sqrt = sqrtMod;
    return result;
  })());
  ...
  const STAKE_INSTRUCTION_LAYOUTS = $Object.freeze($(function () {
    ...
    result.Initialize = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 0;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), authorized(), lockup()));
      return result;
    })();
    result.Authorize = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 1;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("newAuthorized"), LayoutExports.u32("stakeAuthorizationType")));
      return result;
    })();
    ...
    result.AuthorizeWithSeed = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 8;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("newAuthorized"), LayoutExports.u32("stakeAuthorizationType"), rustString("authoritySeed"), publicKey("authorityOwner")));
      return result;
    })();
    return result;
  })());
  ...
  const VOTE_INSTRUCTION_LAYOUTS = $Object.freeze($(function () {
    ...
    result.InitializeAccount = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 0;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), voteInit()));
      return result;
    })();
    result.Authorize = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 1;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), publicKey("newAuthorized"), LayoutExports.u32("voteAuthorizationType")));
      return result;
    })();
    result.Withdraw = $(function () {
      let result = $Object.create(null, undefined);
    ...
    result.AuthorizeWithSeed = $(function () {
      let result = $Object.create(null, undefined);
      result.index = 10;
      result.layout = LayoutExports.struct($Array.of(LayoutExports.u32("instruction"), voteAuthorizeWithSeedArgs()));
      return result;
    })();
    return result;
  })());
  ...
  const InfoString = type($(function () {
    ...
    result.iconUrl = optional(string());
  ...
  const VoteAccountLayout = LayoutExports.struct($Array.of(publicKey("nodePubkey"), publicKey("authorizedWithdrawer"), LayoutExports.u8("commission"), LayoutExports.nu64(), LayoutExports.seq(LayoutExports.struct($Array.of(LayoutExports.nu64("slot"), LayoutExports.u32("confirmationCount"))), LayoutExports.offset(LayoutExports.u32(), -8), "votes"), LayoutExports.u8("rootSlotValid"), LayoutExports.nu64("rootSlot"), LayoutExports.nu64(), LayoutExports.seq(LayoutExports.struct($Array.of(LayoutExports.nu64("epoch"), publicKey("authorizedVoter"))), LayoutExports.offset(LayoutExports.u32(), -8), "authorizedVoters"), LayoutExports.struct($Array.of(LayoutExports.seq(LayoutExports.struct($Array.of(publicKey("authorizedPubkey"), LayoutExports.nu64("epochOfLastAuthorizedSwitch"), LayoutExports.nu64("targetEpoch"))), 32, "buf"), LayoutExports.nu64("idx"), LayoutExports.u8("isEmpty")), "priorVoters"), LayoutExports.nu64(), LayoutExports.seq(LayoutExports.struct($Array.of(LayoutExports.nu64("epoch"), LayoutExports.nu64("credits"), LayoutExports.nu64("prevCredits"))), LayoutExports.offset(LayoutExports.u32(), -8), "epochCredits"), LayoutExports.struct($Array.of(LayoutExports.nu64("slot"), LayoutExports.nu64("timestamp")), "lastTimestamp")));
  class VoteAccount {
    constructor(args) {
      this.nodePubkey = void 0;
      this.authorizedWithdrawer = void 0;
  ...
  async function sendAndConfirmRawTransaction(connection, rawTransaction, confirmationStrategyOrConfirmOptions, maybeConfirmOptions) {
    ...
    if (status.err) {
      if (signature != null) {
        throw new SendTransactionError($(function () {
          let result = $Object.create(null, undefined);
          result.action = sendOptions?.skipPreflight ? "send" : "simulate";
          result.signature = signature;
          result.transactionMessage = `Status: (${JSON.stringify(status)})`;
          return result;
        })());
