...
#ifndef BRAVE_COMPONENTS_BRAVE_ACCOUNT_ENDPOINTS_VERIFY_RESEND_H_
...
using VerifyResend = endpoint_client::BraveEndpoint<
    "accounts.bsg",
    "/v2/verify/resend",
...
#endif  // BRAVE_COMPONENTS_BRAVE_ACCOUNT_ENDPOINTS_VERIFY_RESEND_H_
