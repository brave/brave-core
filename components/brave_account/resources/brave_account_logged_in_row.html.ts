...
// these rows are also served as a page on mobile. <localized-link> below is
// left unresolved on every platform - the elements render as inert, without
// their links. Needs a replacement that works everywhere.
