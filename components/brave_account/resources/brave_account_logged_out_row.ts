...
export class BraveAccountLoggedOutRowElement extends BraveAccountRowBaseElement<
  LoggedOutVerificationIntent,
  LoggedOutState
> {
  static get is() {
  ...
  protected override makeVerificationIntent(
    intent: LoggedOutVerificationIntent,
  ): VerificationIntent {
  ...
  protected override get verificationIntentDescription() {
    ...
    return loadTimeData.getString(
      this.state.verification.intent
        ...
        ? BraveAccountSettingsStrings.SETTINGS_BRAVE_ACCOUNT_RESET_PASSWORD_ROW_DESCRIPTION_1
        : BraveAccountSettingsStrings.SETTINGS_BRAVE_ACCOUNT_VERIFICATION_ROW_DESCRIPTION_1,
    )
  }
  ...
  protected getLoggedOutDescription() {
    const [beforeLink, linkLabel, afterLink] = loadTimeData
      .getString(
        BraveAccountSettingsStrings.SETTINGS_BRAVE_ACCOUNT_LOGGED_OUT_ROW_DESCRIPTION,
      )
      .split(/<a>|<\/a>/)
...
customElements.define(
  BraveAccountLoggedOutRowElement.is,
  BraveAccountLoggedOutRowElement,
)
