 ...
 private:
  ...
  void SetupWebUIDataSource(WebUIDataSource* source) {
    ...
    static constexpr webui::LocalizedString kStrings[] = {
        ...
        {"braveAccountErrorDialogDefaultMessage",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_DEFAULT_MESSAGE},
        {"braveAccountErrorDialogInitializeBadRequest",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_INITIALIZE_BAD_REQUEST},
        {"braveAccountErrorDialogInitializeUnauthorized",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_INITIALIZE_UNAUTHORIZED},
        {"braveAccountErrorDialogInitializeForbidden",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_INITIALIZE_FORBIDDEN},
        {"braveAccountErrorDialogInitializeInternalServerError",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_INITIALIZE_INTERNAL_SERVER_ERROR},
        {"braveAccountErrorDialogInitializeUnknown",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_INITIALIZE_UNKNOWN},
        {"braveAccountErrorDialogInitializeUnexpected",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_INITIALIZE_UNEXPECTED},
        {"braveAccountErrorDialogFinalizeBadRequest",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_FINALIZE_BAD_REQUEST},
        {"braveAccountErrorDialogFinalizeUnauthorized",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_FINALIZE_UNAUTHORIZED},
        {"braveAccountErrorDialogFinalizeForbidden",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_FINALIZE_FORBIDDEN},
        {"braveAccountErrorDialogFinalizeNotFound",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_FINALIZE_NOT_FOUND},
        {"braveAccountErrorDialogFinalizeInternalServerError",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_FINALIZE_INTERNAL_SERVER_ERROR},
        {"braveAccountErrorDialogFinalizeUnknown",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_FINALIZE_UNKNOWN},
        {"braveAccountErrorDialogFinalizeUnexpected",
         IDS_BRAVE_ACCOUNT_ERROR_DIALOG_FINALIZE_UNEXPECTED},
        // Common:
