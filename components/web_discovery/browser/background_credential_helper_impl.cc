...
BackgroundCredentialHelperImpl::BackgroundCredentialHelperImpl()
    : anonymous_credentials_manager_(new_anonymous_credentials_manager()) {}

BackgroundCredentialHelperImpl::~BackgroundCredentialHelperImpl() = default;

void BackgroundCredentialHelperImpl::UseFixedSeedForTesting() {
...
BackgroundCredentialHelperImpl::GenerateJoinRequest(std::string pre_challenge) {
...
std::optional<std::string> BackgroundCredentialHelperImpl::FinishJoin(
    std::string date,
...
std::optional<std::vector<uint8_t>> BackgroundCredentialHelperImpl::PerformSign(
