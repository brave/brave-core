...
#ifndef BRAVE_COMPONENTS_CONTRIBUTE_BROWSER_CONTRIBUTE_JSON_PARSER_H_
#define BRAVE_COMPONENTS_CONTRIBUTE_BROWSER_CONTRIBUTE_JSON_PARSER_H_

#include <map>
#include <string>
#include <vector>

class ContributeJSONParser {
 public:
...
#endif  // BRAVE_COMPONENTS_CONTRIBUTE_BROWSER_CONTRIBUTE_JSON_PARSER_H_
