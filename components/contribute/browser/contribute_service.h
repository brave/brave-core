...
#ifndef BRAVE_COMPONENTS_CONTRIBUTE_BROWSER_CONTRIBUTE_SERVICE_H_
#define BRAVE_COMPONENTS_CONTRIBUTE_BROWSER_CONTRIBUTE_SERVICE_H_
...
class ContributeService : public KeyedService {
 public:
  explicit ContributeService(content::BrowserContext* context);
  ~ContributeService() override;
 ...
 private:
  ...
  base::WeakPtrFactory<ContributeService> weak_factory_;

  FRIEND_TEST_ALL_PREFIXES(ContributeAPIBrowserTest, GetOAuthClientURL);
  friend class ContributeAPIBrowserTest;

  DISALLOW_COPY_AND_ASSIGN(ContributeService);
};

#endif  // BRAVE_COMPONENTS_CONTRIBUTE_BROWSER_CONTRIBUTE_SERVICE_H_
