...
// npm run test -- brave_unit_tests --filter=ContributeJSONParserTest.*
...
typedef testing::Test ContributeJSONParserTest;

TEST_F(ContributeJSONParserTest, GetAccountBalancesFromJSON) {
  std::map<std::string, std::string> balances;
  ASSERT_TRUE(ContributeJSONParser::GetAccountBalancesFromJSON(R"(
      {
        "code": "000000",
        "message": null,
        "data": [
...
TEST_F(ContributeJSONParserTest, GetTokensFromJSON) {
...
TEST_F(ContributeJSONParserTest, GetTickerPriceFromJSON) {
  std::string symbol_pair_price;
  ASSERT_TRUE(ContributeJSONParser::GetTickerPriceFromJSON(R"(
      {
        "symbol": "BTCUSDT",
        "price": "7137.98000000"
      })",
...
TEST_F(ContributeJSONParserTest, GetTickerVolumeFromJSON) {
...
TEST_F(ContributeJSONParserTest, GetDepositInfoFromJSON) {
  std::string deposit_address;
  std::string deposit_url;
  ASSERT_TRUE(ContributeJSONParser::GetDepositInfoFromJSON(R"(
      {
        "code": "0000",
        "message": "null",
        "data": {
...
TEST_F(ContributeJSONParserTest, GetQuoteInfoFromJSON) {
  std::string quote_id;
