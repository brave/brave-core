...
#ifndef BRAVE_COMPONENTS_ON_DEVICE_AI_CORE_LOCAL_MODELS_UPDATER_H_
#define BRAVE_COMPONENTS_ON_DEVICE_AI_CORE_LOCAL_MODELS_UPDATER_H_
...
#endif  // BRAVE_COMPONENTS_ON_DEVICE_AI_CORE_LOCAL_MODELS_UPDATER_H_
