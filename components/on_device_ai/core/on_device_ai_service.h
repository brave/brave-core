...
#ifndef BRAVE_COMPONENTS_ON_DEVICE_AI_CORE_ON_DEVICE_AI_SERVICE_H_
#define BRAVE_COMPONENTS_ON_DEVICE_AI_CORE_ON_DEVICE_AI_SERVICE_H_
...
// OnDeviceAIService manages the lifecycle of background model workers.
//
...
// calls itself.
class OnDeviceAIService : public KeyedService,
                          public mojom::OnDeviceAIService,
 ...
 public:
  ...
  explicit OnDeviceAIService(BackgroundWebContentsFactory factory);
  ~OnDeviceAIService() override;

  OnDeviceAIService(const OnDeviceAIService&) = delete;
  OnDeviceAIService& operator=(const OnDeviceAIService&) = delete;

  mojo::PendingRemote<mojom::OnDeviceAIService> MakeRemote();
  void Bind(mojo::PendingReceiver<mojom::OnDeviceAIService> receiver);

  // mojom::OnDeviceAIService:
 ...
 private:
  ...
  mojo::ReceiverSet<mojom::OnDeviceAIService> receivers_;
  mojo::Remote<mojom::PassageEmbedderFactory> factory_;
  std::vector<GetPassageEmbedderCallback> pending_embedder_callbacks_;

  base::WeakPtrFactory<OnDeviceAIService> weak_ptr_factory_{this};
};

}  // namespace on_device_ai

#endif  // BRAVE_COMPONENTS_ON_DEVICE_AI_CORE_ON_DEVICE_AI_SERVICE_H_
