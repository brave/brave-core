...
#include "brave/components/on_device_ai/core/local_models_updater.h"
...
class LocalModelsUpdaterUnitTest : public testing::Test {
 public:
  LocalModelsUpdaterUnitTest()
    ...
    feature_list_.InitWithFeatures({features::kOnDeviceAIModels}, {});
  }
...
TEST_F(LocalModelsUpdaterUnitTest, DeleteComponent) {
  ...
  feature_list.InitAndDisableFeature(features::kOnDeviceAIModels);
