...
#ifndef BRAVE_COMPONENTS_BRAVE_CRYPTO_BRAVE_PROCHLO_CRYPTO_H_
#define BRAVE_COMPONENTS_BRAVE_CRYPTO_BRAVE_PROCHLO_CRYPTO_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_CRYPTO_BRAVE_PROCHLO_CRYPTO_H_
