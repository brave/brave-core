...
ReduceLanguageComponentInstallerPolicy::
    ~ReduceLanguageComponentInstallerPolicy() = default;
...
void ReduceLanguageComponentInstallerPolicy::LoadDirectlyFromResourcePath() {
  ...
  base::ThreadPool::PostTaskAndReplyWithResult(
      ...
      base::BindOnce(&brave_component_updater::GetDATFileAsString,
                     dat_file_path),
      base::BindOnce(
          &ReduceLanguageComponentInstallerPolicy::OnDATFileDataReady,
...
void ReduceLanguageComponentInstallerPolicy::RemoveObserver(
    Observer* observer) {
