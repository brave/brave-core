...
#ifndef BRAVE_COMPONENTS_BRAVE_TASK_RUNNER_FEDERATED_CLIENT_H_
#define BRAVE_COMPONENTS_BRAVE_TASK_RUNNER_FEDERATED_CLIENT_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_TASK_RUNNER_FEDERATED_CLIENT_H_
