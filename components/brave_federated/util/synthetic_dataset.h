...
#ifndef BRAVE_COMPONENTS_BRAVE_FEDERATED_UTIL_SYNTHETIC_DATASET_SYNTHETIC_DATASET_H_
#define BRAVE_COMPONENTS_BRAVE_FEDERATED_UTIL_SYNTHETIC_DATASET_SYNTHETIC_DATASET_H_
...
SyntheticDataset CreateDefaultSyntheticDataset() {
  ...
  SyntheticDataset synthetic_dataset = SyntheticDataset(W, b, 32, 5500);
  return synthetic_dataset;
}

}  // namespace brave_federated

#endif  // BRAVE_COMPONENTS_BRAVE_FEDERATED_UTIL_SYNTHETIC_DATASET_SYNTHETIC_DATASET_H_
