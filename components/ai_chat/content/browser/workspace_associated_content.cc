...
WorkspaceAssociatedContent::WorkspaceAssociatedContent(
  ...
  // Serve the folder at <this url>/files/ for as long as this workspace lives.
...
void WorkspaceAssociatedContent::DeliverDirectoryHandle(
  ...
  //
  // The grant covers the whole origin, which also serves the workspace's files.
  // See workspace_content_source.h.
