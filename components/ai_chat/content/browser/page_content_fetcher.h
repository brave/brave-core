...
class PageContentFetcher
 ...
 public:
  ...
  // Returns true if the URL has custom extraction logic (e.g. YouTube
  // transcripts, Twitter screenshots) that should be used instead of the
  // default GetAIPageContent approach.
