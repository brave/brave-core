...
base::span<const webui::LocalizedString> GetLocalizedStrings() {
  static constexpr auto kLocalizedStrings = std::to_array<
      ...
      {{"siteTitle", IDS_CHAT_UI_TITLE},
       ...
       {"introMessage-chat-gemma", IDS_CHAT_UI_INTRO_MESSAGE_CHAT_GEMMA},
       ...
       {"retrySameModelButtonLabel", IDS_CHAT_UI_RETRY_SAME_MODEL_BUTTON_LABEL},
       {"currentLabel", IDS_CHAT_UI_CURRENT_LABEL},
       {"regenerateAnswerMenuTitle", IDS_CHAT_UI_REGENERATE_ANSWER_MENU_TITLE},
       {"regenerateAnswerMenuTooltip",
        IDS_CHAT_UI_REGENERATE_ANSWER_MENU_TOOLTIP},
