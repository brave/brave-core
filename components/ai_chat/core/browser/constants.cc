...
base::span<const webui::LocalizedString> GetLocalizedStrings() {
  constexpr webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"introMessage-chat-basic-local-medium", IDS_CHAT_UI_INTRO_MESSAGE_CHAT_BASIC},
      {"introMessage-chat-basic-local-low", IDS_CHAT_UI_INTRO_MESSAGE_CHAT_BASIC},
      {"introMessage-chat-basic-local-tiny", IDS_CHAT_UI_INTRO_MESSAGE_CHAT_BASIC},
      ...
      {"braveLeoModelSubtitle-chat-basic-local-medium", IDS_CHAT_UI_CHAT_BASIC_LOCAL_MEDIUM_SUBTITLE},
      {"braveLeoModelSubtitle-chat-basic-local-low", IDS_CHAT_UI_CHAT_BASIC_LOCAL_LOW_SUBTITLE},
      {"braveLeoModelSubtitle-chat-basic-local-tiny", IDS_CHAT_UI_CHAT_BASIC_LOCAL_TINY_SUBTITLE},
