...
TEST_F(ConversationHandlerUnitTest, SubmitSelectedText) {
  ...
  EXPECT_CALL(*engine, GenerateAssistantResponse(
      ...
      .WillOnce(::testing::DoAll(
          base::test::RunOnceCallback<8>(EngineConsumer::GenerationResultData(
              mojom::ConversationEntryEvent::NewCompletionEvent(
                  mojom::CompletionEvent::New(expected_response)),
              std::nullopt /* model_key */)),
          base::test::RunOnceCallback<9>(
  ...
  expected_history.push_back(mojom::ConversationTurn::New(
      ...
      std::nullopt /* model_key */, nullptr /* near_verification_status */, false /* enable_research */));
  ...
  expected_history.push_back(mojom::ConversationTurn::New(
      ...
      nullptr /* near_verification_status */, false /* enable_research */));
...
TEST_F(ConversationHandlerUnitTest, SubmitSelectedText_WithNEARVerification) {
  ...
  expected_history.push_back(mojom::ConversationTurn::New(
      ...
      std::nullopt, std::move(response_events), base::Time::Now(), std::nullopt,
      std::nullopt, nullptr /* skill */, false, std::nullopt /* model_key */,
      mojom::NEARVerificationStatus::New(true), false /* enable_research */));
...
TEST_F(ConversationHandlerUnitTest, MAYBE_ModifyConversation) {
  ...
  EXPECT_CALL(*engine, GenerateAssistantResponse(_, _, _, _, _, _, _, _, _, _))
      .Times(0);
  conversation_handler_->ModifyConversation(
...
TEST_F(ConversationHandlerUnitTest, UploadFile) {
  ...
  conversation_handler_->SubmitHumanConversationEntry(kTestPrompt, std::nullopt,
                                                      false /* enable_research */);
  loop.Run();
  EXPECT_FALSE(
  ...
  conversation_handler_->SubmitHumanConversationEntry(kTestPrompt, Clone(uploaded_files),
                                                      false /* enable_research */);
  loop3.Run();
  testing::Mock::VerifyAndClearExpectations(&client);
...
TEST_F(ConversationHandlerUnitTest_NoAssociatedContent, SelectedLanguage) {
  ...
  conversation_handler_->SubmitHumanConversationEntry(expected_input1, std::nullopt,
                                                      false /* enable_research */);
  ...
  EXPECT_CALL(*engine, GenerateAssistantResponse(
                           ...
                           StrEq(expected_selected_language), _, _, _, _, _, _, _))
      .WillOnce(::testing::DoAll(
          base::test::RunOnceCallback<8>(EngineConsumer::GenerationResultData(
              mojom::ConversationEntryEvent::NewCompletionEvent(
  ...
  conversation_handler_->SubmitHumanConversationEntry(expected_input2, std::nullopt,
                                                      false /* enable_research */);
  loop2.Run();
...
TEST_F(ConversationHandlerUnitTest_NoAssociatedContent, ContentReceipt) {
  ...
  conversation_handler_->SubmitHumanConversationEntry(expected_input, std::nullopt,
                                                      false /* enable_research */);
...
TEST_F(ConversationHandlerUnitTest,
  ...
  conversation_handler_->SubmitHumanConversationEntry("Test question", std::nullopt,
                                                      false /* enable_research */);
  run_loop.Run();
...
TEST_F(ConversationHandlerUnitTest, ToolUseEvents_MultipleToolsCalled) {
  ...
  conversation_handler_->SubmitHumanConversationEntry("What's the weather?", std::nullopt,
                                                      false /* enable_research */);
...
TEST_F(ConversationHandlerUnitTest,
  ...
  conversation_handler_->SubmitHumanConversationEntry("First question", std::nullopt,
                                                      false /* enable_research */);
  ...
  conversation_handler_->SubmitHumanConversationEntry("New question", std::nullopt,
                                                      false /* enable_research */);
...
TEST_F(ConversationHandlerUnitTest, ToolUseEvents_MultipleToolIterations) {
  ...
  // Submit human entry to start the flow
  conversation_handler_->SubmitHumanConversationEntry("Use multiple tools", std::nullopt,
                                                      false /* enable_research */);
...
TEST_F(ConversationHandlerUnitTest, ToolUseEvents_ToolNotFound) {
  ...
  EXPECT_CALL(*engine, GenerateAssistantResponse)
      ...
      .WillOnce(testing::DoAll(
          ...
          testing::WithArg<9>([](EngineConsumer::GenerationCompletedCallback
                                     completion_callback) {
  ...
  conversation_handler_->SubmitHumanConversationEntry("Help me with something", std::nullopt,
                                                      false /* enable_research */);
  run_loop.Run();
}
...
TEST_P(ConversationHandlerUnitTest_AutoScreenshot,
  ...
  MockEngineConsumer* engine = static_cast<MockEngineConsumer*>(
      conversation_handler_->GetEngineForTesting());
  EXPECT_CALL(*engine, GenerateAssistantResponse)
      .WillOnce(base::test::RunOnceCallback<9>(
          base::ok(EngineConsumer::GenerationResultData(
              mojom::ConversationEntryEvent::NewCompletionEvent(
...
TEST_F(ConversationHandlerUnitTest, ScreenshotsAppendToExistingFiles) {
  ...
  conversation_handler_->SubmitHumanConversationEntry("Test question", Clone(existing_images),
                                                      false /* enable_research */);
  loop.Run();
