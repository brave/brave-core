...
TEST_F(ConversationHandlerUnitTest_NoAssociatedContent, SelectedLanguage) {
  ...
  EXPECT_CALL(*engine, GenerateAssistantResponse(
                           ...
                           StrEq(expected_selected_language), _, _, _, _, _))
      .WillOnce(::testing::DoAll(
          base::test::RunOnceCallback<6>(EngineConsumer::GenerationResultData(
              mojom::ConversationEntryEvent::NewCompletionEvent(
...
TEST_F(ConversationHandlerUnitTest,
  ...
  EXPECT_CALL(*interactive_tool_ptr,
              UseTool("{\"param\":\"value1\"}", testing::_,
                      testing::Optional(
                          testing::Property(&base::Value::is_dict, true))))
      .WillOnce(testing::DoAll(
          testing::WithArg<1>([&](Tool::UseToolCallback callback) {
