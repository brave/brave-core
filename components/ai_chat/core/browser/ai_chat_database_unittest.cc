...
TEST_P(AIChatDatabaseTest, ToolUseEvent) {
  ...
  auto history = CreateSampleChatHistory(2u);
  {
    auto tool_event_first = mojom::ToolUseEvent::New(
        "test_tool", "tool_id_123", R"({
      "param1": "value1",
      "param2": 42,
      "param3": true
    })",
        base::Value::Dict(), std::vector<mojom::ContentBlockPtr>());
    ...
    tool_event_first->arguments->Set("param1", "value1");
    tool_event_first->arguments->Set("param2", 42);
    tool_event_first->arguments->Set("param3", true);

    auto tool_event_second = mojom::ToolUseEvent::New(
        "test_tool_2", "tool_id_456", R"({
      "param1": "value2",
      "param2": 43,
      "param3": false
    })",
    ...
    tool_event_second->arguments->Set("param1", "value2");
    tool_event_second->arguments->Set("param2", 43);
    tool_event_second->arguments->Set("param3", false);

    auto tool_event_third = mojom::ToolUseEvent::New(
        "test_tool_3", "tool_id_789", R"({
      "param1": "value3",
      "param2": 44,
      "param3": true
    })",
    ...
    tool_event_third->arguments->Set("param1", "value3");
    tool_event_third->arguments->Set("param2", 44);
    tool_event_third->arguments->Set("param3", true);
...
TEST_P(AIChatDatabaseTest, ToolUseEvent_Invalid) {
  ...
  auto history = CreateSampleChatHistory(1u);
  {
    ...
    tool_event_third->arguments->Set("param1", "value2");
    tool_event_third->arguments->Set("param2", 43);
    tool_event_third->arguments->Set("param3", false);
...
TEST_P(AIChatDatabaseTest, MixedEvents) {
  ...
  tool_event_second->arguments->Set("param2", 43);
  tool_event_second->arguments->Set("param3", false);
  base::Value::Dict nested_arguments;
  nested_arguments.Set("param1", "value2");
  nested_arguments.Set("param2", 43);
  tool_event_second->arguments->Set("nested", std::move(nested_arguments));
