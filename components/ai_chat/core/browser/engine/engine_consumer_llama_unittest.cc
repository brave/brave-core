...
TEST_F(EngineConsumerLlamaUnitTest, TestGenerateAssistantResponse) {
  ...
  std::string prompt_after_time_and_date =
      ...
      "of code or data.\n<</SYS>>\n\nThis is the text of a web page within "
      "<page> tags:\n\n<page> This is a page. </page>\n\nWhich show is this "
      "catchphrase from?\nSelected text: This is the way. [/INST] The "
      "Mandalorian.</s><s>[INST] This is an excerpt of the page content in "
      "<excerpt> tags:\n\n<excerpt> I'm groot. </excerpt>\n\nWhat's his name? "
      "[/INST]";
  ...
  prompt_after_time_and_date =
      ...
      "of code or data.\n<</SYS>>\n\nThis is the text of a web page within "
      "<page> tags:\n\n<page> This is a page. </page>\n\nThis is an excerpt "
      "of the page content in <excerpt> tags:\n\n<excerpt> I'm groot. "
  ...
  EXPECT_CALL(*mock_remote_completion_client, QueryPrompt(_, _, _, _))
      .WillOnce([](const std::string& prompt,
        ...
        std::string prompt_segment_with_truncated_selected_text =
            "This is an excerpt of the page content in <excerpt> "
            "tags:\n\n<excerpt> 12345 </excerpt>\n\n";
