...
class OAIAPIClient {
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(OAIAPIUnitTest,
                           SerializeOAIMessages_RewriteSuggestions_Improve);
  FRIEND_TEST_ALL_PREFIXES(OAIAPIUnitTest,
                           SerializeOAIMessages_RewriteSuggestions_Paraphrase);
  FRIEND_TEST_ALL_PREFIXES(OAIAPIUnitTest,
                           SerializeOAIMessages_RewriteSuggestions_Shorten);
  FRIEND_TEST_ALL_PREFIXES(OAIAPIUnitTest,
                           SerializeOAIMessages_RewriteSuggestions_Expand);
  FRIEND_TEST_ALL_PREFIXES(OAIAPIUnitTest,
                           SerializeOAIMessages_RewriteSuggestions_ChangeTone);
  FRIEND_TEST_ALL_PREFIXES(OAIAPIUnitTest, SerializeOAIMessages);
  FRIEND_TEST_ALL_PREFIXES(ContentBlockSerializationTest,
                           SerializesAsOAIMessage);
