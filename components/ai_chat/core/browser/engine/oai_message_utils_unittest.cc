...
// Creates a WebSourcesContentBlock with 1 source. If |page_content_size| has
// a value, the source includes page_content and extra_snippets; otherwise
// those fields are nullopt (stripped).
