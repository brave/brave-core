...
provideStrings({
  ...
  pageContentTooLongWarning: 'The page is too long for Leo. Some context could be missing from the conversation. Upgrade to premium for longer inputs.',
  pageContentTooLongWarningPremium: 'The page is too long for Leo. Some context could be missing from the conversation. Leo was able to read $1 of the page\'s contents.',
