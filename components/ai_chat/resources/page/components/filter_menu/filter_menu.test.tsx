...
describe('filter_menu', () => {
  ...
  it('should be hidden when isOpen is false', () => {
    const { container } = render(<FilterMenu {...defaultProps} isOpen={false}>
      {(item) => <leo-menu-item>{item}</leo-menu-item>}
    </FilterMenu>)
    expect(container.querySelector('leo-buttonmenu')).toHaveProperty('isOpen', false)
  })

  it('should be shown when isOpen is true', () => {
    const { container } = render(<FilterMenu {...defaultProps} isOpen={true}>
      {(item) => <leo-menu-item>{item}</leo-menu-item>}
    </FilterMenu>)
    expect(container.querySelector('leo-buttonmenu')).toHaveProperty('isOpen', true)
  })

  it('should open when a query is set', async () => {
    render(<FilterMenu {...defaultProps} isOpen={false} query={'hello'}>
      {(item) => <leo-menu-item>{item}</leo-menu-item>}
    </FilterMenu>)
  ...
  it('should open for empty queries', async () => {
    render(<FilterMenu {...defaultProps} isOpen={false} query=''>
      {(item) => <leo-menu-item>{item}</leo-menu-item>}
    </FilterMenu>)
  ...
  it('should close when query goes null', async () => {
    render(<FilterMenu {...defaultProps} isOpen={true} query={null}>
      {(item) => <leo-menu-item>{item}</leo-menu-item>}
    </FilterMenu>)
  ...
  it('should render children', async () => {
    const { queryByText } = render(<FilterMenu {...defaultProps} isOpen={true} query={null}>
      {(item) => <leo-menu-item>{item}</leo-menu-item>}
    </FilterMenu>)
  ...
  it('should filter children', async () => {
    const { queryByText } = render(<FilterMenu {...defaultProps} isOpen={true} query={'hell'}>
      {(item) => <leo-menu-item>{item}</leo-menu-item>}
    </FilterMenu>)
  ...
  it('should click first menu-item when enter is pressed and nothing is focused', async () => {
    const click = jest.fn()
    render(<FilterMenu {...defaultProps} isOpen={true} query={''}>
      {(item) => <leo-menu-item tabindex={0} onClick={() => click(item)}>{item}</leo-menu-item>}
    </FilterMenu>)
  ...
  it('should click focused menu-item when enter is pressed', async () => {
    const click = jest.fn()
    const { getByText } = render(<FilterMenu {...defaultProps} isOpen={true} query={''}>
      {(item) => <leo-menu-item tabindex={0} onClick={() => click(item)}>{item}</leo-menu-item>}
    </FilterMenu>)
  ...
  it('should filter out categories with no matches', async () => {
    const click = jest.fn()
    const { queryByText } = render(<FilterMenu {...defaultProps} categories={[
