...
const getTitle = (activeConversation?: Conversation) =>
  activeConversation?.title || getLocale('conversationListUntitled')
...
export const ConversationHeader = React.forwardRef(function (
  ...
  const activeConversation = aiChatContext.visibleConversations.find(
      ...
      <div className={styles.actions}>
        {aiChatContext.hasAcceptedAgreement && (
          <>
            ...
            {supportsAttachments && aiChatContext.tabs.length > 0 && (
              <Button
                fab
                kind={
                  conversationContext.showAttachments ? 'plain' : 'plain-faint'
                }
                aria-label={getLocale('attachmentsTitle')}
                title={getLocale('attachmentsTitle')}
                onClick={() =>
                  conversationContext.setShowAttachments(
