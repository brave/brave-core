...
export default function FeatureMenu() {
  ...
  // TODO(petemill): Whilst this may be accurate, if the default (i.e. Unset) value
  // changes to True, this will be wrong.
  ...
  return (
    <ButtonMenu>
      ...
      <div className={styles.menuSectionTitle}>{getLocale('menuTitleModels')}</div>
      <div className={styles.menuSubtitle}>{getLocale('modelCategory-chat')}</div>
      ...
      <leo-menu-item onClick={handleAutoGenerateQuestionsClick} data-is-interactive={true}>
        <div className={styles.menuItemWithIcon}>
