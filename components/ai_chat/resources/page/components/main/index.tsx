...
function Main() {
  ...
  const showAttachments = conversationContext.attachmentsDialog === 'tabs'
  ...
  return (
    ...
    >
      ...
      {showAttachments && <Dialog isOpen onClose={() => conversationContext.setAttachmentsDialog(null)} className={styles.attachmentsDialog}>
        <Attachments />
      </Dialog>}
