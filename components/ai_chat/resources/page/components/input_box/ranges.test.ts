...
describe('ranges utilities', () => {
  describe('createNode', () => {
    ...
    it('preserves special characters in associated content', () => {
      const contentNode = createAssociatedContentNode(
        'special-chars',
        'special @#$%^&*()',
      )
  ...
  describe('getRangeToTriggerChar', () => {
    ...
    it('finds trigger character in previous text node', () => {
      const { textNodes } = setupEditableWithMultipleTextNodes([
        'Hello @',
        'world',
      ])
  ...
  describe('replaceRange', () => {
    ...
    it('replaces range with associated content node', () => {
      ...
      const associatedContent = createAssociatedContentNode(
        'mention-1',
        'Alice',
      )
    ...
    it('works in conjunction with getRangeToTriggerChar for mention replacement', () => {
      const { editable, textNode } = setupEditableWithText(
        'Hello @ali and more text',
      )
