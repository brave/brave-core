...
import { fallback, provideNodeGlobals } from '../../../webpack/polyfill'
 ...
 */
const prefixReplacer = (prefix: string, replacements: string[] | string) => {
...
export default async function (env: any, argv: any): Promise<webpack.Configuration> {
  ...
  const entry = {
    'ai_chat_shared_conversation': path.join(__dirname, 'shared_conversation_page.tsx'),
  }
  ...
  return {
    ...
    plugins: [
      ...
      provideNodeGlobals,
      ...(Object.keys(pathMap) as Array<keyof typeof pathMap>)
