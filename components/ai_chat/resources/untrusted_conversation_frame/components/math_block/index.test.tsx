...
describe('math_block hardening', () => {
  ...
  it('does not hang on an expansion bomb', () => {
    // maxExpand bounds macro expansion; without it this would not terminate.
    const bomb =
      '\\def\\a{\\b\\b}\\def\\b{\\c\\c}\\def\\c{\\d\\d}\\def\\d{x}\\a'
    expect(() => render(<Math.Inline tex={bomb} />)).not.toThrow()
  })
})
