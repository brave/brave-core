...
describe('ToolEventTabManagement', () => {
  test('should render permission request state', () => {
          ...
          toolUseEvent={
            {
              ...
              id: 'test-id',
              argumentsJson: '{"url": "https://example.com", "title": "Example Site"}',
              output: undefined,
    ...
    expect(screen.getByTestId('tool-tabmanagement-permission-icon')).toBeInTheDocument()

    // Should show allow and deny buttons
    expect(screen.getByText('AI_CHAT_TOOL_TAB_MANAGEMENT_PERMISSION_ALLOW_BUTTON')).toBeInTheDocument()
    expect(screen.getByText('AI_CHAT_TOOL_TAB_MANAGEMENT_PERMISSION_DENY_BUTTON')).toBeInTheDocument()
  })
  ...
  test('should render active state', () => {
    ...
    expect(screen.getByText('AI_CHAT_TOOL_TAB_MANAGEMENT_ACTIVE_STATE_DESCRIPTION')).toBeInTheDocument()

    // Should show progress icon
    expect(screen.getByTestId('tool-default-progress-icon')).toBeInTheDocument()
    expect(screen.queryByTestId('tool-tabmanagement-permission-icon')).not.toBeInTheDocument()
  })
  ...
  test('should render completed state', () => {
    ...
    expect(screen.getByText('AI_CHAT_TOOL_TAB_MANAGEMENT_COMPLETED_STATE_DESCRIPTION')).toBeInTheDocument()
          ...
          toolUseEvent={
            {
              ...
              id: 'test-id',
              argumentsJson: '{"url": "https://example.com", "title": "Example Site"}',
              output: [createTextContentBlock('Tab operation completed successfully')],
              requiresUserInteraction: false
            }
          }
          isEntryActive={false}
