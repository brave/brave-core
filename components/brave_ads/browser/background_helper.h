...
#ifndef BRAVE_COMPONENTS_BROWSER_BRAVE_ADS_BACKGROUND_HELPER_H_
#define BRAVE_COMPONENTS_BROWSER_BRAVE_ADS_BACKGROUND_HELPER_H_
...
#endif  // BRAVE_COMPONENTS_BROWSER_BRAVE_ADS_BACKGROUND_HELPER_H_
