...
TEST_F(BraveAdsAdsServiceImplTest,
       ServiceKeepsRunningWhenOptingOutOfNewTabPageBackgroundImages) {
  // Arrange
  prefs_.SetBoolean(prefs::kSponsoredEnabled, false);
  Startup();
  prefs_.SetBoolean(
...
TEST_F(BraveAdsAdsServiceImplTest, ClearDataPreservesDisabledSponsored) {
  // Arrange
  prefs_.SetBoolean(prefs::kSponsoredEnabled, false);
  Startup();
...
TEST_F(BraveAdsAdsServiceImplTest, ClearDataPreservesEnabledSponsored) {
  // Arrange
  prefs_.SetBoolean(prefs::kSponsoredEnabled, true);
  Startup();
...
TEST_F(BraveAdsAdsServiceImplTest, ClearDataDoesNotSetUnsetSponsored) {
  // Arrange
  Startup();
