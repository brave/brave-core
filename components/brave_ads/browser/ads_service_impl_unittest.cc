...
class MockRewardsService : public RewardsService {
 public:
  ...
  MOCK_CONST_METHOD2(SolveGrantCaptcha,
  ...
  MOCK_METHOD3(OnTip, void(const std::string&, int, bool));
  MOCK_METHOD4(OnTip,
               void(const std::string&,
                    int,
                    bool,
  ...
  MOCK_METHOD2(SetInlineTipSetting, void(const std::string& key, bool enabled));
