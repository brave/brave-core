...
class MockRewardsService : public RewardsService {
 public:
  ...
  MOCK_METHOD1(GetAutoContribute,
      void(const brave_rewards::GetAutoContributeCallback&));
  ...
  MOCK_METHOD1(GetPublisherBanner, void(const std::string&));
  ...
  MOCK_METHOD1(RemoveRecurring, void(const std::string&));
  ...
  MOCK_METHOD1(GetAddressesForPaymentId,
      void(const brave_rewards::GetAddressesCallback&));
  MOCK_METHOD1(GetConfirmationsHistory,
      void(brave_rewards::ConfirmationsHistoryCallback));
