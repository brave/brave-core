...
const int kMinAndroidVersionForNotificationChannels = 8;
...
void NotificationHelperAndroid::ShowMyFirstAdNotification() const {
...
bool NotificationHelperAndroid::IsBraveAdsChannelEnabled() const {
  if (GetOsVersion() < kMinAndroidVersionForNotificationChannels) {
    return true;
  }
