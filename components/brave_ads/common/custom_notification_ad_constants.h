...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_COMMON_CUSTOM_NOTIFICATION_AD_CONSTANTS_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_COMMON_CUSTOM_NOTIFICATION_AD_CONSTANTS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_COMMON_CUSTOM_NOTIFICATION_AD_CONSTANTS_H_
