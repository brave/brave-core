...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_COMMON_FUNCTIONAL_ONCE_CLOSURE_TASK_QUEUE_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_COMMON_FUNCTIONAL_ONCE_CLOSURE_TASK_QUEUE_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_COMMON_FUNCTIONAL_ONCE_CLOSURE_TASK_QUEUE_H_
