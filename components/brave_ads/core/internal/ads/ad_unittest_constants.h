...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ADS_AD_UNITTEST_CONSTANTS_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ADS_AD_UNITTEST_CONSTANTS_H_

namespace brave_ads {

constexpr char kPlacementId[] = "8b742869-6e4a-490c-ac31-31b49130098a";
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ADS_AD_UNITTEST_CONSTANTS_H_
