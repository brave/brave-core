...
TEST(BraveAdsSeenAdvertisersUtilTest,
     DoNotGetLastSeenAdvertiserTimeForEmptyAdEvents) {
  // Arrange
...
TEST(BraveAdsSeenAdvertisersUtilTest,
     DoNotGetLastSeenAdvertiserTimeForUnseenAdvertiser) {
  // Arrange
...
TEST(BraveAdsSeenAdvertisersUtilTest, GetLastSeenAdvertiserTime) {
  // Arrange
