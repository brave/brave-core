...
TEST(BraveAdsFeaturesTest, GetDefaultAdsPerHour) {
  // Arrange
...
TEST(BraveAdsFeaturesTest, DefaultDefaultAdsPerHour) {
  // Arrange
...
TEST(BraveAdsFeaturesTest, DefaultDefaultAdsPerHourWhenDisabled) {
  // Arrange
  const std::vector<base::test::FeatureRefAndParams> enabled_features;
