...
#include "brave/components/brave_ads/core/internal/ad_serving/eligible_ads/pipelines/new_tab_page_ads/eligible_new_tab_page_ads_v2.h"
...
#include "brave/components/brave_ads/core/internal/ad_serving/prediction/model_based/creative_ad_model_based_predictor.h"
...
void EligibleNewTabPageAdsV2::GetEligibleAdsCallback(
  ...
  const std::optional<CreativeNewTabPageAdInfo> creative_ad =
