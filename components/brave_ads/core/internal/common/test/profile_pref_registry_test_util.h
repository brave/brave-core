...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_COMMON_TEST_PROFILE_PREF_REGISTRY_TEST_UTIL_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_COMMON_TEST_PROFILE_PREF_REGISTRY_TEST_UTIL_H_
