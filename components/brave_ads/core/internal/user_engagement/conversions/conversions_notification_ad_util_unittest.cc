...
class BraveAdsConversionsNotificationAdUtilTest : public UnitTestBase {};

TEST_F(BraveAdsConversionsNotificationAdUtilTest, CanConvertViewedAdEvent) {
  // Arrange
  const AdInfo ad =
...
TEST_F(BraveAdsConversionsNotificationAdUtilTest,
       CannotConvertViewedAdEventIfOptedOutOfNotificationAds) {
  // Arrange
...
TEST_F(BraveAdsConversionsNotificationAdUtilTest, CanConvertAdClickedEvent) {
  // Arrange
  const AdInfo ad = test::BuildAd(AdType::kNotificationAd,
                                  /*should_generate_random_uuids=*/false);
...
TEST_F(BraveAdsConversionsNotificationAdUtilTest,
       CannotConvertAdClickedEventIfOptedOutOfNotificationAds) {
  // Arrange
  test::OptOutOfNotificationAds();
