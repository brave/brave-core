...
BraveAdsConversionsUnitTestBase::BraveAdsConversionsUnitTestBase() = default;

BraveAdsConversionsUnitTestBase::~BraveAdsConversionsUnitTestBase() = default;

void BraveAdsConversionsUnitTestBase::SetUp() {
  UnitTestBase::SetUp();
...
void BraveAdsConversionsUnitTestBase::TearDown() {
  conversions_->RemoveObserver(&conversions_observer_mock_);

  UnitTestBase::TearDown();
}

void BraveAdsConversionsUnitTestBase::RecordAdEventsAdvancingTheClockAfterEach(
    const AdInfo& ad,
...
void BraveAdsConversionsUnitTestBase::VerifyOnDidConvertAdExpectation(
    const AdInfo& ad,
...
void BraveAdsConversionsUnitTestBase::VerifyOnDidNotConvertAdExpectation() {
  EXPECT_CALL(conversions_observer_mock_, OnDidConvertAd).Times(0);
}

void BraveAdsConversionsUnitTestBase::VerifyOnDidConvertVerifiableAdExpectation(
    const AdInfo& ad,
    const ConversionActionType action_type,
