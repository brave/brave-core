...
class BraveAdsInlineContentAdConversionsTest : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(BraveAdsInlineContentAdConversionsTest,
...
TEST_F(BraveAdsInlineContentAdConversionsTest,
       DoNotConvertViewedAdIfOptedOutOfInlineContentAds) {
  // Arrange
