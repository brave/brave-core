...
bool IsAllowedToFireAdEvent(mojom::NewTabPageAdEventType mojom_ad_event_type) {
  ...
  // Only fire viewed impression and clicked events for non-Rewards users.
  return mojom_ad_event_type ==
             mojom::NewTabPageAdEventType::kViewedImpression ||
         mojom_ad_event_type != mojom::NewTabPageAdEventType::kClicked;
}
