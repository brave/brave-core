...
class BraveAdsSearchResultAdEventHandlerIfUserHasNotJoinedBraveRewardsTest
    : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(BraveAdsSearchResultAdEventHandlerIfUserHasNotJoinedBraveRewardsTest,
       DoNotFireEventIfShouldNotAlwaysTriggerSearchResultAdEvents) {
  // Arrange
