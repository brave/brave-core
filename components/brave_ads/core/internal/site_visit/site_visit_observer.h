...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_SITE_VISIT_SITE_VISIT_OBSERVER_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_SITE_VISIT_SITE_VISIT_OBSERVER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_SITE_VISIT_SITE_VISIT_OBSERVER_H_
