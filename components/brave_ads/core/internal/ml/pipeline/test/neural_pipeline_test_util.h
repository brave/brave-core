...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ML_PIPELINE_TEST_NEURAL_PIPELINE_TEST_UTIL_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ML_PIPELINE_TEST_NEURAL_PIPELINE_TEST_UTIL_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ML_PIPELINE_TEST_NEURAL_PIPELINE_TEST_UTIL_H_
