...
TEST_F(
    BraveAdsAdsSummaryUtilTest,
    GetAdsSummaryForDateRangeWhenUserHasJoinedBraveRewardsAndNotConnectedWallet) {
  // Arrange
...
TEST_F(
    BraveAdsAdsSummaryUtilTest,
    GetAdsSummaryForDateRangeWhenUserHasJoinedBraveRewardsAndConnectedWallet) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
