...
TEST_F(BraveAdsConfirmationUserDataBuilderTest, Build) {
  // Arrange
...
TEST_F(BraveAdsConfirmationUserDataBuilderTest, BuildForDefaultConversion) {
  // Arrange
  MockBuildChannel(BuildChannelType::kRelease);
  MockPlatformHelper(platform_helper_mock_, PlatformType::kWindows);
...
TEST_F(BraveAdsConfirmationUserDataBuilderTest, BuildForVerifiableConversion) {
  // Arrange
  MockBuildChannel(BuildChannelType::kRelease);
  MockPlatformHelper(platform_helper_mock_, PlatformType::kWindows);
