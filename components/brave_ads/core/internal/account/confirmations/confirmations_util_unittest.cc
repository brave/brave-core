...
TEST_F(BraveAdsConfirmationsUtilTest, Invalid) {
  // Arrange
...
TEST_F(BraveAdsConfirmationsUtilTest, ResetRewardConfirmations) {
  // Arrange
...
TEST_F(BraveAdsConfirmationsUtilTest, ResetEmptyTokens) {
  // Arrange
