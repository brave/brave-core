...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ACCOUNT_TOKENS_REDEEM_PAYMENT_TOKENS_REDEEM_PAYMENT_TOKENS_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ACCOUNT_TOKENS_REDEEM_PAYMENT_TOKENS_REDEEM_PAYMENT_TOKENS_H_
...
class RedeemPaymentTokens final {
 ...
 private:
  ...
  void RedeemCallback(const privacy::PaymentTokenList& payment_tokens,
                      const mojom::UrlResponseInfo& url_response);

  void SuccessfullyRedeemed(const privacy::PaymentTokenList& payment_tokens);
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_ACCOUNT_TOKENS_REDEEM_PAYMENT_TOKENS_REDEEM_PAYMENT_TOKENS_H_
