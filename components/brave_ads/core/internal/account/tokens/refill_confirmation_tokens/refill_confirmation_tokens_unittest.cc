...
#include "brave/components/brave_ads/core/internal/account/tokens/refill_confirmation_tokens/refill_confirmation_tokens_delegate_mock.h"
#include "brave/components/brave_ads/core/internal/account/tokens/refill_confirmation_tokens/refill_confirmation_tokens_unittest_util.h"
#include "brave/components/brave_ads/core/internal/account/tokens/refill_confirmation_tokens/url_requests/get_signed_tokens/get_signed_tokens_url_request_builder_unittest_constants.h"
#include "brave/components/brave_ads/core/internal/account/tokens/refill_confirmation_tokens/url_requests/get_signed_tokens/get_signed_tokens_url_request_builder_util.h"
#include "brave/components/brave_ads/core/internal/account/tokens/refill_confirmation_tokens/url_requests/request_signed_tokens/request_signed_tokens_url_request_builder_util.h"
 ...
 protected:
  void SetUp() override {
    ...
    refill_confirmation_tokens_ =
        std::make_unique<RefillConfirmationTokens>(&token_generator_mock_);
    refill_confirmation_tokens_->SetDelegate(
...
TEST_F(BraveAdsRefillConfirmationTokensTest, RefillConfirmationTokens) {
  ...
  const URLResponseMap url_responses = {
      {BuildRequestSignedTokensUrlPath(kWalletPaymentId),
       {{net::HTTP_CREATED, BuildRequestSignedTokensUrlResponseBody()}}},
      {BuildGetSignedTokensUrlPath(kWalletPaymentId, kGetSignedTokensNonce),
       {{net::HTTP_OK, BuildGetSignedTokensUrlResponseBody()}}}};
  ...
  // Assert
  EXPECT_EQ(50, privacy::ConfirmationTokenCount());
}
...
TEST_F(BraveAdsRefillConfirmationTokensTest,
  ...
  // Assert
  EXPECT_EQ(0, privacy::ConfirmationTokenCount());
}
...
TEST_F(BraveAdsRefillConfirmationTokensTest, RefillIfBelowTheMinimumThreshold) {
  ...
  privacy::SetConfirmationTokens(/*count*/ 19);
