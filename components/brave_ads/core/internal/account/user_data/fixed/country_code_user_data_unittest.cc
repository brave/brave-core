...
class BraveAdsCountryCodeUserDataTest : public test::TestBase {};

TEST_F(BraveAdsCountryCodeUserDataTest, BuildCountryCodeUserData) {
  // Act & Assert
...
TEST_F(BraveAdsCountryCodeUserDataTest,
