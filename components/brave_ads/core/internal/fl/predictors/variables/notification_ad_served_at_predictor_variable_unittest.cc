...
class BatAdsNotificationAdServedAtPredictorVariableTest : public UnitTestBase {
};
...
TEST_F(BatAdsNotificationAdServedAtPredictorVariableTest, GetValue) {
  // Arrange
...
TEST_F(BatAdsNotificationAdServedAtPredictorVariableTest, GetValueWithoutTime) {
  // Arrange
  std::unique_ptr<PredictorVariableInterface> predictor_variable =
