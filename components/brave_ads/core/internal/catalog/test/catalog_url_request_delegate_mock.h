...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_CATALOG_TEST_CATALOG_URL_REQUEST_DELEGATE_MOCK_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_CATALOG_TEST_CATALOG_URL_REQUEST_DELEGATE_MOCK_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_CATALOG_TEST_CATALOG_URL_REQUEST_DELEGATE_MOCK_H_
