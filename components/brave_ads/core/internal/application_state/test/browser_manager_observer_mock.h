...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_APPLICATION_STATE_TEST_BROWSER_MANAGER_OBSERVER_MOCK_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_APPLICATION_STATE_TEST_BROWSER_MANAGER_OBSERVER_MOCK_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_APPLICATION_STATE_TEST_BROWSER_MANAGER_OBSERVER_MOCK_H_
