...
TEST_F(BraveAdsHistoryManagerTest, AddNotificationAdHistory) {
  ...
  EXPECT_CALL(history_manager_observer_mock_,
              OnDidAddHistory(expected_history_item));
...
TEST_F(BraveAdsHistoryManagerTest, LikeAd) {
  ...
  EXPECT_CALL(history_manager_observer_mock_, OnDidLikeAd(expected_ad_content));
...
TEST_F(BraveAdsHistoryManagerTest, DislikeAd) {
  ...
  EXPECT_CALL(history_manager_observer_mock_,
              OnDidDislikeAd(expected_ad_content));
...
TEST_F(BraveAdsHistoryManagerTest, LikeCategory) {
  ...
  // Act & Assert
  EXPECT_CALL(history_manager_observer_mock_,
              OnDidLikeCategory(category_content.category));
...
TEST_F(BraveAdsHistoryManagerTest, DislikeCategory) {
  ...
  // Act & Assert
  EXPECT_CALL(history_manager_observer_mock_,
              OnDidDislikeCategory(category_content.category));
...
TEST_F(BraveAdsHistoryManagerTest, SaveAd) {
  ...
  EXPECT_CALL(history_manager_observer_mock_, OnDidSaveAd(expected_ad_content));
...
TEST_F(BraveAdsHistoryManagerTest, UnsaveAd) {
  ...
  // Act & Assert
  EXPECT_CALL(history_manager_observer_mock_,
              OnDidUnsaveAd(history_item.ad_content));
...
TEST_F(BraveAdsHistoryManagerTest, MarkAdAsInappropriate) {
  ...
  EXPECT_CALL(history_manager_observer_mock_,
              OnDidMarkAdAsInappropriate(expected_ad_content));
