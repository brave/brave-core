...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_NETWORK_OBLIVIOUS_HTTP_CONSTANTS_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_NETWORK_OBLIVIOUS_HTTP_CONSTANTS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_NETWORK_OBLIVIOUS_HTTP_CONSTANTS_H_
