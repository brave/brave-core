...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_NETWORK_NETWORK_CLIENT_UTIL_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_NETWORK_NETWORK_CLIENT_UTIL_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_NETWORK_NETWORK_CLIENT_UTIL_H_
