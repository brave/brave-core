...
describe('cosmeticFilterReducer', () => {
  ...
  beforeEach(
      () => {removeSiteFilterSpy =
                 jest.spyOn(cosmeticFilterAPI, 'removeSiteFilter')})
  afterEach(() => {removeSiteFilterSpy.mockRestore()})
  ...
  beforeEach(
      () => {removeSiteFilterSpy =
                 jest.spyOn(cosmeticFilterAPI, 'removeAllFilters')})
  afterEach(() => {removeSiteFilterSpy.mockRestore()})
  ...
  beforeEach(
      () => {removeSiteFilterSpy =
                 jest.spyOn(cosmeticFilterAPI, 'addSiteCosmeticFilter')})
  afterEach(() => {removeSiteFilterSpy.mockRestore()})
