...
import {setBadgeText} from '../../../../../brave_rewards/resources/extension/brave_rewards/background/browserAction'
...
let spyColor: jest.SpyInstance
  ...
  notifications: {'1': {id: 'test'}}
    ...
    expect(spyText).toHaveBeenCalled()
    expect(spyText.mock.calls[0][0]).toEqual({text: '1', tabId: 1})
