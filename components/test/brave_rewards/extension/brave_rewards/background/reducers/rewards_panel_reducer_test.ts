...
beforeAll(() => {
  ...
  ...defaultState, walletCreated: true, enabledMain: true
        }
        const payload = {
  tab: {url: 'https://clifton.io', incognito: false, active: true, windowId: 1}
        }

        // first visit
        const expectedState1: Rewards.State = {
  ...defaultState, walletCreated: true, enabledMain: true,
      publishers: {id_1: {tabUrl: 'https://clifton.io'}}
        }
  ...
  {
    ...defaultState, walletCreated: true, enabledMain: true, publishers: {
      id_1: {
        tabUrl: 'https://clifton.io',
        name: 'Clifton',
        publisher_key: 'clifton.io'
  ...
  state = reducers(state, {type: types.ON_TAB_RETRIEVED, payload})
  ...
  ...defaultState, walletCreated: true, enabledMain: true,
      ...
      {
        ...defaultState, walletCreated: true, enabledMain: true,
            publishers: {id_1: {tabUrl: 'https://brave.com'}}
      }
      ...
      it('rewards are disabled', () => {
        const initState: Rewards.State = {
  ...defaultState, walletCreated: true, enabledMain: false
        }
      ...
      it('publisher is empty', () => {
        const initState: Rewards.State = {
  ...defaultState, walletCreated: true, enabledMain: true,
      publishers: {id_1: {tabUrl: 'clifton.io', random: 'I need to vanish'}}
        }
  ...
  ...defaultState, walletCreated: true, enabledMain: true,
      ...
      it('switching between two tabs that has the same url', () => {
        const initState: Rewards.State = {
  ...defaultState, walletCreated: true, enabledMain: true, publishers: {
    id_1: {tabUrl: 'https://clifton.io', publisher_key: 'clifton.io', tabId: 1}
  }
        }

        const expectedState: Rewards.State = {
  ...defaultState, walletCreated: true, enabledMain: true, publishers: {
    id_1: {tabUrl: 'https://clifton.io', publisher_key: 'clifton.io', tabId: 2}
  }
        }
  ...
  ...defaultState, notifications: {}
    ...
    it('list is ok', () => {
      ...
      const expectedState: Rewards.State = {
  ...defaultState, currentNotification: 'notification_2', notifications: {
    'notification_1':
        {id: 'notification_1', type: 1, timestamp: 0, args: ['working']},
    'notification_2': {id: 'notification_2', type: 1, timestamp: 1, args: []}
  }
      }
