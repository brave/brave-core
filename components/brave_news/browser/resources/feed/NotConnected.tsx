...
export default function NotConnected() {
  ...
  return <Container align='center' direction='column' justify='center' gap={spacing.m}>
    ...
    <Title>{getLocale(S.BRAVE_NEWS_OFFLINE_TITLE)}</Title>
    <div>
      {getLocale(S.BRAVE_NEWS_OFFLINE_MESSAGE)}
    </div>
    <NewsButton onClick={refreshFeedV2}>
      {getLocale(S.BRAVE_NEWS_REFRESH_FEED)}
    </NewsButton>
  </Container>
}
