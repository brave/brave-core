...
#ifndef BRAVE_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_WALLPAPERS_NTP_WALLPAPER_PROVIDER_FACTORY_H_
#define BRAVE_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_WALLPAPERS_NTP_WALLPAPER_PROVIDER_FACTORY_H_
...
// factory determines which one that is, so callers do not each need to
// check all four themselves.
class NTPWallpaperProviderFactory {
 public:
  NTPWallpaperProviderFactory(
  ...
  NTPWallpaperProviderFactory(const NTPWallpaperProviderFactory&) = delete;
  NTPWallpaperProviderFactory& operator=(
      const NTPWallpaperProviderFactory&) = delete;
...
#endif  // BRAVE_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_WALLPAPERS_NTP_WALLPAPER_PROVIDER_FACTORY_H_
