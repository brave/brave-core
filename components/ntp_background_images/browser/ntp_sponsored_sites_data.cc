...
NTPSponsoredSitesData::NTPSponsoredSitesData(const NTPSponsoredSitesData&) =
    default;

NTPSponsoredSitesData& NTPSponsoredSitesData::operator=(
    const NTPSponsoredSitesData&) = default;

NTPSponsoredSitesData::NTPSponsoredSitesData(NTPSponsoredSitesData&&) noexcept =
    default;

NTPSponsoredSitesData& NTPSponsoredSitesData::operator=(
    NTPSponsoredSitesData&&) noexcept = default;
