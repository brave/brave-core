...
import { ArgsOfMethod, VoidMethodKeys } from './api_utils'
...
>(
  ...
  type ValidKeys = Extract<keyof PartialInterface, VoidMethodKeys<Interface>>

  // TODO: only bubble up events that are asked for
  type Events = {
    [K in ValidKeys]: EventDef<[], ArgsOfMethod<Interface, K>>
  }
