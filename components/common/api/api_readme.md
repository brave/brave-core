...
seen in libraries like _Redux Toolkit Queries_ and _TanStack Query_ (a.k.a.
_React Query_).
...
...we now get the following helper for React...
...
subscribed to it. This is common for React which still won't perform expensive
