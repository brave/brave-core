...
declare namespace RewardsInternals {
  ...
  export interface State {
    balance: import(
      'gen/brave/components/brave_rewards/common/mojom/rewards_core_types.mojom.m.js'
    ).Balance
    info: {
  ...
  type WalletStatus = import('gen/brave/components/brave_rewards/common/mojom/rewards_core_types.mojom.m.js').WalletStatus
  ...
  type Environment = import('gen/brave/components/brave_rewards/common/mojom/rewards_core_types.mojom.m.js').Environment
}
