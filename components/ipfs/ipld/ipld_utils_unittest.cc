...
namespace {
// Header of the CAR file (base32 - cidv1 - dag-cbor - (sha2-256 : 256 :
// F88BC853804CF294FE417E4FA83028689FCDB1B1592C5102E1474DBC200FAB8B))
//  version: 1, roots:
...
const std::vector<uint8_t> kCarv1HeaderData = {
    0xA2, 0x65, 0x72, 0x6F, 0x6F, 0x74, 0x73, 0x82, 0xD8, 0x2A, 0x58,
    0x25, 0x00, 0x01, 0x71, 0x12, 0x20, 0xF8, 0x8B, 0xC8, 0x53, 0x80,
    0x4C, 0xF2, 0x94, 0xFE, 0x41, 0x7E, 0x4F, 0xA8, 0x30, 0x28, 0x68,
    0x9F, 0xCD, 0xB1, 0xB1, 0x59, 0x2C, 0x51, 0x02, 0xE1, 0x47, 0x4D,
    0xBC, 0x20, 0x0F, 0xAB, 0x8B, 0xD8, 0x2A, 0x58, 0x25, 0x00, 0x01,
    0x71, 0x12, 0x20, 0x69, 0xEA, 0x07, 0x40, 0xF9, 0x80, 0x7A, 0x28,
    0xF4, 0xD9, 0x32, 0xC6, 0x2E, 0x7C, 0x1C, 0x83, 0xBE, 0x05, 0x5E,
    0x55, 0x07, 0x2C, 0x90, 0x26, 0x6A, 0xB3, 0xE7, 0x9D, 0xF6, 0x3A,
    0x36, 0x5B, 0x67, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6F, 0x6E, 0x01  //, 0x5B
};
...
const std::vector<std::tuple<const std::vector<uint8_t> /*block data*/,
    ...
    kBlocksData{
        ...
        {{0x01, 0x71, 0x12, 0x20, 0xF8, 0x8B, 0xC8, 0x53, 0x80, 0x4C, 0xF2,
          ...
          0x58, 0x23, 0x00, 0x12, 0x20, 0x02, 0xAC, 0xEC, 0xC5, 0xDE, 0x24,
          0x38, 0xEA, 0x41, 0x26, 0xA3, 0x01, 0x0E, 0xCB, 0x1F, 0x8A, 0x59,
          0x9C, 0x8E, 0xFF, 0x22, 0xFF, 0xF1, 0xA1, 0xDC, 0xFF, 0xE9, 0x99,
        ...
        {{0x12, 0x20, 0x02, 0xAC, 0xEC, 0xC5, 0xDE, 0x24, 0x38, 0xEA, 0x41,
          ...
          0xD6, 0x75, 0xF9, 0x8E, 0x2A, 0xBD, 0x22, 0xD4, 0xED, 0x29, 0xFD,
          0xC8, 0x31, 0x50, 0xFE, 0xDC, 0x48, 0x59, 0x7E, 0x92, 0xDD, 0x1A,
          0x7A, 0x24, 0x38, 0x1D, 0x44, 0xA2, 0x74, 0x51, 0x12, 0x04, 0x62,
          0x65, 0x61, 0x72, 0x18, 0x04, 0x12, 0x2F, 0x0A, 0x22, 0x12, 0x20,
          0x79, 0xA9, 0x82, 0xDE, 0x3C, 0x99, 0x07, 0x95, 0x3D, 0x4D, 0x32,
          0x3C, 0xEE, 0x1D, 0x0F, 0xB1, 0xED, 0x8F, 0x45, 0xF8, 0xEF, 0x02,
        ...
        {{0x12, 0x20, 0x79, 0xA9, 0x82, 0xDE, 0x3C, 0x99, 0x07, 0x95, 0x3D,
          ...
          0x5B, 0x17, 0x01, 0x86, 0x74, 0xB4, 0x01, 0xB4, 0x2F, 0x35, 0xBA,
          0x07, 0xBB, 0x79, 0xE2, 0x11, 0x23, 0x9C, 0x23, 0xBF, 0xFE, 0x65,
          0x8D, 0xA1, 0x57, 0x7E, 0x3E, 0x64, 0x68, 0x77, 0x12, 0x03, 0x64,
          0x6F, 0x67, 0x18, 0x04, 0x12, 0x2D, 0x0A, 0x22, 0x12, 0x20, 0xE7,
          0xDC, 0x48, 0x6E, 0x97, 0xE6, 0xEB, 0xE5, 0xCD, 0xAB, 0xAB, 0x3E,
          0x39, 0x2B, 0xDA, 0xD1, 0x28, 0xB6, 0xE0, 0x9A, 0xCC, 0x94, 0xBB,
        ...
        {{0x12, 0x20, 0xE7, 0xDC, 0x48, 0x6E, 0x97, 0xE6, 0xEB, 0xE5, 0xCD,
          ...
          0x55, 0xA8, 0xE2, 0xF6, 0xB4, 0xE1, 0x72, 0x33, 0x8B, 0xDD, 0xF1,
          0x84, 0xD6, 0xDB, 0xEE, 0x29, 0xC9, 0x88, 0x53, 0xE0, 0xA0, 0x48,
...
TEST_F(IpldUtilsUnitTest, DecodeCarv1Header) {
  // Valid CAR_V1 header
  auto result = ipfs::ipld::DecodeCarv1Header(kCarv1HeaderData);
  ...
  std::vector<uint8_t> carv1_header_data(kCarv1HeaderData);
  carv1_header_data[98] = 0x02;
  ...
  result = ipfs::ipld::DecodeCarv1Header(kCarv2HeaderPragmaData);
  ASSERT_GT(result.error.error.length(), 0UL);
  ASSERT_EQ(result.error.error_code, 10);

  // Valid CAR_V2 pragma data (10 bytes, without length)
  std::vector<uint8_t> carv2_header_pragme_data(kCarv2HeaderPragmaData);
  carv2_header_pragme_data.erase(carv2_header_pragme_data.cbegin());
