...
const char kManagedBraveShieldsDisabledForUrls[] = "brave.managed_shields_disabled";
const char kManagedBraveShieldsEnabledForUrls[] = "brave.managed_shields_enabled";
