...
inline constexpr char kOnDeviceModelWorkerURL[] = "chrome-untrusted://on-device-model-worker/";
inline constexpr char kOnDeviceModelWorkerHost[] = "on-device-model-worker";
