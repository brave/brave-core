...
// Recorded in page_load_metrics_initialize.cc via
// browser/misc_metrics/captcha_metrics/captcha_metrics.cc
...
// that window tight across process restarts. See
// browser/misc_metrics/captcha_metrics/captcha_metrics.cc for
