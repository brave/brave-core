...
TEST_F(BackupResultsURLLoaderThrottleTest, AlwaysAllowedPaths) {
  ...
  EXPECT_FALSE(RunThrottle("https://www.example.com/"));
  EXPECT_FALSE(RunThrottle("https://www.example.com/search?q=test"));
  EXPECT_FALSE(RunThrottle("https://www.example.com/search"));
}
...
TEST_F(BackupResultsURLLoaderThrottleTest, FetchPathsBlockedByDefault) {
  ...
  EXPECT_TRUE(RunThrottle("https://www.example.com/gen_204"));
  EXPECT_TRUE(RunThrottle("https://www.example.com/client_204"));
  EXPECT_TRUE(RunThrottle("https://www.example.com/complete/s?q=test"));
}
...
TEST_F(BackupResultsURLLoaderThrottleTest, FetchPathsAllowedWhenParamTrue) {
  ...
  EXPECT_FALSE(RunThrottle("https://www.example.com/gen_204"));
  EXPECT_FALSE(RunThrottle("https://www.example.com/client_204"));
  EXPECT_FALSE(RunThrottle("https://www.example.com/complete/s?q=test"));
}
...
TEST_F(BackupResultsURLLoaderThrottleTest, CosmeticAssetsBlockedByDefault) {
  ...
  constexpr std::string_view kBlockedUrls[] = {
      ...
      "https://www.example.com/images/branding/logo.png",
      "https://www.example.com/shopping/ads",
      "https://www.example.com/favicon",
      "https://www.example.com/grass",
  };
...
TEST_F(BackupResultsURLLoaderThrottleTest,
  ...
  EXPECT_TRUE(RunThrottle("https://www.example.com/some/random/path"));
  EXPECT_TRUE(RunThrottle("https://www.example.com/xjs/_/js/main.js"));
}
...
TEST_F(BackupResultsURLLoaderThrottleTest,
  ...
  EXPECT_FALSE(RunThrottle("https://www.example.com/some/random/path"));
}
...
TEST_F(BackupResultsURLLoaderThrottleTest, CosmeticIsClassified) {
  ...
  EXPECT_FALSE(RunThrottle("https://www.example.com/logo.png"));
}
