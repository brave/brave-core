...
// Screen bounds of the browser window as of the last recorded navigation.
// Used to report realistic window.outerWidth/outerHeight/screenX/screenY
// values for backup results requests.
