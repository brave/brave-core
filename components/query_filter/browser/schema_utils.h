...
#ifndef BRAVE_COMPONENTS_QUERY_FILTER_BROWSER_SCHEMA_UTILS_H_
#define BRAVE_COMPONENTS_QUERY_FILTER_BROWSER_SCHEMA_UTILS_H_
...
#endif  // BRAVE_COMPONENTS_QUERY_FILTER_BROWSER_SCHEMA_UTILS_H_
