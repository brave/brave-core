...
#ifndef BRAVE_COMPONENTS_PSST_CORE_BROWSER_PSST_RULE_REGISTRY_H_
#define BRAVE_COMPONENTS_PSST_CORE_BROWSER_PSST_RULE_REGISTRY_H_
...
#endif  // BRAVE_COMPONENTS_PSST_CORE_BROWSER_PSST_RULE_REGISTRY_H_
