...
#ifndef BRAVE_COMPONENTS_PSST_CORE_BROWSER_RULE_DATA_READER_H_
#define BRAVE_COMPONENTS_PSST_CORE_BROWSER_RULE_DATA_READER_H_
...
#endif  // BRAVE_COMPONENTS_PSST_CORE_BROWSER_RULE_DATA_READER_H_
