...
// psst.json keys
const base::FilePath::CharType kInclude[] = FILE_PATH_LITERAL("include");
const base::FilePath::CharType kExclude[] = FILE_PATH_LITERAL("exclude");
const base::FilePath::CharType kTestScript[] = FILE_PATH_LITERAL("test_script");
const base::FilePath::CharType kPolicyScript[] =
    FILE_PATH_LITERAL("policy_script");
const base::FilePath::CharType kVersion[] = FILE_PATH_LITERAL("version");
