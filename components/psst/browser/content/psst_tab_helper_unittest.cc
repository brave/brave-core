...
// void SetProgressValue(content::WebContents* contents, const double value)
// override {} void SetRequestDone(content::WebContents* contents, const
// std::string& url) override {}
// };

// class PsstTabHelperUnitTest : public ChromeRenderViewHostTestHarness
...
//     psst::PsstRuleRegistryAccessor::GetInstance()
//          ->Registry()->OnLoadRules(contents);
//   }
...
//   raw_ptr<PsstTabHelper, DanglingUntriaged> tab_helper_ = nullptr;  // Owned
//   by WebContents.
// };
...
//       ]
//       )";
//   LoadRulesForTest(base::ReplaceStringPlaceholders(rules, {rule_name},
//   nullptr));
