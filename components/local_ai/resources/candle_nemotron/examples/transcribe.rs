...
//     --manifest-path components/local_ai/resources/candle_nemotron/Cargo.toml \
...
use candle_nemotron::audio;
use candle_nemotron::decode::{rnnt_greedy_step, DecodeState};
use candle_nemotron::model::{
