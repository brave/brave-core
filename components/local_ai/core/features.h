...
// Gates Brave's on-device speech recognition feature, which runs
// Parakeet-CTC-110M in a WASM worker. Disabled by default; enable
// with --enable-features=BraveOnDeviceSpeechRecognition.
