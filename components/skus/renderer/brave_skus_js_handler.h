...
#ifndef BRAVE_COMPONENTS_SKUS_RENDERER_JS_HANDLER_H_
#define BRAVE_COMPONENTS_SKUS_RENDERER_JS_HANDLER_H_
...
#endif  // BRAVE_COMPONENTS_SKUS_RENDERER_JS_HANDLER_H_
