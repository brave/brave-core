...
#     python3 generate_search_engine_constants.py | pbcopy
...
#ifndef BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_SEARCH_ENGINE_SEARCH_ENGINE_CONSTANTS_H_
#define BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_SEARCH_ENGINE_SEARCH_ENGINE_CONSTANTS_H_
...
// search results page. If the URL matches one of the search engines listed
// below, its name is included in the metrics payload (see `README.md`). For all
// other search engines, the value "Other" is reported to preserve user privacy.
//
//   - Brave
//   - Google
//   - DuckDuckGo
...
#endif  // BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_SEARCH_ENGINE_SEARCH_ENGINE_CONSTANTS_H_
""")
