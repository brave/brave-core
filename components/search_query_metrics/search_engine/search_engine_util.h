...
#ifndef BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_SEARCH_ENGINE_SEARCH_ENGINE_UTIL_H_
#define BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_SEARCH_ENGINE_SEARCH_ENGINE_UTIL_H_
...
// Returns `true` if `url` is associated with a known search engine domain. This
// check is based on a predefined list of supported search engines.
...
#endif  // BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_SEARCH_ENGINE_SEARCH_ENGINE_UTIL_H_
