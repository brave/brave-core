...
#ifndef BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_NETWORK_CLIENT_NETWORK_CLIENT_H_
#define BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_NETWORK_CLIENT_NETWORK_CLIENT_H_
...
class NetworkClient {
 ...
 private:
  ...
  void ObliviousHttpRequest(const GURL& url,
                            const std::string& content,
                            const std::string& content_type,
                            const std::string& method,
...
#endif  // BRAVE_COMPONENTS_SEARCH_QUERY_METRICS_NETWORK_CLIENT_NETWORK_CLIENT_H_
