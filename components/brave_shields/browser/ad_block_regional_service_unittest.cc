...
TEST(AdBlockRegionalServiceTest, UserModelLanguages) {
  std::vector<brave_shields::RegionalCatalogEntry> catalog =
      std::vector<brave_shields::RegionalCatalogEntry>();
  catalog.push_back(brave_shields::RegionalCatalogEntry(
