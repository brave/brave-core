...
#ifndef BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_ENGINE_TEST_OBSERVER_H_
#define BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_ENGINE_TEST_OBSERVER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_ENGINE_TEST_OBSERVER_H_
