...
#ifndef BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_AD_BLOCK_TEST_SOURCE_PROVIDER_H_
#define BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_AD_BLOCK_TEST_SOURCE_PROVIDER_H_
...
class TestSourceProvider : public brave_shields::SourceProvider,
                           public brave_shields::ResourceProvider {
 public:
...
#endif  // BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_AD_BLOCK_TEST_SOURCE_PROVIDER_H_
