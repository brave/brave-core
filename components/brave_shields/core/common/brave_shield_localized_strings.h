...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveShieldsAreYouExperiencingIssuesWithThisSiteDesc",
     IDS_BRAVE_SHIELDS_ARE_YOU_EXPERIENCING_ISSUES_WITH_THIS_SITE_DESC},
    {"braveShieldsAreYouExperiencingIssuesWithShieldsTitle",
     IDS_BRAVE_SHIELDS_ARE_YOU_EXPERIENCING_ISSUES_WITH_SHIELDS_TITLE},
    {"braveShieldsAreYouExperiencingIssuesWithShieldsDesc",
     IDS_BRAVE_SHIELDS_ARE_YOU_EXPERIENCING_ISSUES_WITH_SHIELDS_DESC},
