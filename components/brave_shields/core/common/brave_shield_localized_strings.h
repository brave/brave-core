...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveShieldsAreYouExperiencingIssuesWithThisSiteTitle",
     IDS_BRAVE_SHIELDS_ARE_YOU_EXPERIENCING_ISSUES_WITH_THIS_SITE_TITLE},
    {"braveShieldsAreYouExperiencingIssuesWithThisSiteDesc1",
     IDS_BRAVE_SHIELDS_ARE_YOU_EXPERIENCING_ISSUES_WITH_THIS_SITE_DESC1},
    {"braveShieldsAreYouExperiencingIssuesWithThisSiteDesc2",
     IDS_BRAVE_SHIELDS_ARE_YOU_EXPERIENCING_ISSUES_WITH_THIS_SITE_DESC2},
    {"braveShieldsEnableAdBlockOnlyMode",
     IDS_BRAVE_SHIELDS_ENABLE_AD_BLOCK_ONLY_MODE},
    {"braveShieldsDismissAlert", IDS_BRAVE_SHIELDS_DISMISS_ALERT},
    {"braveShieldsIsThisSiteWorkingCorrectlyNowTitle",
     IDS_BRAVE_SHIELDS_IS_THIS_SITE_WORKING_CORRECTLY_NOW_TITLE},
    {"braveShieldsIsThisSiteWorkingCorrectlyNowDesc",
     IDS_BRAVE_SHIELDS_IS_THIS_SITE_WORKING_CORRECTLY_NOW_DESC},
    {"braveShieldsIsThisSiteWorkingCorrectlyNowLooksGood",
     IDS_BRAVE_SHIELDS_IS_THIS_SITE_WORKING_CORRECTLY_NOW_LOOKS_GOOD},
    {"braveShieldsIsThisSiteWorkingCorrectlyNowReportSite",
     IDS_BRAVE_SHIELDS_IS_THIS_SITE_WORKING_CORRECTLY_NOW_REPORT_SITE},
    {"braveShieldsAdBlockOnlyModeEnabledTitle",
     IDS_BRAVE_SHIELDS_AD_BLOCK_ONLY_MODE_ENABLE_TITLE},
    {"braveShieldsAdBlockOnlyModeEnabledDesc",
     IDS_BRAVE_SHIELDS_AD_BLOCK_ONLY_MODE_ENABLE_DESC},
    ...
    {"braveShieldsScriptsBlockedOverridden",
     IDS_BRAVE_SHIELDS_SCRIPTS_BLOCKED_OVERRIDDEN},
    {"braveShieldsScriptsBlockedOverriddenByExt",
     IDS_BRAVE_SHIELDS_SCRIPTS_BLOCKED_OVERRIDDEN_BY_EXTENSION},
    {"braveShieldsScriptsBlockedOverriddenByPolicy",
    ...
    {"braveShieldsScriptsBlockedOverriddenByPWA",
     IDS_BRAVE_SHIELDS_SCRIPTS_BLOCKED_OVERRIDDEN_BY_PWA},
