...
class AdBlockFiltersProviderManager : public AdBlockFiltersProvider,
 ...
 public:
  ...
  void LoadFiltersForEngine(
      ...
      base::OnceCallback<void(const std::vector<unsigned char>& verified_engine_dat)>);
 ...
 private:
  ...
  explicit AdBlockFiltersProviderManager(mojo::Remote<filter_set::mojom::UtilParseFilterSet> filter_set_service);
