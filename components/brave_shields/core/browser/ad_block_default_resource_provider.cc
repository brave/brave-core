...
void AdBlockDefaultResourceProvider::OnResourcesLoaded(const std::string& resources_json) {
...
void AdBlockDefaultResourceProvider::OnLoadResourcesLoaded(
    base::OnceCallback<void(rust::Box<adblock::BraveCoreResourceStorage>)> cb,
