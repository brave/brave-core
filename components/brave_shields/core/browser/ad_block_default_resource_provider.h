...
class AdBlockDefaultResourceProvider : public AdBlockResourceProvider {
 public:
  ...
  void LoadResources(
      base::OnceCallback<void(rust::Box<adblock::BraveCoreResourceStorage>)>) override;
 ...
 private:
  ...
  void OnLoadResourcesLoaded(base::OnceCallback<void(rust::Box<adblock::BraveCoreResourceStorage>)> cb,
