...
provideStrings({
  ...
  braveShieldsAreYouExperiencingIssuesWithThisSiteDesc: 'We\'re trying out an experiment to increase site compatibility, where we only keep ad-blocking on and reduce privacy protections. Do you want to try it out? You can always undo and return to your regular Shields experience. $1Learn more$1.',
  braveShieldsAreYouExperiencingIssuesWithShieldsTitle: 'Are you experiencing issues with shields?',
  braveShieldsAreYouExperiencingIssuesWithShieldsDesc: 'We\'re trying out an experiment to increase site compatibility, where we only keep ad-blocking on and reduce privacy protections. Do you want to try it out? You can always undo and return to your regular Shields experience. $1Learn more$1.',
  braveShieldsEnableAdBlockOnlyMode: 'Enable ad block only mode',
  ...
  braveShieldsAdBlockOnlyModeEnabledTitle: 'Ad block only mode enabled',
  braveShieldsAdBlockOnlyModeEnabledDesc: 'You\'re currently using ad blocking only mode. This mode only offers ad-blocking protection. If you wish to return to full shields mode, disable this mode from settings.',
