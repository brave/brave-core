...
export function FingerprintingDetails(props: Props) {
  ...
  const title = getString(S.BRAVE_SHIELDS_FINGERPRINTING_PROTECTIONS_TITLE)
    ...
    <main data-css-scope={style.scope}>
      ...
      >
        <p className='header-text'>
          {getString(S.BRAVE_SHIELDS_FINGERPRINTING_LIST_DESCRIPTION)}
          <button onClick={() => actions.openTab(learnMoreUrl)}>
            {getString(S.BRAVE_SHIELDS_LEARN_MORE_LINK_TEXT)}
          </button>
        </p>
      </DetailsHeader>
