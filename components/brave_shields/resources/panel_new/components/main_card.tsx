  ...
  function renderBlockInfo() {
    if (!shieldsEnabled) {
      return (
        <div className='report-prompt'>
          {getString(S.BRAVE_SHIELDS_SITE_NOT_WORKING)}
          <Button onClick={actions.openWebCompatReporter}>
            {getString(S.BRAVE_SHIELDS_REPORT)}
          </Button>
        </div>
      )
    }
    ...
    return (
      <div className='block-info'>
        ...
        {getString(S.BRAVE_SHIELDS_TRACKERS_ADS_BLOCKED)}
      </div>
    )
  }
      ...
      <div className='site-info'>
        ...
        <div className='site-text'>
          ...
          <div className='shields-status'>
            {formatString(
              shieldsEnabled
                ? getString(S.BRAVE_SHIELDS_STATUS_UP)
                : getString(S.BRAVE_SHIELDS_STATUS_DOWN),
              {
