...
export function createShieldsApi(
  opts: {
  ...
  const api = createInterfaceApi({
    ...
    endpoints: {
      ...
      isHttpsByDefaultEnabled: state(initialState.isHttpsByDefaultEnabled),
      isTorProfile: state(initialState.isTorProfile),
      showStrictFingerprintingMode:
        state(initialState.showStrictFingerprintingMode),
      isWebcompatExceptionsServiceEnabled:
        state(initialState.isWebcompatExceptionsServiceEnabled),
      isBraveForgetFirstPartyStorageFeatureEnabled:
        state(initialState.isBraveForgetFirstPartyStorageFeatureEnabled),
      repeatedReloadsDetected: state(initialState.repeatedReloadsDetected),
    },
  ...
  if (createUIHandlerRemote) {
    dataHandler.registerUIHandler(createUIHandlerRemote({
