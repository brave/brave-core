...
const locale = {
  ...
  blockAllCookies: 'All cookies blocked',
  block3partyScripts: '3rd-party scripts blocked',
  blockAllScripts: 'All scripts blocked',
  allowAllScripts: 'Allow all scripts',
  allowAllFingerprinting: 'All device recognition allowed',
  blockAllFingerprinting: 'All device recognition blocked',
