...
protocol ExpressibleByPropertyAnimator {
...
extension NSObject {
  ...
  @discardableResult
  func springAnimate(property: ExpressibleByPropertyAnimator, key: String, _ animation: (_: POPSpringAnimation, _ inProgress: Bool) -> Void) -> POPSpringAnimation {
  ...
  @discardableResult
  func basicAnimate(property: ExpressibleByPropertyAnimator, key: String, _ animation: (_: POPBasicAnimation, _ inProgress: Bool) -> Void) -> POPBasicAnimation {
