...
class ConnectUserWalletButton: UIControl {
  ...
  override init(frame: CGRect) {
    ...
    stackView.addStackViewItems(
      ...
      .view(UIImageView(image: UIImage(frameworkResourceNamed: "verify-continue")))
    )
    ...
    stackView.snp.makeConstraints {
      $0.edges.equalTo(self).inset(UIEdgeInsets(top: 6, left: 12, bottom: 6, right: 6))
    }
  }
