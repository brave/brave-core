...
#
# Ported verbatim from chromium //agents/testing/asserts/check_changes.py.
# These asserts only shell to `git status` and read files, so there is no
# Chromium coupling — Brave reuses them unchanged for structural (non-prose)
# assertions on eval results.
