...
#if BUILDFLAG(IS_MAC)
const bool kRestrictFontFamiliesOnThisPlatform = true;
...
const bool kRestrictFontFamiliesOnThisPlatform = true;
constexpr auto kAllowedFontFamilies = base::MakeFixedFlatSet<base::StringPiece>(
    {"Arial",
     "Arial Black",
     "Arial Bold",
     "Arial Bold Italic",
...
// ar,fa,ur="Aldhabi","Andalus","Arabic Typesetting","Microsoft
// Uighur","Microsoft Uighur Bold","Sakkal Majalla","Sakkal Majalla
// Bold","Simplified Arabic","Simplified Arabic Bold","Simplified Arabic
// Fixed","Traditional Arabic","Traditional Arabic Bold","Urdu
// Typesetting","Urdu Typesetting Bold"

// as="Shonar Bangla","Shonar Bangla Bold","Vrinda","Vrinda Bold"

// iu="Euphemia"

// hi,mr="Aparajita","Aparajita Italic","Aparajita Bold","Aparajita Bold
// Italic","Kokila","Kokila Italic","Kokila Bold","Kokila Bold
// Italic","Mangal","Mangal Bold","Sanskrit Text","Utsaah","Utsaah
// Italic","Utsaah Bold","Utsaah Bold Italic"
...
// zh="DengXian Light","DengXian","DengXian
// Bold","FangSong","KaiTi","SimHei","DFKai-SB","MingLiU","MingLiU_HKSCS","PMingLiU"

// he="Aharoni Bold","David","David Bold","FrankRuehl","Gisha","Gisha
// Bold","Levenim MT","Levenim MT Bold","Miriam","Miriam Fixed","Narkisim","Rod"

// ja="BIZ UDGothic","BIZ UDGothic Bold","BIZ UDPGothic","BIZ UDPGothic
// Bold","BIZ UDMincho Medium","BIZ UDPMincho Medium","Meiryo","Meiryo
// Italic","Meiryo Bold","Meiryo Bold Italic","Meiryo UI","Meiryo UI
// Italic","Meiryo UI Bold","Meiryo UI Bold Italic","MS Mincho","MS PMincho","UD
// Digi Kyokasho","UD Digi Kyokasho N-B","UD Digi Kyokasho NK-B","UD Digi
// Kyokasho NK-R","UD Digi Kyokasho NP-B","UD Digi Kyokasho NP-R","UD Digi
// Kyokasho N-R","Yu Mincho Light","Yu Mincho Regular","Yu Mincho Demibold"
...
#else
const bool kRestrictFontFamiliesOnThisPlatform = false;
constexpr auto kAllowedFontFamilies =
    base::MakeFixedFlatSet<base::StringPiece>({});
#endif
