...
const locale: Record<string, string> = {
  ...
  tokens: 'tokens',
  total: 'Total',
  transitionBannerRead: 'Please read:',
  transitionBannerBody: 'Due to a change in our anonymous wallet system, your deposited funds of {{amount}} BAT are no longer reflected in your Brave Rewards wallet balance, and need to be claimed before you can contribute or withdraw them. Please follow the claim process to reclaim your funds by verifying your wallet with Uphold.',
  transitionBannerCTA: 'Claim My Deposit',
