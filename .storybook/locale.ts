...
const locale: Record<string, string> = {
  ...
  transitionBannerBody: 'Due to our system change, your deposited funds {{ amount }} BAT must be used by February 25th, 2020 or you need to verify your wallet via Uphold so the funds can be transferred to it. Please complete this action before February 25th.',
  transitionBannerCTA: 'Verify wallet',
