...
inline constexpr auto kUnstoppableDomains =
    base::MakeFixedFlatSet<std::string_view>(
        {".agent",      ".ai4",         ".altimist",    ".amped",
         ".anime",      ".anyone",      ".arculus",     ".ask",
         ".ath",        ".austin",      ".bald",        ".basenji",
         ".bay",        ".bch",         ".benji",       ".binanceus",
         ".bitcoin",    ".bitget",      ".bitscrunch",  ".blockchain",
         ".boomer",     ".brave",       ".bunni",       ".calicoin",
         ".carbon",     ".caw",         ".cgai",        ".chip",
         ".chomp",      ".clay",        ".collect",     ".crypto",
         ".dao",        ".dejay",       ".depin",       ".derad",
         ".dfz",        ".digibyte",    ".doga",        ".donut",
         ".dream",      ".dsci",        ".emir",        ".ethermail",
         ".farms",      ".goblin",      ".gotchi",      ".grow",
         ".her",        ".hub",         ".imtoken",     ".kingdom",
         ".klever",     ".kresus",      ".kryptic",     ".learn",
         ".lfg",        ".ltc",         ".lunar",       ".manga",
         ".marketer",   ".metropolis",  ".miku",        ".ministry",
         ".mobix",      ".moon",        ".mooncat",     ".mumu",
         ".mycircle",   ".nft",         ".nibi",        ".npc",
         ".ohm",        ".onchain",     ".pack",        ".pastor",
