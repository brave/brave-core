...
hooks = [
  ...
  },
  {
    ...
    'pattern': '.',
    'action': ['vpython3', 'tools/chromium_src/generate_clang_format.py', '../.clang-format', 'chromium_src/.clang-format']
  },
  {
    # We only need a custom .clang-format in chromium_src. It was previously
    # generated in the root of brave/. Clean it up now. This can be removed
    # after 08/2025.
