    ...
    <li class="nav-items-list-item" title="${this.historyTitle}">
      <a class="nav-item ${this.getNavItemSelectedClassName('history')}" href="chrome://history">
        <span class="nav-item-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg" width="20" height="20">
            <path fill-rule="nonzero" d="M11.083 10h3.292a.625.625 0 1 1 0 1.25h-3.292a1.25 1.25 0 1 1-1.708-1.708V6.875a.625.625 0 1 1 1.25 0v2.667c.19.11.348.268.458.458zM5.28 5h1.594a.625.625 0 1 1 0 1.25H3.75a.625.625 0 0 1-.625-.625V2.5a.625.625 0 1 1 1.25 0v1.636A8.125 8.125 0 1 1 1.875 10a.625.625 0 1 1 1.25 0 6.875 6.875 0 1 0 2.156-5z"/>
          </svg>
        </span>
      ...
      <a class="nav-item ${this.getNavItemSelectedClassName('downloads')}" href="chrome://downloads">
        <span class="nav-item-icon">
          <svg
            ...
            <path fill-rule="evenodd" d="M9.557 13.562a.619.619 0 0 0 .443.183.631.631 0 0 0 .443-.183l3.123-3.117a.624.624 0 1 0-.882-.884l-2.059 2.053v-8.49a.624.624 0 1 0-1.25 0v8.49L7.316 9.561a.624.624 0 1 0-.882.884l3.123 3.117zm7.943-1.06v3.749c0 .688-.56 1.249-1.25 1.249H3.75c-.69 0-1.25-.561-1.25-1.25v-3.748a.624.624 0 1 1 1.25 0v3.749h12.5v-3.749a.624.624 0 1 1 1.25 0z"/>
          </svg>
        </span>
      ...
      <a class="nav-item ${this.getNavItemSelectedClassName('wallet')}" href="chrome://wallet">
        <span class="nav-item-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M1.3 4.04839C1.3 3.08278 2.08278 2.3 3.04839 2.3H14.041C15.2889 2.3 16.319 3.23214 16.4732 4.4381C17.7387 4.66181 18.7 5.76703 18.7 7.09677V14C18.7 15.4912 17.4912 16.7 16 16.7H4C2.50883 16.7 1.3 15.4912 1.3 14V4.04839ZM2.7 5.76206V14C2.7 14.718 3.28203 15.3 4 15.3H16C16.718 15.3 17.3 14.718 17.3 14V13.5205H12.8276C11.3364 13.5205 10.1276 12.3117 10.1276 10.8205V10.3753C10.1276 8.88416 11.3364 7.67533 12.8276 7.67533H17.3V7.09677C17.3 6.3788 16.718 5.79677 16 5.79677H3.04839C2.92909 5.79677 2.81259 5.78483 2.7 5.76206ZM17.3 9.07533H12.8276C12.1096 9.07533 11.5276 9.65736 11.5276 10.3753V10.8205C11.5276 11.5385 12.1096 12.1205 12.8276 12.1205H17.3V9.07533ZM2.7 4.04839C2.7 4.2408 2.85598 4.39677 3.04839 4.39677H15.0316C14.8859 3.99056 14.4974 3.7 14.041 3.7H3.04839C2.85598 3.7 2.7 3.85598 2.7 4.04839Z" fill="#495057"/>
          </svg>
        </span>
