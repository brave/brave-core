...
def download_font(name: str, css_url: str):
  ...
  for (charset, name, weight, url) in re.findall(font_regex, css):
    ...
    print(f"""Charset: {charset}, Name: {name}, Weight: {weight}, URL: {url}""", font_file_path)
...
# plain old 'Inter').
download_font('inter', f"https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap")
